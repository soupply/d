 ...
 */
module soupply.protocol.pocket100.play;
...
import soupply.protocol.pocket100.packet : Pocket100Packet;

static import soupply.protocol.pocket100.types;
...
class ResourcePacksInfo : Pocket100Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket100.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket100.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.pocket100.types.PackWithSize[] behaviourPacks=(soupply.protocol.pocket100.types.PackWithSize[]).init, soupply.protocol.pocket100.types.PackWithSize[] resourcePacks=(soupply.protocol.pocket100.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Pocket100Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket100.types.Pack[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket100.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.pocket100.types.Pack[] behaviourPacks=(soupply.protocol.pocket100.types.Pack[]).init, soupply.protocol.pocket100.types.Pack[] resourcePacks=(soupply.protocol.pocket100.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class AddEntity : Pocket100Packet
{
    ...
    float pitch;
    float yaw;
    soupply.protocol.pocket100.types.Attribute[] attributes;
    Metadata metadata;
    soupply.protocol.pocket100.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, uint type=uint.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.protocol.pocket100.types.Attribute[] attributes=(soupply.protocol.pocket100.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.protocol.pocket100.types.Link[] links=(soupply.protocol.pocket100.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class AddItemEntity : Pocket100Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.protocol.pocket100.types.Slot item;
    Tuple!(float, "xyz") position;
    Tuple!(float, "xyz") motion;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket100.types.Slot item=soupply.protocol.pocket100.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Pocket100Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.protocol.pocket100.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket100.types.BlockPosition position=soupply.protocol.pocket100.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class RemoveBlock : Pocket100Packet
{
    ...
    this(soupply.protocol.pocket100.types.BlockPosition position) pure nothrow @safe @nogc
    {
        this.position = position;
    }
...
class UpdateBlock : Pocket100Packet
{
    ...
    this(soupply.protocol.pocket100.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Pocket100Packet
{
    ...
    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket100.types.BlockPosition position=soupply.protocol.pocket100.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Pocket100Packet
{
    ...
    Tuple!(float, "xyz") position;
    float radius;
    soupply.protocol.pocket100.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.protocol.pocket100.types.BlockPosition[] destroyedBlocks=(soupply.protocol.pocket100.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class BlockEvent : Pocket100Packet
{
    ...
    this(soupply.protocol.pocket100.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class UpdateAttributes : Pocket100Packet
{
    ...
    this(long entityId, soupply.protocol.pocket100.types.Attribute[] attributes=(soupply.protocol.pocket100.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class MobEquipment : Pocket100Packet
{
    ...
    this(long entityId, soupply.protocol.pocket100.types.Slot item=soupply.protocol.pocket100.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Pocket100Packet
{
    ...
    @Var long entityId;
    soupply.protocol.pocket100.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.protocol.pocket100.types.Slot[4] armor=(soupply.protocol.pocket100.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class UseItem : Pocket100Packet
{
    ...
    soupply.protocol.pocket100.types.BlockPosition blockPosition;
    @Var uint hotbarSlot;
    @Var int face;
    ...
    this(soupply.protocol.pocket100.types.BlockPosition blockPosition, uint hotbarSlot=uint.init, int face=int.init, Tuple!(float, "xyz") facePosition=Tuple!(float, "xyz").init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, int slot=int.init, soupply.protocol.pocket100.types.Slot item=soupply.protocol.pocket100.types.Slot.init) pure nothrow @safe @nogc
    {
...
class PlayerAction : Pocket100Packet
{
    ...
    this(long entityId, int action=int.init, soupply.protocol.pocket100.types.BlockPosition position=soupply.protocol.pocket100.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class SetSpawnPosition : Pocket100Packet
{
    ...
    this(int unknown0, soupply.protocol.pocket100.types.BlockPosition position=soupply.protocol.pocket100.types.BlockPosition.init, bool unknown2=bool.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
        this.unknown2 = unknown2;
...
class DropItem : Pocket100Packet
{
    ...
    this(ubyte action, soupply.protocol.pocket100.types.Slot item=soupply.protocol.pocket100.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class InventoryAction : Pocket100Packet
{
    ...
    this(int action, soupply.protocol.pocket100.types.Slot item=soupply.protocol.pocket100.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class ContainerOpen : Pocket100Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, int slotCount=int.init, soupply.protocol.pocket100.types.BlockPosition position=soupply.protocol.pocket100.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
...
class ContainerSetSlot : Pocket100Packet
{
    ...
    this(ubyte window, int slot=int.init, int hotbarSlot=int.init, soupply.protocol.pocket100.types.Slot item=soupply.protocol.pocket100.types.Slot.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.hotbarSlot = hotbarSlot;
...
class ContainerSetContent : Pocket100Packet
{
    ...
    ubyte window;
    soupply.protocol.pocket100.types.Slot[] slots;
    @Var int[] hotbar;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.protocol.pocket100.types.Slot[] slots=(soupply.protocol.pocket100.types.Slot[]).init, int[] hotbar=(int[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
        this.hotbar = hotbar;
...
class CraftingData : Pocket100Packet
{
    ...
    soupply.protocol.pocket100.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.pocket100.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Pocket100Packet
{
    ...
    @Var int type;
    UUID uuid;
    soupply.protocol.pocket100.types.Slot[] input;
    soupply.protocol.pocket100.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, UUID uuid=UUID.init, soupply.protocol.pocket100.types.Slot[] input=(soupply.protocol.pocket100.types.Slot[]).init, soupply.protocol.pocket100.types.Slot[] output=(soupply.protocol.pocket100.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class BlockEntityData : Pocket100Packet
{
    ...
    this(soupply.protocol.pocket100.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class FullChunkData : Pocket100Packet
{
    ...
    soupply.protocol.pocket100.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") position, soupply.protocol.pocket100.types.ChunkData data=soupply.protocol.pocket100.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class PlayerList : Pocket100Packet
{
    ...
    class Add : Pocket100Packet
    {
        ...
        soupply.protocol.pocket100.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.pocket100.types.PlayerList[] players) pure nothrow @safe @nogc
        {
...
class ClientboundMapItemData : Pocket100Packet
{
    ...
    @Condition("update==4") soupply.protocol.pocket100.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.protocol.pocket100.types.Decoration[] decorations=(soupply.protocol.pocket100.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class ItemFrameDropItem : Pocket100Packet
{
    ...
    this(soupply.protocol.pocket100.types.BlockPosition position, soupply.protocol.pocket100.types.Slot item=soupply.protocol.pocket100.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class ReplaceSelectedItem : Pocket100Packet
{
    ...
    this(soupply.protocol.pocket100.types.Slot item) pure nothrow @safe @nogc
    {
        this.item = item;
    }
...
class GameRulesChanged : Pocket100Packet
{
    ...
    @Length!uint soupply.protocol.pocket100.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.pocket100.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
