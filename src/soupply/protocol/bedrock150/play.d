 ...
 * Generated from protocol/bedrock150
 */
module soupply.protocol.bedrock150.play;
...
import soupply.protocol.bedrock150.packet : Bedrock150Packet;

static import soupply.protocol.bedrock150.types;
...
class Login : Bedrock150Packet
{
    ...
    @BigEndian uint protocol = 150;
    soupply.protocol.bedrock150.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.protocol.bedrock150.types.LoginBody body_=soupply.protocol.bedrock150.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class PlayStatus : Bedrock150Packet
{
...
class ServerToClientHandshake : Bedrock150Packet
{
...
class ClientToServerHandshake : Bedrock150Packet
{
...
class Disconnect : Bedrock150Packet
{
...
class ResourcePacksInfo : Bedrock150Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.bigEndian) soupply.protocol.bedrock150.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.bigEndian) soupply.protocol.bedrock150.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.bedrock150.types.PackWithSize[] behaviourPacks=(soupply.protocol.bedrock150.types.PackWithSize[]).init, soupply.protocol.bedrock150.types.PackWithSize[] resourcePacks=(soupply.protocol.bedrock150.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock150Packet
{
    ...
    bool mustAccept;
    soupply.protocol.bedrock150.types.Pack[] behaviourPacks;
    soupply.protocol.bedrock150.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.bedrock150.types.Pack[] behaviourPacks=(soupply.protocol.bedrock150.types.Pack[]).init, soupply.protocol.bedrock150.types.Pack[] resourcePacks=(soupply.protocol.bedrock150.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class ResourcePackClientResponse : Bedrock150Packet
{
...
class Text : Bedrock150Packet
{
    ...
    class Translation : Bedrock150Packet
    {
    ...
    class JukeboxPopup : Bedrock150Packet
    {
    ...
    class Whisper : Bedrock150Packet
    {
    ...
    class Announcement : Bedrock150Packet
    {
...
class SetTime : Bedrock150Packet
{
...
class StartGame : Bedrock150Packet
{
    ...
    soupply.protocol.bedrock150.types.Rule[] gameRules;
...
class AddPlayer : Bedrock150Packet
{
    ...
    float headYaw;
    float yaw;
    soupply.protocol.bedrock150.types.Slot heldItem;
    Metadata metadata;
    @Var uint unknown11;
    @Var uint unknown12;
    @Var uint unknown13;
    ...
    @Var uint unknown15;
    long unknown16;
    soupply.protocol.bedrock150.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock150.types.McpeUuid uuid, string username=string.init, long entityId=long.init, ulong runtimeId=ulong.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float headYaw=float.init, float yaw=float.init, soupply.protocol.bedrock150.types.Slot heldItem=soupply.protocol.bedrock150.types.Slot.init, Metadata metadata=Metadata.init, uint unknown11=uint.init, uint unknown12=uint.init, uint unknown13=uint.init, uint unknown14=uint.init, uint unknown15=uint.init, long unknown16=long.init, soupply.protocol.bedrock150.types.Link[] links=(soupply.protocol.bedrock150.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
...
class AddEntity : Bedrock150Packet
{
    ...
    float pitch;
    float yaw;
    soupply.protocol.bedrock150.types.Attribute[] attributes;
    Metadata metadata;
    soupply.protocol.bedrock150.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, uint type=uint.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.protocol.bedrock150.types.Attribute[] attributes=(soupply.protocol.bedrock150.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.protocol.bedrock150.types.Link[] links=(soupply.protocol.bedrock150.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class RemoveEntity : Bedrock150Packet
{
...
class AddItemEntity : Bedrock150Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.protocol.bedrock150.types.Slot item;
    Tuple!(float, "xyz") position;
    Tuple!(float, "xyz") motion;
    Metadata metadata;
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock150.types.Slot item=soupply.protocol.bedrock150.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Bedrock150Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.protocol.bedrock150.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock150.types.BlockPosition position=soupply.protocol.bedrock150.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class TakeItemEntity : Bedrock150Packet
{
...
class MoveEntity : Bedrock150Packet
{
...
class MovePlayer : Bedrock150Packet
{
...
class RiderJump : Bedrock150Packet
{
...
class UpdateBlock : Bedrock150Packet
{
    ...
    this(soupply.protocol.bedrock150.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Bedrock150Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock150.types.BlockPosition position=soupply.protocol.bedrock150.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Bedrock150Packet
{
    ...
    Tuple!(float, "xyz") position;
    float radius;
    soupply.protocol.bedrock150.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.protocol.bedrock150.types.BlockPosition[] destroyedBlocks=(soupply.protocol.bedrock150.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class LevelSoundEvent : Bedrock150Packet
{
...
class LevelEvent : Bedrock150Packet
{
...
class BlockEvent : Bedrock150Packet
{
    ...
    this(soupply.protocol.bedrock150.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class EntityEvent : Bedrock150Packet
{
...
class MobEffect : Bedrock150Packet
{
...
class UpdateAttributes : Bedrock150Packet
{
    ...
    this(long entityId, soupply.protocol.bedrock150.types.Attribute[] attributes=(soupply.protocol.bedrock150.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock150Packet
{
    ...
    @Var uint type;
    soupply.protocol.bedrock150.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.protocol.bedrock150.types.InventoryAction[] actions=(soupply.protocol.bedrock150.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class Normal0 : Bedrock150Packet
    {
    ...
    class Normal1 : Bedrock150Packet
    {
    ...
    class UseItem : Bedrock150Packet
    {
        ...
        @Var uint actionType;
        soupply.protocol.bedrock150.types.BlockPosition blockPosition;
        @Var int face;
        @Var int hotbarSlot;
        soupply.protocol.bedrock150.types.Slot item;
        ...
        this(uint actionType, soupply.protocol.bedrock150.types.BlockPosition blockPosition=soupply.protocol.bedrock150.types.BlockPosition.init, int face=int.init, int hotbarSlot=int.init, soupply.protocol.bedrock150.types.Slot item=soupply.protocol.bedrock150.types.Slot.init, Tuple!(float, "xyz") playerPosition=Tuple!(float, "xyz").init, Tuple!(float, "xyz") clickPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
    ...
    class UseItemOnEntity : Bedrock150Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.protocol.bedrock150.types.Slot item=soupply.protocol.bedrock150.types.Slot.init, Tuple!(float, "xyz") unknown4=Tuple!(float, "xyz").init, Tuple!(float, "xyz") unknown5=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock150Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.protocol.bedrock150.types.Slot item=soupply.protocol.bedrock150.types.Slot.init, Tuple!(float, "xyz") headPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class MobEquipment : Bedrock150Packet
{
    ...
    this(long entityId, soupply.protocol.bedrock150.types.Slot item=soupply.protocol.bedrock150.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock150Packet
{
    ...
    @Var long entityId;
    soupply.protocol.bedrock150.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.protocol.bedrock150.types.Slot[4] armor=(soupply.protocol.bedrock150.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class Interact : Bedrock150Packet
{
...
class BlockPickRequest : Bedrock150Packet
{
...
class EntityPickRequest : Bedrock150Packet
{
...
class PlayerAction : Bedrock150Packet
{
    ...
    this(long entityId, int action=int.init, soupply.protocol.bedrock150.types.BlockPosition position=soupply.protocol.bedrock150.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class EntityFall : Bedrock150Packet
{
...
class HurtArmor : Bedrock150Packet
{
...
class SetEntityData : Bedrock150Packet
{
...
class SetEntityMotion : Bedrock150Packet
{
...
class SetEntityLink : Bedrock150Packet
{
...
class SetHealth : Bedrock150Packet
{
...
class SetSpawnPosition : Bedrock150Packet
{
    ...
    this(int type, soupply.protocol.bedrock150.types.BlockPosition position=soupply.protocol.bedrock150.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class Animate : Bedrock150Packet
{
...
class Respawn : Bedrock150Packet
{
...
class ContainerOpen : Bedrock150Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.protocol.bedrock150.types.BlockPosition position=soupply.protocol.bedrock150.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class ContainerClose : Bedrock150Packet
{
...
class PlayerHotbar : Bedrock150Packet
{
...
class InventoryContent : Bedrock150Packet
{
    ...
    @Var uint window;
    soupply.protocol.bedrock150.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.protocol.bedrock150.types.Slot[] slots=(soupply.protocol.bedrock150.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class InventorySlot : Bedrock150Packet
{
...
class ContainerSetData : Bedrock150Packet
{
...
class CraftingData : Bedrock150Packet
{
    ...
    soupply.protocol.bedrock150.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock150.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock150Packet
{
    ...
    @Var int type;
    soupply.protocol.bedrock150.types.McpeUuid uuid;
    soupply.protocol.bedrock150.types.Slot[] input;
    soupply.protocol.bedrock150.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.protocol.bedrock150.types.McpeUuid uuid=soupply.protocol.bedrock150.types.McpeUuid.init, soupply.protocol.bedrock150.types.Slot[] input=(soupply.protocol.bedrock150.types.Slot[]).init, soupply.protocol.bedrock150.types.Slot[] output=(soupply.protocol.bedrock150.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class GuiDataPickItem : Bedrock150Packet
{
...
class AdventureSettings : Bedrock150Packet
{
...
class BlockEntityData : Bedrock150Packet
{
    ...
    this(soupply.protocol.bedrock150.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerInput : Bedrock150Packet
{
...
class FullChunkData : Bedrock150Packet
{
    ...
    soupply.protocol.bedrock150.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") position, soupply.protocol.bedrock150.types.ChunkData data=soupply.protocol.bedrock150.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class SetCommandsEnabled : Bedrock150Packet
{
...
class SetDifficulty : Bedrock150Packet
{
...
class ChangeDimension : Bedrock150Packet
{
...
class SetPlayerGameType : Bedrock150Packet
{
...
class PlayerList : Bedrock150Packet
{
    ...
    class Add : Bedrock150Packet
    {
        ...
        soupply.protocol.bedrock150.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.bedrock150.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock150Packet
    {
        ...
        soupply.protocol.bedrock150.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.bedrock150.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class SimpleEvent : Bedrock150Packet
{
...
class TelemetryEvent : Bedrock150Packet
{
...
class SpawnExperienceOrb : Bedrock150Packet
{
...
class ClientboundMapItemData : Bedrock150Packet
{
    ...
    @Condition("update==4") soupply.protocol.bedrock150.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.protocol.bedrock150.types.Decoration[] decorations=(soupply.protocol.bedrock150.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class MapInfoRequest : Bedrock150Packet
{
...
class RequestChunkRadius : Bedrock150Packet
{
...
class ChunkRadiusUpdated : Bedrock150Packet
{
...
class ItemFrameDropItem : Bedrock150Packet
{
    ...
    this(soupply.protocol.bedrock150.types.BlockPosition position, soupply.protocol.bedrock150.types.Slot item=soupply.protocol.bedrock150.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock150Packet
{
    ...
    soupply.protocol.bedrock150.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock150.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class BossEvent : Bedrock150Packet
{
...
class ShowCredits : Bedrock150Packet
{
...
class AvailableCommands : Bedrock150Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.protocol.bedrock150.types.Enum[] enums;
    soupply.protocol.bedrock150.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.protocol.bedrock150.types.Enum[] enums=(soupply.protocol.bedrock150.types.Enum[]).init, soupply.protocol.bedrock150.types.Command[] commands=(soupply.protocol.bedrock150.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandRequest : Bedrock150Packet
{
    ...
    this(string command, uint type=uint.init, soupply.protocol.bedrock150.types.McpeUuid uuid=soupply.protocol.bedrock150.types.McpeUuid.init, string requestId=string.init, int playerId=int.init, bool internal=bool.init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock150Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.protocol.bedrock150.types.BlockPosition position;
    ...
    this(bool updateBlock, soupply.protocol.bedrock150.types.BlockPosition position=soupply.protocol.bedrock150.types.BlockPosition.init, uint mode=uint.init, bool redstoneMode=bool.init, bool conditional=bool.init, long minecart=long.init, string command=string.init, string lastOutput=string.init, string hover=string.init, bool trackOutput=bool.init) pure nothrow @safe @nogc
    {
...
class UpdateTrade : Bedrock150Packet
{
...
class UpdateEquip : Bedrock150Packet
{
...
class ResourcePackDataInfo : Bedrock150Packet
{
...
class ResourcePackChunkData : Bedrock150Packet
{
...
class ResourcePackChunkRequest : Bedrock150Packet
{
...
class Transfer : Bedrock150Packet
{
...
class PlaySound : Bedrock150Packet
{
    ...
    this(string name, soupply.protocol.bedrock150.types.BlockPosition position=soupply.protocol.bedrock150.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class StopSound : Bedrock150Packet
{
...
class SetTitle : Bedrock150Packet
{
...
class AddBehaviorTree : Bedrock150Packet
{
...
class StructureBlockUpdate : Bedrock150Packet
{
...
class ShowStoreOffer : Bedrock150Packet
{
...
class PurchaseReceipt : Bedrock150Packet
{
...
class PlayerSkin : Bedrock150Packet
{
    ...
    this(soupply.protocol.bedrock150.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
...
class SubClientLogin : Bedrock150Packet
{
...
class InitiateWebSocketConnection : Bedrock150Packet
{
...
class SetLastHurtBy : Bedrock150Packet
{
...
class BookEdit : Bedrock150Packet
{
    ...
    class ReplacePage : Bedrock150Packet
    {
    ...
    class AddPage : Bedrock150Packet
    {
    ...
    class DeletePage : Bedrock150Packet
    {
    ...
    class SwapPages : Bedrock150Packet
    {
...
class NpcRequest : Bedrock150Packet
{
...
class PhotoTransfer : Bedrock150Packet
{
...
class ModalFormRequest : Bedrock150Packet
{
...
class ModalFormResponse : Bedrock150Packet
{
...
class ServerSettingsRequest : Bedrock150Packet
{
...
class ServerSettingsResponse : Bedrock150Packet
{
...
class ShowProfile : Bedrock150Packet
{
...
class SetDefaultGameType : Bedrock150Packet
{
