 ...
 * Generated from protocol/pocket101
 */
module soupply.protocol.pocket101.play;
...
import soupply.metadata.pocket101;
import soupply.protocol.pocket101.packet : Pocket101Packet;

static import soupply.protocol.pocket101.types;
...
class PlayStatus : Pocket101Packet
{
...
class ServerToClientHandshake : Pocket101Packet
{
...
class ClientToServerHandshake : Pocket101Packet
{
...
class Disconnect : Pocket101Packet
{
...
class ResourcePacksInfo : Pocket101Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket101.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket101.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.pocket101.types.PackWithSize[] behaviourPacks=(soupply.protocol.pocket101.types.PackWithSize[]).init, soupply.protocol.pocket101.types.PackWithSize[] resourcePacks=(soupply.protocol.pocket101.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Pocket101Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket101.types.Pack[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket101.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.pocket101.types.Pack[] behaviourPacks=(soupply.protocol.pocket101.types.Pack[]).init, soupply.protocol.pocket101.types.Pack[] resourcePacks=(soupply.protocol.pocket101.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class ResourcePackClientResponse : Pocket101Packet
{
...
class Text : Pocket101Packet
{
    ...
    class Translation : Pocket101Packet
    {
...
class StartGame : Pocket101Packet
{
...
class AddPlayer : Pocket101Packet
{
...
class AddEntity : Pocket101Packet
{
    ...
    float pitch;
    float yaw;
    soupply.protocol.pocket101.types.Attribute[] attributes;
    Metadata metadata;
    soupply.protocol.pocket101.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, uint type=uint.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.protocol.pocket101.types.Attribute[] attributes=(soupply.protocol.pocket101.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.protocol.pocket101.types.Link[] links=(soupply.protocol.pocket101.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class RemoveEntity : Pocket101Packet
{
...
class AddItemEntity : Pocket101Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.protocol.pocket101.types.Slot item;
    Tuple!(float, "xyz") position;
    Tuple!(float, "xyz") motion;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket101.types.Slot item=soupply.protocol.pocket101.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Pocket101Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.protocol.pocket101.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket101.types.BlockPosition position=soupply.protocol.pocket101.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class TakeItemEntity : Pocket101Packet
{
...
class MoveEntity : Pocket101Packet
{
...
class MovePlayer : Pocket101Packet
{
...
class RiderJump : Pocket101Packet
{
...
class RemoveBlock : Pocket101Packet
{
    ...
    this(soupply.protocol.pocket101.types.BlockPosition position) pure nothrow @safe @nogc
    {
        this.position = position;
    }
...
class UpdateBlock : Pocket101Packet
{
    ...
    this(soupply.protocol.pocket101.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Pocket101Packet
{
    ...
    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket101.types.BlockPosition position=soupply.protocol.pocket101.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Pocket101Packet
{
    ...
    Tuple!(float, "xyz") position;
    float radius;
    soupply.protocol.pocket101.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.protocol.pocket101.types.BlockPosition[] destroyedBlocks=(soupply.protocol.pocket101.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class LevelSoundEvent : Pocket101Packet
{
...
class LevelEvent : Pocket101Packet
{
...
class BlockEvent : Pocket101Packet
{
    ...
    this(soupply.protocol.pocket101.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class EntityEvent : Pocket101Packet
{
...
class MobEffect : Pocket101Packet
{
...
class UpdateAttributes : Pocket101Packet
{
    ...
    this(long entityId, soupply.protocol.pocket101.types.Attribute[] attributes=(soupply.protocol.pocket101.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class MobEquipment : Pocket101Packet
{
    ...
    this(long entityId, soupply.protocol.pocket101.types.Slot item=soupply.protocol.pocket101.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Pocket101Packet
{
    ...
    @Var long entityId;
    soupply.protocol.pocket101.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.protocol.pocket101.types.Slot[4] armor=(soupply.protocol.pocket101.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class Interact : Pocket101Packet
{
...
class UseItem : Pocket101Packet
{
    ...
    soupply.protocol.pocket101.types.BlockPosition blockPosition;
    @Var uint hotbarSlot;
    @Var int face;
    ...
    this(soupply.protocol.pocket101.types.BlockPosition blockPosition, uint hotbarSlot=uint.init, int face=int.init, Tuple!(float, "xyz") facePosition=Tuple!(float, "xyz").init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, int slot=int.init, soupply.protocol.pocket101.types.Slot item=soupply.protocol.pocket101.types.Slot.init) pure nothrow @safe @nogc
    {
...
class PlayerAction : Pocket101Packet
{
    ...
    this(long entityId, int action=int.init, soupply.protocol.pocket101.types.BlockPosition position=soupply.protocol.pocket101.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class PlayerFall : Pocket101Packet
{
...
class HurtArmor : Pocket101Packet
{
...
class SetEntityData : Pocket101Packet
{
...
class SetEntityMotion : Pocket101Packet
{
...
class SetEntityLink : Pocket101Packet
{
...
class SetHealth : Pocket101Packet
{
...
class SetSpawnPosition : Pocket101Packet
{
    ...
    this(int unknown0, soupply.protocol.pocket101.types.BlockPosition position=soupply.protocol.pocket101.types.BlockPosition.init, bool unknown2=bool.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
        this.unknown2 = unknown2;
...
class DropItem : Pocket101Packet
{
    ...
    this(ubyte action, soupply.protocol.pocket101.types.Slot item=soupply.protocol.pocket101.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class InventoryAction : Pocket101Packet
{
    ...
    this(int action, soupply.protocol.pocket101.types.Slot item=soupply.protocol.pocket101.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class ContainerOpen : Pocket101Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, int slotCount=int.init, soupply.protocol.pocket101.types.BlockPosition position=soupply.protocol.pocket101.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
...
class ContainerClose : Pocket101Packet
{
...
class ContainerSetSlot : Pocket101Packet
{
    ...
    this(ubyte window, int slot=int.init, int hotbarSlot=int.init, soupply.protocol.pocket101.types.Slot item=soupply.protocol.pocket101.types.Slot.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.hotbarSlot = hotbarSlot;
...
class ContainerSetData : Pocket101Packet
{
...
class ContainerSetContent : Pocket101Packet
{
    ...
    ubyte window;
    soupply.protocol.pocket101.types.Slot[] slots;
    @Var int[] hotbar;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.protocol.pocket101.types.Slot[] slots=(soupply.protocol.pocket101.types.Slot[]).init, int[] hotbar=(int[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
        this.hotbar = hotbar;
...
class CraftingData : Pocket101Packet
{
    ...
    soupply.protocol.pocket101.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.pocket101.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Pocket101Packet
{
    ...
    @Var int type;
    UUID uuid;
    soupply.protocol.pocket101.types.Slot[] input;
    soupply.protocol.pocket101.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, UUID uuid=UUID.init, soupply.protocol.pocket101.types.Slot[] input=(soupply.protocol.pocket101.types.Slot[]).init, soupply.protocol.pocket101.types.Slot[] output=(soupply.protocol.pocket101.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class AdventureSettings : Pocket101Packet
{
...
class BlockEntityData : Pocket101Packet
{
    ...
    this(soupply.protocol.pocket101.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerInput : Pocket101Packet
{
...
class FullChunkData : Pocket101Packet
{
    ...
    soupply.protocol.pocket101.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") position, soupply.protocol.pocket101.types.ChunkData data=soupply.protocol.pocket101.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class SetCommandsEnabled : Pocket101Packet
{
...
class SetDifficulty : Pocket101Packet
{
...
class ChangeDimension : Pocket101Packet
{
...
class SetPlayerGameType : Pocket101Packet
{
...
class PlayerList : Pocket101Packet
{
    ...
    class Add : Pocket101Packet
    {
        ...
        soupply.protocol.pocket101.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.pocket101.types.PlayerList[] players) pure nothrow @safe @nogc
        {
...
class TelemetryEvent : Pocket101Packet
{
...
class SpawnExperienceOrb : Pocket101Packet
{
...
class ClientboundMapItemData : Pocket101Packet
{
    ...
    @Condition("update==4") soupply.protocol.pocket101.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.protocol.pocket101.types.Decoration[] decorations=(soupply.protocol.pocket101.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class MapInfoRequest : Pocket101Packet
{
...
class RequestChunkRadius : Pocket101Packet
{
...
class ChunkRadiusUpdated : Pocket101Packet
{
...
class ItemFrameDropItem : Pocket101Packet
{
    ...
    this(soupply.protocol.pocket101.types.BlockPosition position, soupply.protocol.pocket101.types.Slot item=soupply.protocol.pocket101.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class ReplaceSelectedItem : Pocket101Packet
{
    ...
    this(soupply.protocol.pocket101.types.Slot item) pure nothrow @safe @nogc
    {
        this.item = item;
    }
...
class GameRulesChanged : Pocket101Packet
{
    ...
    @Length!uint soupply.protocol.pocket101.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.pocket101.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class BossEvent : Pocket101Packet
{
...
class ShowCredits : Pocket101Packet
{
...
class AvailableCommands : Pocket101Packet
{
...
class CommandStep : Pocket101Packet
{
...
class ResourcePackDataInfo : Pocket101Packet
{
...
class ResourcePackChunkData : Pocket101Packet
{
...
class ResourcePackChunkRequest : Pocket101Packet
{
...
class Transfer : Pocket101Packet
{
