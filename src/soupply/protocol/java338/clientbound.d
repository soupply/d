 ...
 * Generated from protocol/java338
 */
module soupply.protocol.java338.clientbound;
...
import soupply.metadata.java338;
import soupply.protocol.java338.packet : Java338Packet;

static import soupply.protocol.java338.types;
...
class SpawnObject : Java338Packet
{
...
class SpawnExperienceOrb : Java338Packet
{
...
class SpawnGlobalEntity : Java338Packet
{
...
class SpawnMob : Java338Packet
{
    ...
    this(uint entityId, UUID uuid=UUID.init, uint type=uint.init, Tuple!(double, "xyz") position=Tuple!(double, "xyz").init, ubyte yaw=ubyte.init, ubyte pitch=ubyte.init, ubyte headPitch=ubyte.init, Tuple!(short, "xyz") velocity=Tuple!(short, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.uuid = uuid;
        this.type = type;
...
class SpawnPainting : Java338Packet
{
...
class SpawnPlayer : Java338Packet
{
...
class Statistics : Java338Packet
{
    ...
    soupply.protocol.java338.types.Statistic[] statistics;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.java338.types.Statistic[] statistics) pure nothrow @safe @nogc
    {
...
class BlockBreakAnimation : Java338Packet
{
...
class UpdateBlockEntity : Java338Packet
{
...
class BlockAction : Java338Packet
{
...
class BlockChange : Java338Packet
{
...
class BossBar : Java338Packet
{
    ...
    class UpdateHealth : Java338Packet
    {
    ...
    class UpdateTitle : Java338Packet
    {
    ...
    class UpdateStyle : Java338Packet
    {
    ...
    class UpdateFlags : Java338Packet
    {
...
class ServerDifficulty : Java338Packet
{
...
class TabComplete : Java338Packet
{
...
class ChatMessage : Java338Packet
{
...
class MultiBlockChange : Java338Packet
{
    ...
    Tuple!(int, "xz") chunk;
    soupply.protocol.java338.types.BlockChange[] changes;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") chunk, soupply.protocol.java338.types.BlockChange[] changes=(soupply.protocol.java338.types.BlockChange[]).init) pure nothrow @safe @nogc
    {
        this.chunk = chunk;
...
class ConfirmTransaction : Java338Packet
{
...
class CloseWindow : Java338Packet
{
...
class OpenWindow : Java338Packet
{
...
class WindowItems : Java338Packet
{
    ...
    ubyte window;
    @Length!ushort soupply.protocol.java338.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.protocol.java338.types.Slot[] slots=(soupply.protocol.java338.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class WindowProperty : Java338Packet
{
...
class SetSlot : Java338Packet
{
    ...
    ubyte window;
    ushort slot;
    soupply.protocol.java338.types.Slot item;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, soupply.protocol.java338.types.Slot item=soupply.protocol.java338.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.item = item;
...
class SetCooldown : Java338Packet
{
...
class PluginMessage : Java338Packet
{
...
class NamedSoundEffect : Java338Packet
{
...
class Disconnect : Java338Packet
{
...
class EntityStatus : Java338Packet
{
...
class UnloadChunk : Java338Packet
{
...
class ChangeGameState : Java338Packet
{
...
class Map : Java338Packet
{
    ...
    ubyte scale;
    bool showIcons;
    soupply.protocol.java338.types.Icon[] icons;
    ubyte colums;
    ubyte rows;
    ...
    this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.protocol.java338.types.Icon[] icons=(soupply.protocol.java338.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "xz") offset=Tuple!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.scale = scale;
...
class EntityRelativeMove : Java338Packet
{
...
class EntityLookAndRelativeMove : Java338Packet
{
...
class EntityLook : Java338Packet
{
...
class VehicleMove : Java338Packet
{
...
class OpenSignEditor : Java338Packet
{
...
class CraftRecipeResponse : Java338Packet
{
...
class PlayerAbilities : Java338Packet
{
...
class CombatEvent : Java338Packet
{
    ...
    class EnterCombat : Java338Packet
    {
    ...
    class EntityDead : Java338Packet
    {
...
class PlayerListItem : Java338Packet
{
    ...
    class AddPlayer : Java338Packet
    {
        ...
        soupply.protocol.java338.types.ListAddPlayer[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java338.types.ListAddPlayer[] players) pure nothrow @safe @nogc
        {
    ...
    class UpdateGamemode : Java338Packet
    {
        ...
        soupply.protocol.java338.types.ListUpdateGamemode[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java338.types.ListUpdateGamemode[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateLatency : Java338Packet
    {
        ...
        soupply.protocol.java338.types.ListUpdateLatency[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java338.types.ListUpdateLatency[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateDisplayName : Java338Packet
    {
        ...
        soupply.protocol.java338.types.ListUpdateDisplayName[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java338.types.ListUpdateDisplayName[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class RemovePlayer : Java338Packet
    {
...
class PlayerPositionAndLook : Java338Packet
{
...
class UnlockRecipes : Java338Packet
{
    ...
    enum string[] __fields = ["action", "openBook", "filtering", "recipes", "bookRecipes"];
    ...
    this(uint action, bool openBook=bool.init, bool filtering=bool.init, uint[] recipes=(uint[]).init, uint[] bookRecipes=(uint[]).init) pure nothrow @safe @nogc
    {
        this.action = action;
    ...
    public override string toString()
    {
        return "UnlockRecipes(action: " ~ std.conv.to!string(this.action) ~ ", openBook: " ~ std.conv.to!string(this.openBook) ~ ", filtering: " ~ std.conv.to!string(this.filtering) ~ ", recipes: " ~ std.conv.to!string(this.recipes) ~ ", bookRecipes: " ~ std.conv.to!string(this.bookRecipes) ~ ")";
    }

}

class DestroyEntities : Java338Packet
{
...
class RemoveEntityEffect : Java338Packet
{
...
class ResourcePackSend : Java338Packet
{
...
class EntityHeadLook : Java338Packet
{
...
class AdvancementProgress : Java338Packet
{
...
class WorldBorder : Java338Packet
{
    ...
    class Initialize : Java338Packet
    {
    ...
    class SetWarningTime : Java338Packet
    {
    ...
    class SetWarningBlocks : Java338Packet
    {
...
class HeldItemChange : Java338Packet
{
...
class DisplayScoreboard : Java338Packet
{
...
class EntityMetadata : Java338Packet
{
...
class AttachEntity : Java338Packet
{
...
class EntityVelocity : Java338Packet
{
...
class EntityEquipment : Java338Packet
{
    ...
    this(uint entityId, uint slot=uint.init, soupply.protocol.java338.types.Slot item=soupply.protocol.java338.types.Slot.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.slot = slot;
        this.item = item;
...
class SetExperience : Java338Packet
{
...
class ScoreboardObjective : Java338Packet
{
...
class SetPassengers : Java338Packet
{
...
class Teams : Java338Packet
{
    ...
    class CreateTeam : Java338Packet
    {
    ...
    class RemoveTeam : Java338Packet
    {
    ...
    class UpdateTeamInfo : Java338Packet
    {
    ...
    class AddPlayers : Java338Packet
    {
    ...
    class RemovePlayers : Java338Packet
    {
...
class UpdateScore : Java338Packet
{
...
class SpawnPosition : Java338Packet
{
...
class TimeUpdate : Java338Packet
{
...
class Title : Java338Packet
{
    ...
    class SetSubtitle : Java338Packet
    {
    ...
    class SetActionBar : Java338Packet
    {
    ...
    class SetTimings : Java338Packet
    {
...
class SoundEffect : Java338Packet
{
...
class PlayerListHeaderAndFooter : Java338Packet
{
...
class CollectItem : Java338Packet
{
...
class EntityTeleport : Java338Packet
{
...
class Advencements : Java338Packet
{
...
class EntityProperties : Java338Packet
{
    ...
    @Var uint entityId;
    @Length!uint soupply.protocol.java338.types.Attribute[] attributes;

    this() pure nothrow @safe @nogc {}

    this(uint entityId, soupply.protocol.java338.types.Attribute[] attributes=(soupply.protocol.java338.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
...
class EntityEffect : Java338Packet
{
