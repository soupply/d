 ...
 */
module soupply.protocol.java338.serverbound;
...
class TeleportConfirm : Java338Packet
{
...
class ClientStatus : Java338Packet
{
...
class ClientSettings : Java338Packet
{
...
class EnchantItem : Java338Packet
{
...
class ClickWindow : Java338Packet
{
    ...
    ushort action;
    @Var uint mode;
    soupply.protocol.java338.types.Slot clickedItem;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, soupply.protocol.java338.types.Slot clickedItem=soupply.protocol.java338.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.button = button;
...
class PlayerPosition : Java338Packet
{
...
class PlayerLook : Java338Packet
{
...
class CraftRecipeRequest : Java338Packet
{
...
class PlayerDigging : Java338Packet
{
...
class EntityAction : Java338Packet
{
...
class SteerVehicle : Java338Packet
{
...
class CraftingBookData : Java338Packet
{
    ...
    class DisplayedRecipe : Java338Packet
    {
    ...
    class CraftingBookStatus : Java338Packet
    {
...
class ResourcePackStatus : Java338Packet
{
...
class AdvencementTab : Java338Packet
{
...
class CreativeInventoryAction : Java338Packet
{
    ...
    this(ushort slot, soupply.protocol.java338.types.Slot clickedItem=soupply.protocol.java338.types.Slot.init) pure nothrow @safe @nogc
    {
        this.slot = slot;
        this.clickedItem = clickedItem;
    }
...
class UpdateSign : Java338Packet
{
...
class PlayerBlockPlacement : Java338Packet
{
