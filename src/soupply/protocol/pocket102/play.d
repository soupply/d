 ...
 * Generated from protocol/pocket102
 */
module soupply.protocol.pocket102.play;
...
import soupply.metadata.pocket102;
import soupply.protocol.pocket102.packet : Pocket102Packet;

static import soupply.protocol.pocket102.types;
...
class PlayStatus : Pocket102Packet
{
...
class ServerToClientHandshake : Pocket102Packet
{
...
class ClientToServerHandshake : Pocket102Packet
{
...
class Disconnect : Pocket102Packet
{
...
class ResourcePacksInfo : Pocket102Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket102.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket102.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.pocket102.types.PackWithSize[] behaviourPacks=(soupply.protocol.pocket102.types.PackWithSize[]).init, soupply.protocol.pocket102.types.PackWithSize[] resourcePacks=(soupply.protocol.pocket102.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Pocket102Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket102.types.Pack[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket102.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.pocket102.types.Pack[] behaviourPacks=(soupply.protocol.pocket102.types.Pack[]).init, soupply.protocol.pocket102.types.Pack[] resourcePacks=(soupply.protocol.pocket102.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class ResourcePackClientResponse : Pocket102Packet
{
...
class Text : Pocket102Packet
{
    ...
    class Translation : Pocket102Packet
    {
...
class StartGame : Pocket102Packet
{
...
class AddPlayer : Pocket102Packet
{
...
class AddEntity : Pocket102Packet
{
    ...
    float pitch;
    float yaw;
    soupply.protocol.pocket102.types.Attribute[] attributes;
    Metadata metadata;
    soupply.protocol.pocket102.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, uint type=uint.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.protocol.pocket102.types.Attribute[] attributes=(soupply.protocol.pocket102.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.protocol.pocket102.types.Link[] links=(soupply.protocol.pocket102.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class RemoveEntity : Pocket102Packet
{
...
class AddItemEntity : Pocket102Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.protocol.pocket102.types.Slot item;
    Tuple!(float, "xyz") position;
    Tuple!(float, "xyz") motion;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket102.types.Slot item=soupply.protocol.pocket102.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Pocket102Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.protocol.pocket102.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket102.types.BlockPosition position=soupply.protocol.pocket102.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class TakeItemEntity : Pocket102Packet
{
...
class MoveEntity : Pocket102Packet
{
...
class MovePlayer : Pocket102Packet
{
...
class RiderJump : Pocket102Packet
{
...
class RemoveBlock : Pocket102Packet
{
    ...
    this(soupply.protocol.pocket102.types.BlockPosition position) pure nothrow @safe @nogc
    {
        this.position = position;
    }
...
class UpdateBlock : Pocket102Packet
{
    ...
    this(soupply.protocol.pocket102.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Pocket102Packet
{
    ...
    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket102.types.BlockPosition position=soupply.protocol.pocket102.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Pocket102Packet
{
    ...
    Tuple!(float, "xyz") position;
    float radius;
    soupply.protocol.pocket102.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.protocol.pocket102.types.BlockPosition[] destroyedBlocks=(soupply.protocol.pocket102.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class LevelSoundEvent : Pocket102Packet
{
...
class LevelEvent : Pocket102Packet
{
...
class BlockEvent : Pocket102Packet
{
    ...
    this(soupply.protocol.pocket102.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class EntityEvent : Pocket102Packet
{
...
class MobEffect : Pocket102Packet
{
...
class UpdateAttributes : Pocket102Packet
{
    ...
    this(long entityId, soupply.protocol.pocket102.types.Attribute[] attributes=(soupply.protocol.pocket102.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class MobEquipment : Pocket102Packet
{
    ...
    this(long entityId, soupply.protocol.pocket102.types.Slot item=soupply.protocol.pocket102.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Pocket102Packet
{
    ...
    @Var long entityId;
    soupply.protocol.pocket102.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.protocol.pocket102.types.Slot[4] armor=(soupply.protocol.pocket102.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class Interact : Pocket102Packet
{
...
class UseItem : Pocket102Packet
{
    ...
    soupply.protocol.pocket102.types.BlockPosition blockPosition;
    @Var uint hotbarSlot;
    @Var int face;
    ...
    this(soupply.protocol.pocket102.types.BlockPosition blockPosition, uint hotbarSlot=uint.init, int face=int.init, Tuple!(float, "xyz") facePosition=Tuple!(float, "xyz").init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, int slot=int.init, soupply.protocol.pocket102.types.Slot item=soupply.protocol.pocket102.types.Slot.init) pure nothrow @safe @nogc
    {
...
class PlayerAction : Pocket102Packet
{
    ...
    this(long entityId, int action=int.init, soupply.protocol.pocket102.types.BlockPosition position=soupply.protocol.pocket102.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class PlayerFall : Pocket102Packet
{
...
class HurtArmor : Pocket102Packet
{
...
class SetEntityData : Pocket102Packet
{
...
class SetEntityMotion : Pocket102Packet
{
...
class SetEntityLink : Pocket102Packet
{
...
class SetHealth : Pocket102Packet
{
...
class SetSpawnPosition : Pocket102Packet
{
    ...
    this(int unknown0, soupply.protocol.pocket102.types.BlockPosition position=soupply.protocol.pocket102.types.BlockPosition.init, bool unknown2=bool.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
        this.unknown2 = unknown2;
...
class DropItem : Pocket102Packet
{
    ...
    this(ubyte action, soupply.protocol.pocket102.types.Slot item=soupply.protocol.pocket102.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class InventoryAction : Pocket102Packet
{
    ...
    this(int action, soupply.protocol.pocket102.types.Slot item=soupply.protocol.pocket102.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class ContainerOpen : Pocket102Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, int slotCount=int.init, soupply.protocol.pocket102.types.BlockPosition position=soupply.protocol.pocket102.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
...
class ContainerClose : Pocket102Packet
{
...
class ContainerSetSlot : Pocket102Packet
{
    ...
    this(ubyte window, int slot=int.init, int hotbarSlot=int.init, soupply.protocol.pocket102.types.Slot item=soupply.protocol.pocket102.types.Slot.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.hotbarSlot = hotbarSlot;
...
class ContainerSetData : Pocket102Packet
{
...
class ContainerSetContent : Pocket102Packet
{
    ...
    ubyte window;
    soupply.protocol.pocket102.types.Slot[] slots;
    @Var int[] hotbar;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.protocol.pocket102.types.Slot[] slots=(soupply.protocol.pocket102.types.Slot[]).init, int[] hotbar=(int[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
        this.hotbar = hotbar;
...
class CraftingData : Pocket102Packet
{
    ...
    soupply.protocol.pocket102.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.pocket102.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Pocket102Packet
{
    ...
    @Var int type;
    UUID uuid;
    soupply.protocol.pocket102.types.Slot[] input;
    soupply.protocol.pocket102.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, UUID uuid=UUID.init, soupply.protocol.pocket102.types.Slot[] input=(soupply.protocol.pocket102.types.Slot[]).init, soupply.protocol.pocket102.types.Slot[] output=(soupply.protocol.pocket102.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class AdventureSettings : Pocket102Packet
{
...
class BlockEntityData : Pocket102Packet
{
    ...
    this(soupply.protocol.pocket102.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerInput : Pocket102Packet
{
...
class FullChunkData : Pocket102Packet
{
    ...
    soupply.protocol.pocket102.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") position, soupply.protocol.pocket102.types.ChunkData data=soupply.protocol.pocket102.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class SetCommandsEnabled : Pocket102Packet
{
...
class SetDifficulty : Pocket102Packet
{
...
class ChangeDimension : Pocket102Packet
{
...
class SetPlayerGameType : Pocket102Packet
{
...
class PlayerList : Pocket102Packet
{
    ...
    class Add : Pocket102Packet
    {
        ...
        soupply.protocol.pocket102.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.pocket102.types.PlayerList[] players) pure nothrow @safe @nogc
        {
...
class TelemetryEvent : Pocket102Packet
{
...
class SpawnExperienceOrb : Pocket102Packet
{
...
class ClientboundMapItemData : Pocket102Packet
{
    ...
    @Condition("update==4") soupply.protocol.pocket102.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.protocol.pocket102.types.Decoration[] decorations=(soupply.protocol.pocket102.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class MapInfoRequest : Pocket102Packet
{
...
class RequestChunkRadius : Pocket102Packet
{
...
class ChunkRadiusUpdated : Pocket102Packet
{
...
class ItemFrameDropItem : Pocket102Packet
{
    ...
    this(soupply.protocol.pocket102.types.BlockPosition position, soupply.protocol.pocket102.types.Slot item=soupply.protocol.pocket102.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class ReplaceSelectedItem : Pocket102Packet
{
    ...
    this(soupply.protocol.pocket102.types.Slot item) pure nothrow @safe @nogc
    {
        this.item = item;
    }
...
class GameRulesChanged : Pocket102Packet
{
    ...
    @Length!uint soupply.protocol.pocket102.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.pocket102.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class BossEvent : Pocket102Packet
{
...
class ShowCredits : Pocket102Packet
{
...
class AvailableCommands : Pocket102Packet
{
...
class CommandStep : Pocket102Packet
{
...
class UpdateTrade : Pocket102Packet
{
...
class ResourcePackDataInfo : Pocket102Packet
{
...
class ResourcePackChunkData : Pocket102Packet
{
...
class ResourcePackChunkRequest : Pocket102Packet
{
...
class Transfer : Pocket102Packet
{
