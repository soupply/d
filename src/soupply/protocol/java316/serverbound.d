 ...
 */
module soupply.protocol.java316.serverbound;
...
class ClickWindow : Java316Packet
{
    ...
    ushort action;
    @Var uint mode;
    soupply.protocol.java316.types.Slot clickedItem;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, soupply.protocol.java316.types.Slot clickedItem=soupply.protocol.java316.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.button = button;
...
class CreativeInventoryAction : Java316Packet
{
    ...
    this(ushort slot, soupply.protocol.java316.types.Slot clickedItem=soupply.protocol.java316.types.Slot.init) pure nothrow @safe @nogc
    {
        this.slot = slot;
        this.clickedItem = clickedItem;
    }
