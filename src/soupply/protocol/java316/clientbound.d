 ...
 * Generated from protocol/java316
 */
module soupply.protocol.java316.clientbound;
...
import soupply.metadata.java316;
import soupply.protocol.java316.packet : Java316Packet;

static import soupply.protocol.java316.types;
...
class Statistics : Java316Packet
{
    ...
    soupply.protocol.java316.types.Statistic[] statistics;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.java316.types.Statistic[] statistics) pure nothrow @safe @nogc
    {
...
class MultiBlockChange : Java316Packet
{
    ...
    Tuple!(int, "xz") chunk;
    soupply.protocol.java316.types.BlockChange[] changes;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") chunk, soupply.protocol.java316.types.BlockChange[] changes=(soupply.protocol.java316.types.BlockChange[]).init) pure nothrow @safe @nogc
    {
        this.chunk = chunk;
...
class WindowItems : Java316Packet
{
    ...
    ubyte window;
    @Length!ushort soupply.protocol.java316.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.protocol.java316.types.Slot[] slots=(soupply.protocol.java316.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class SetSlot : Java316Packet
{
    ...
    ubyte window;
    ushort slot;
    soupply.protocol.java316.types.Slot item;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, soupply.protocol.java316.types.Slot item=soupply.protocol.java316.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.item = item;
...
class Map : Java316Packet
{
    ...
    ubyte scale;
    bool showIcons;
    soupply.protocol.java316.types.Icon[] icons;
    ubyte colums;
    ubyte rows;
    ...
    this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.protocol.java316.types.Icon[] icons=(soupply.protocol.java316.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "xz") offset=Tuple!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.scale = scale;
...
class PlayerListItem : Java316Packet
{
    ...
    class AddPlayer : Java316Packet
    {
        ...
        soupply.protocol.java316.types.ListAddPlayer[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java316.types.ListAddPlayer[] players) pure nothrow @safe @nogc
        {
    ...
    class UpdateGamemode : Java316Packet
    {
        ...
        soupply.protocol.java316.types.ListUpdateGamemode[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java316.types.ListUpdateGamemode[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateLatency : Java316Packet
    {
        ...
        soupply.protocol.java316.types.ListUpdateLatency[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java316.types.ListUpdateLatency[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateDisplayName : Java316Packet
    {
        ...
        soupply.protocol.java316.types.ListUpdateDisplayName[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java316.types.ListUpdateDisplayName[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class EntityEquipment : Java316Packet
{
    ...
    this(uint entityId, uint slot=uint.init, soupply.protocol.java316.types.Slot item=soupply.protocol.java316.types.Slot.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.slot = slot;
        this.item = item;
...
class EntityProperties : Java316Packet
{
    ...
    @Var uint entityId;
    @Length!uint soupply.protocol.java316.types.Attribute[] attributes;

    this() pure nothrow @safe @nogc {}

    this(uint entityId, soupply.protocol.java316.types.Attribute[] attributes=(soupply.protocol.java316.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
