 ...
 */
module soupply.protocol.java335.clientbound;
...
class SpawnObject : Java335Packet
{
...
class SpawnExperienceOrb : Java335Packet
{
...
class SpawnGlobalEntity : Java335Packet
{
...
class SpawnPainting : Java335Packet
{
...
class SpawnPlayer : Java335Packet
{
...
class Statistics : Java335Packet
{
    ...
    soupply.protocol.java335.types.Statistic[] statistics;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.java335.types.Statistic[] statistics) pure nothrow @safe @nogc
    {
...
class BlockBreakAnimation : Java335Packet
{
...
class UpdateBlockEntity : Java335Packet
{
...
class BlockAction : Java335Packet
{
...
class BlockChange : Java335Packet
{
...
class BossBar : Java335Packet
{
    ...
    class UpdateHealth : Java335Packet
    {
    ...
    class UpdateTitle : Java335Packet
    {
    ...
    class UpdateStyle : Java335Packet
    {
    ...
    class UpdateFlags : Java335Packet
    {
...
class ServerDifficulty : Java335Packet
{
...
class MultiBlockChange : Java335Packet
{
    ...
    Tuple!(int, "xz") chunk;
    soupply.protocol.java335.types.BlockChange[] changes;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") chunk, soupply.protocol.java335.types.BlockChange[] changes=(soupply.protocol.java335.types.BlockChange[]).init) pure nothrow @safe @nogc
    {
        this.chunk = chunk;
...
class OpenWindow : Java335Packet
{
...
class WindowItems : Java335Packet
{
    ...
    ubyte window;
    @Length!ushort soupply.protocol.java335.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.protocol.java335.types.Slot[] slots=(soupply.protocol.java335.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class WindowProperty : Java335Packet
{
...
class SetSlot : Java335Packet
{
    ...
    this(ubyte window, ushort slot=ushort.init, soupply.protocol.java335.types.Slot item=soupply.protocol.java335.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.item = item;
...
class SetCooldown : Java335Packet
{
...
class NamedSoundEffect : Java335Packet
{
...
class EntityStatus : Java335Packet
{
...
class UnloadChunk : Java335Packet
{
...
class ChangeGameState : Java335Packet
{
...
class Map : Java335Packet
{
    ...
    ubyte scale;
    bool showIcons;
    soupply.protocol.java335.types.Icon[] icons;
    ubyte colums;
    ubyte rows;
    ...
    this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.protocol.java335.types.Icon[] icons=(soupply.protocol.java335.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "xz") offset=Tuple!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.scale = scale;
...
class EntityRelativeMove : Java335Packet
{
...
class EntityLookAndRelativeMove : Java335Packet
{
...
class EntityLook : Java335Packet
{
...
class OpenSignEditor : Java335Packet
{
...
class CombatEvent : Java335Packet
{
    ...
    class EnterCombat : Java335Packet
    {
    ...
    class EntityDead : Java335Packet
    {
...
class PlayerListItem : Java335Packet
{
    ...
    class AddPlayer : Java335Packet
    {
        ...
        soupply.protocol.java335.types.ListAddPlayer[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java335.types.ListAddPlayer[] players) pure nothrow @safe @nogc
        {
    ...
    class UpdateGamemode : Java335Packet
    {
        ...
        soupply.protocol.java335.types.ListUpdateGamemode[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java335.types.ListUpdateGamemode[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateLatency : Java335Packet
    {
        ...
        soupply.protocol.java335.types.ListUpdateLatency[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java335.types.ListUpdateLatency[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateDisplayName : Java335Packet
    {
        ...
        soupply.protocol.java335.types.ListUpdateDisplayName[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java335.types.ListUpdateDisplayName[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class RemovePlayer : Java335Packet
    {
...
class UnlockRecipes : Java335Packet
{
...
class DestroyEntities : Java335Packet
{
...
class RemoveEntityEffect : Java335Packet
{
...
class ResourcePackSend : Java335Packet
{
...
class EntityHeadLook : Java335Packet
{
...
class AdvancementProgress : Java335Packet
{
...
class WorldBorder : Java335Packet
{
    ...
    class Initialize : Java335Packet
    {
    ...
    class SetWarningTime : Java335Packet
    {
    ...
    class SetWarningBlocks : Java335Packet
    {
...
class DisplayScoreboard : Java335Packet
{
...
class EntityMetadata : Java335Packet
{
...
class AttachEntity : Java335Packet
{
...
class EntityVelocity : Java335Packet
{
...
class EntityEquipment : Java335Packet
{
    ...
    this(uint entityId, uint slot=uint.init, soupply.protocol.java335.types.Slot item=soupply.protocol.java335.types.Slot.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.slot = slot;
        this.item = item;
...
class SetExperience : Java335Packet
{
...
class ScoreboardObjective : Java335Packet
{
...
class SetPassengers : Java335Packet
{
...
class Teams : Java335Packet
{
    ...
    class CreateTeam : Java335Packet
    {
    ...
    class RemoveTeam : Java335Packet
    {
    ...
    class UpdateTeamInfo : Java335Packet
    {
    ...
    class AddPlayers : Java335Packet
    {
    ...
    class RemovePlayers : Java335Packet
    {
...
class UpdateScore : Java335Packet
{
...
class SpawnPosition : Java335Packet
{
...
class TimeUpdate : Java335Packet
{
...
class Title : Java335Packet
{
    ...
    class SetSubtitle : Java335Packet
    {
    ...
    class SetActionBar : Java335Packet
    {
    ...
    class SetTimings : Java335Packet
    {
...
class SoundEffect : Java335Packet
{
...
class PlayerListHeaderAndFooter : Java335Packet
{
...
class CollectItem : Java335Packet
{
...
class EntityTeleport : Java335Packet
{
...
class Advencements : Java335Packet
{
...
class EntityProperties : Java335Packet
{
    ...
    @Var uint entityId;
    @Length!uint soupply.protocol.java335.types.Attribute[] attributes;

    this() pure nothrow @safe @nogc {}

    this(uint entityId, soupply.protocol.java335.types.Attribute[] attributes=(soupply.protocol.java335.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
...
class EntityEffect : Java335Packet
{
