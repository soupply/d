 ...
 * Generated from protocol/bedrock141
 */
module soupply.protocol.bedrock141.play;
...
import soupply.metadata.bedrock141;
import soupply.protocol.bedrock141.packet : Bedrock141Packet;

static import soupply.protocol.bedrock141.types;
...
class Login : Bedrock141Packet
{
    ...
    @BigEndian uint protocol = 141;
    soupply.protocol.bedrock141.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.protocol.bedrock141.types.LoginBody body_=soupply.protocol.bedrock141.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class PlayStatus : Bedrock141Packet
{
...
class ServerToClientHandshake : Bedrock141Packet
{
...
class ClientToServerHandshake : Bedrock141Packet
{
...
class Disconnect : Bedrock141Packet
{
...
class ResourcePacksInfo : Bedrock141Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.bigEndian) soupply.protocol.bedrock141.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.bigEndian) soupply.protocol.bedrock141.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.bedrock141.types.PackWithSize[] behaviourPacks=(soupply.protocol.bedrock141.types.PackWithSize[]).init, soupply.protocol.bedrock141.types.PackWithSize[] resourcePacks=(soupply.protocol.bedrock141.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock141Packet
{
    ...
    bool mustAccept;
    soupply.protocol.bedrock141.types.Pack[] behaviourPacks;
    soupply.protocol.bedrock141.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.bedrock141.types.Pack[] behaviourPacks=(soupply.protocol.bedrock141.types.Pack[]).init, soupply.protocol.bedrock141.types.Pack[] resourcePacks=(soupply.protocol.bedrock141.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class ResourcePackClientResponse : Bedrock141Packet
{
...
class Text : Bedrock141Packet
{
    ...
    class Translation : Bedrock141Packet
    {
    ...
    class JukeboxPopup : Bedrock141Packet
    {
    ...
    class Whisper : Bedrock141Packet
    {
    ...
    class Announcement : Bedrock141Packet
    {
...
class SetTime : Bedrock141Packet
{
...
class StartGame : Bedrock141Packet
{
    ...
    soupply.protocol.bedrock141.types.Rule[] gameRules;
...
class AddPlayer : Bedrock141Packet
{
    ...
    soupply.protocol.bedrock141.types.McpeUuid uuid;
    string username;
    @Var long entityId;
    @Var ulong runtimeId;
    Tuple!(float, "xyz") position;
    ...
    float headYaw;
    float yaw;
    soupply.protocol.bedrock141.types.Slot heldItem;
    Metadata metadata;
    @Var uint unknown11;
    @Var uint unknown12;
    @Var uint unknown13;
    ...
    @Var uint unknown15;
    long unknown16;
    soupply.protocol.bedrock141.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock141.types.McpeUuid uuid, string username=string.init, long entityId=long.init, ulong runtimeId=ulong.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float headYaw=float.init, float yaw=float.init, soupply.protocol.bedrock141.types.Slot heldItem=soupply.protocol.bedrock141.types.Slot.init, Metadata metadata=Metadata.init, uint unknown11=uint.init, uint unknown12=uint.init, uint unknown13=uint.init, uint unknown14=uint.init, uint unknown15=uint.init, long unknown16=long.init, soupply.protocol.bedrock141.types.Link[] links=(soupply.protocol.bedrock141.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
...
class AddEntity : Bedrock141Packet
{
    ...
    float pitch;
    float yaw;
    soupply.protocol.bedrock141.types.Attribute[] attributes;
    Metadata metadata;
    soupply.protocol.bedrock141.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, uint type=uint.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.protocol.bedrock141.types.Attribute[] attributes=(soupply.protocol.bedrock141.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.protocol.bedrock141.types.Link[] links=(soupply.protocol.bedrock141.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class RemoveEntity : Bedrock141Packet
{
...
class AddItemEntity : Bedrock141Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.protocol.bedrock141.types.Slot item;
    Tuple!(float, "xyz") position;
    Tuple!(float, "xyz") motion;
    Metadata metadata;
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock141.types.Slot item=soupply.protocol.bedrock141.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Bedrock141Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.protocol.bedrock141.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock141.types.BlockPosition position=soupply.protocol.bedrock141.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class TakeItemEntity : Bedrock141Packet
{
...
class MoveEntity : Bedrock141Packet
{
...
class MovePlayer : Bedrock141Packet
{
...
class RiderJump : Bedrock141Packet
{
...
class UpdateBlock : Bedrock141Packet
{
    ...
    this(soupply.protocol.bedrock141.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Bedrock141Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock141.types.BlockPosition position=soupply.protocol.bedrock141.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Bedrock141Packet
{
    ...
    Tuple!(float, "xyz") position;
    float radius;
    soupply.protocol.bedrock141.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.protocol.bedrock141.types.BlockPosition[] destroyedBlocks=(soupply.protocol.bedrock141.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class LevelSoundEvent : Bedrock141Packet
{
...
class LevelEvent : Bedrock141Packet
{
...
class BlockEvent : Bedrock141Packet
{
    ...
    this(soupply.protocol.bedrock141.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class EntityEvent : Bedrock141Packet
{
...
class MobEffect : Bedrock141Packet
{
...
class UpdateAttributes : Bedrock141Packet
{
    ...
    this(long entityId, soupply.protocol.bedrock141.types.Attribute[] attributes=(soupply.protocol.bedrock141.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock141Packet
{
    ...
    @Var uint type;
    soupply.protocol.bedrock141.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.protocol.bedrock141.types.InventoryAction[] actions=(soupply.protocol.bedrock141.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class Normal0 : Bedrock141Packet
    {
    ...
    class Normal1 : Bedrock141Packet
    {
    ...
    class UseItem : Bedrock141Packet
    {
        ...
        @Var uint actionType;
        soupply.protocol.bedrock141.types.BlockPosition blockPosition;
        @Var int face;
        @Var int hotbarSlot;
        soupply.protocol.bedrock141.types.Slot item;
        ...
        this(uint actionType, soupply.protocol.bedrock141.types.BlockPosition blockPosition=soupply.protocol.bedrock141.types.BlockPosition.init, int face=int.init, int hotbarSlot=int.init, soupply.protocol.bedrock141.types.Slot item=soupply.protocol.bedrock141.types.Slot.init, Tuple!(float, "xyz") playerPosition=Tuple!(float, "xyz").init, Tuple!(float, "xyz") clickPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
    ...
    class UseItemOnEntity : Bedrock141Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.protocol.bedrock141.types.Slot item=soupply.protocol.bedrock141.types.Slot.init, Tuple!(float, "xyz") unknown4=Tuple!(float, "xyz").init, Tuple!(float, "xyz") unknown5=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock141Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.protocol.bedrock141.types.Slot item=soupply.protocol.bedrock141.types.Slot.init, Tuple!(float, "xyz") headPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class MobEquipment : Bedrock141Packet
{
    ...
    this(long entityId, soupply.protocol.bedrock141.types.Slot item=soupply.protocol.bedrock141.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock141Packet
{
    ...
    @Var long entityId;
    soupply.protocol.bedrock141.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.protocol.bedrock141.types.Slot[4] armor=(soupply.protocol.bedrock141.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class Interact : Bedrock141Packet
{
...
class BlockPickRequest : Bedrock141Packet
{
...
class EntityPickRequest : Bedrock141Packet
{
...
class PlayerAction : Bedrock141Packet
{
    ...
    this(long entityId, int action=int.init, soupply.protocol.bedrock141.types.BlockPosition position=soupply.protocol.bedrock141.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class EntityFall : Bedrock141Packet
{
...
class HurtArmor : Bedrock141Packet
{
...
class SetEntityData : Bedrock141Packet
{
...
class SetEntityMotion : Bedrock141Packet
{
...
class SetEntityLink : Bedrock141Packet
{
...
class SetHealth : Bedrock141Packet
{
...
class SetSpawnPosition : Bedrock141Packet
{
    ...
    this(int type, soupply.protocol.bedrock141.types.BlockPosition position=soupply.protocol.bedrock141.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class Animate : Bedrock141Packet
{
...
class Respawn : Bedrock141Packet
{
...
class ContainerOpen : Bedrock141Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.protocol.bedrock141.types.BlockPosition position=soupply.protocol.bedrock141.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class ContainerClose : Bedrock141Packet
{
...
class PlayerHotbar : Bedrock141Packet
{
...
class InventoryContent : Bedrock141Packet
{
    ...
    @Var uint window;
    soupply.protocol.bedrock141.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.protocol.bedrock141.types.Slot[] slots=(soupply.protocol.bedrock141.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class InventorySlot : Bedrock141Packet
{
...
class ContainerSetData : Bedrock141Packet
{
...
class CraftingData : Bedrock141Packet
{
    ...
    soupply.protocol.bedrock141.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock141.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock141Packet
{
    ...
    @Var int type;
    soupply.protocol.bedrock141.types.McpeUuid uuid;
    soupply.protocol.bedrock141.types.Slot[] input;
    soupply.protocol.bedrock141.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.protocol.bedrock141.types.McpeUuid uuid=soupply.protocol.bedrock141.types.McpeUuid.init, soupply.protocol.bedrock141.types.Slot[] input=(soupply.protocol.bedrock141.types.Slot[]).init, soupply.protocol.bedrock141.types.Slot[] output=(soupply.protocol.bedrock141.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class GuiDataPickItem : Bedrock141Packet
{
...
class AdventureSettings : Bedrock141Packet
{
...
class BlockEntityData : Bedrock141Packet
{
    ...
    this(soupply.protocol.bedrock141.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerInput : Bedrock141Packet
{
...
class FullChunkData : Bedrock141Packet
{
    ...
    soupply.protocol.bedrock141.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") position, soupply.protocol.bedrock141.types.ChunkData data=soupply.protocol.bedrock141.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class SetCommandsEnabled : Bedrock141Packet
{
...
class SetDifficulty : Bedrock141Packet
{
...
class ChangeDimension : Bedrock141Packet
{
...
class SetPlayerGameType : Bedrock141Packet
{
...
class PlayerList : Bedrock141Packet
{
    ...
    class Add : Bedrock141Packet
    {
        ...
        soupply.protocol.bedrock141.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.bedrock141.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock141Packet
    {
        ...
        soupply.protocol.bedrock141.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.bedrock141.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class SimpleEvent : Bedrock141Packet
{
...
class TelemetryEvent : Bedrock141Packet
{
...
class SpawnExperienceOrb : Bedrock141Packet
{
...
class ClientboundMapItemData : Bedrock141Packet
{
    ...
    @Condition("update==4") soupply.protocol.bedrock141.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.protocol.bedrock141.types.Decoration[] decorations=(soupply.protocol.bedrock141.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class MapInfoRequest : Bedrock141Packet
{
...
class RequestChunkRadius : Bedrock141Packet
{
...
class ChunkRadiusUpdated : Bedrock141Packet
{
...
class ItemFrameDropItem : Bedrock141Packet
{
    ...
    this(soupply.protocol.bedrock141.types.BlockPosition position, soupply.protocol.bedrock141.types.Slot item=soupply.protocol.bedrock141.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock141Packet
{
    ...
    soupply.protocol.bedrock141.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock141.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class BossEvent : Bedrock141Packet
{
...
class ShowCredits : Bedrock141Packet
{
...
class AvailableCommands : Bedrock141Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.protocol.bedrock141.types.Enum[] enums;
    soupply.protocol.bedrock141.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.protocol.bedrock141.types.Enum[] enums=(soupply.protocol.bedrock141.types.Enum[]).init, soupply.protocol.bedrock141.types.Command[] commands=(soupply.protocol.bedrock141.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandRequest : Bedrock141Packet
{
    ...
    this(string command, uint type=uint.init, soupply.protocol.bedrock141.types.McpeUuid uuid=soupply.protocol.bedrock141.types.McpeUuid.init, string requestId=string.init, int playerId=int.init, bool internal=bool.init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock141Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.protocol.bedrock141.types.BlockPosition position;
    ...
    this(bool updateBlock, soupply.protocol.bedrock141.types.BlockPosition position=soupply.protocol.bedrock141.types.BlockPosition.init, uint mode=uint.init, bool redstoneMode=bool.init, bool conditional=bool.init, long minecart=long.init, string command=string.init, string lastOutput=string.init, string hover=string.init, bool trackOutput=bool.init) pure nothrow @safe @nogc
    {
...
class UpdateTrade : Bedrock141Packet
{
...
class UpdateEquip : Bedrock141Packet
{
...
class ResourcePackDataInfo : Bedrock141Packet
{
...
class ResourcePackChunkData : Bedrock141Packet
{
...
class ResourcePackChunkRequest : Bedrock141Packet
{
...
class Transfer : Bedrock141Packet
{
...
class PlaySound : Bedrock141Packet
{
    ...
    this(string name, soupply.protocol.bedrock141.types.BlockPosition position=soupply.protocol.bedrock141.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class StopSound : Bedrock141Packet
{
...
class SetTitle : Bedrock141Packet
{
...
class AddBehaviorTree : Bedrock141Packet
{
...
class StructureBlockUpdate : Bedrock141Packet
{
...
class ShowStoreOffer : Bedrock141Packet
{
...
class PurchaseReceipt : Bedrock141Packet
{
...
class PlayerSkin : Bedrock141Packet
{
    ...
    this(soupply.protocol.bedrock141.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
...
class SubClientLogin : Bedrock141Packet
{
...
class InitiateWebSocketConnection : Bedrock141Packet
{
...
class SetLastHurtBy : Bedrock141Packet
{
...
class BookEdit : Bedrock141Packet
{
    ...
    class ReplacePage : Bedrock141Packet
    {
    ...
    class AddPage : Bedrock141Packet
    {
    ...
    class DeletePage : Bedrock141Packet
    {
    ...
    class SwapPages : Bedrock141Packet
    {
...
class NpcRequest : Bedrock141Packet
{
...
class PhotoTransfer : Bedrock141Packet
{
...
class ModalFormRequest : Bedrock141Packet
{
...
class ModalFormResponse : Bedrock141Packet
{
...
class ServerSettingsRequest : Bedrock141Packet
{
...
class ServerSettingsResponse : Bedrock141Packet
{
...
class ShowProfile : Bedrock141Packet
{
...
class SetDefaultGameType : Bedrock141Packet
{
