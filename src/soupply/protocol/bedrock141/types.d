 ...
 */
module soupply.protocol.bedrock141.types;
...
struct PlayerList
{
    ...
    @Var long entityId;
    string displayName;
    soupply.protocol.bedrock141.types.Skin skin;
    string unknown4;
...
struct InventoryAction
{
    ...
    @Var uint slot;
    soupply.protocol.bedrock141.types.Slot oldItem;
    soupply.protocol.bedrock141.types.Slot newItem;
...
struct ChunkData
{
    ...
    soupply.protocol.bedrock141.types.Section[] sections;
    ushort[256] heights;
    ubyte[256] biomes;
    ubyte[] borders;
    soupply.protocol.bedrock141.types.ExtraData[] extraData;
...
struct Command
{
    ...
    int aliasesEnum = -1;
    soupply.protocol.bedrock141.types.Overload[] overloads;
...
struct Overload
{
    ...
    soupply.protocol.bedrock141.types.Parameter[] parameters;
