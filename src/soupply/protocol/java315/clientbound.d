 ...
 */
module soupply.protocol.java315.clientbound;
...
class SpawnObject : Java315Packet
{
...
class SpawnExperienceOrb : Java315Packet
{
...
class SpawnGlobalEntity : Java315Packet
{
...
class SpawnPainting : Java315Packet
{
...
class SpawnPlayer : Java315Packet
{
...
class Statistics : Java315Packet
{
	...
	soupply.protocol.java315.types.Statistic[] statistics;

	this() pure nothrow @safe @nogc {}

	this(soupply.protocol.java315.types.Statistic[] statistics) pure nothrow @safe @nogc
	{
...
class BlockBreakAnimation : Java315Packet
{
...
class UpdateBlockEntity : Java315Packet
{
...
class BlockAction : Java315Packet
{
...
class BlockChange : Java315Packet
{
...
class BossBar : Java315Packet
{
	...
	class UpdateHealth : Java315Packet
	{
	...
	class UpdateTitle : Java315Packet
	{
	...
	class UpdateStyle : Java315Packet
	{
	...
	class UpdateFlags : Java315Packet
	{
...
class ServerDifficulty : Java315Packet
{
...
class MultiBlockChange : Java315Packet
{
	...
	Tuple!(int, "xz") chunk;
	soupply.protocol.java315.types.BlockChange[] changes;

	this() pure nothrow @safe @nogc {}

	this(Tuple!(int, "xz") chunk, soupply.protocol.java315.types.BlockChange[] changes=(soupply.protocol.java315.types.BlockChange[]).init) pure nothrow @safe @nogc
	{
		this.chunk = chunk;
...
class OpenWindow : Java315Packet
{
...
class WindowItems : Java315Packet
{
	...
	ubyte window;
	@Length!ushort soupply.protocol.java315.types.Slot[] slots;

	this() pure nothrow @safe @nogc {}

	this(ubyte window, soupply.protocol.java315.types.Slot[] slots=(soupply.protocol.java315.types.Slot[]).init) pure nothrow @safe @nogc
	{
		this.window = window;
		this.slots = slots;
	}
...
class WindowProperty : Java315Packet
{
...
class SetSlot : Java315Packet
{
	...
	ubyte window;
	ushort slot;
	soupply.protocol.java315.types.Slot item;

	this() pure nothrow @safe @nogc {}

	this(ubyte window, ushort slot=ushort.init, soupply.protocol.java315.types.Slot item=soupply.protocol.java315.types.Slot.init) pure nothrow @safe @nogc
	{
		this.window = window;
		this.slot = slot;
		this.item = item;
...
class SetCooldown : Java315Packet
{
...
class NamedSoundEffect : Java315Packet
{
...
class EntityStatus : Java315Packet
{
...
class UnloadChunk : Java315Packet
{
...
class ChangeGameState : Java315Packet
{
...
class Map : Java315Packet
{
	...
	ubyte scale;
	bool showIcons;
	soupply.protocol.java315.types.Icon[] icons;
	ubyte colums;
	ubyte rows;
	...
	this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.protocol.java315.types.Icon[] icons=(soupply.protocol.java315.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "xz") offset=Tuple!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
	{
		this.mapId = mapId;
		this.scale = scale;
...
class EntityRelativeMove : Java315Packet
{
...
class EntityLookAndRelativeMove : Java315Packet
{
...
class EntityLook : Java315Packet
{
...
class OpenSignEditor : Java315Packet
{
...
class CombatEvent : Java315Packet
{
	...
	class EnterCombat : Java315Packet
	{
	...
	class EntityDead : Java315Packet
	{
...
class PlayerListItem : Java315Packet
{
	...
	class AddPlayer : Java315Packet
	{
		...
		soupply.protocol.java315.types.ListAddPlayer[] players;

		this() pure nothrow @safe @nogc {}

		this(soupply.protocol.java315.types.ListAddPlayer[] players) pure nothrow @safe @nogc
		{
	...
	class UpdateGamemode : Java315Packet
	{
		...
		soupply.protocol.java315.types.ListUpdateGamemode[] players;

		this() pure nothrow @safe @nogc {}

		this(soupply.protocol.java315.types.ListUpdateGamemode[] players) pure nothrow @safe @nogc
		{
			this.players = players;
		}
	...
	class UpdateLatency : Java315Packet
	{
		...
		soupply.protocol.java315.types.ListUpdateLatency[] players;

		this() pure nothrow @safe @nogc {}

		this(soupply.protocol.java315.types.ListUpdateLatency[] players) pure nothrow @safe @nogc
		{
			this.players = players;
		}
	...
	class UpdateDisplayName : Java315Packet
	{
		...
		soupply.protocol.java315.types.ListUpdateDisplayName[] players;

		this() pure nothrow @safe @nogc {}

		this(soupply.protocol.java315.types.ListUpdateDisplayName[] players) pure nothrow @safe @nogc
		{
			this.players = players;
		}
	...
	class RemovePlayer : Java315Packet
	{
...
class DestroyEntities : Java315Packet
{
...
class RemoveEntityEffect : Java315Packet
{
...
class ResourcePackSend : Java315Packet
{
...
class EntityHeadLook : Java315Packet
{
...
class WorldBorder : Java315Packet
{
	...
	class Initialize : Java315Packet
	{
	...
	class SetWarningTime : Java315Packet
	{
	...
	class SetWarningBlocks : Java315Packet
	{
...
class DisplayScoreboard : Java315Packet
{
...
class EntityMetadata : Java315Packet
{
...
class AttachEntity : Java315Packet
{
...
class EntityVelocity : Java315Packet
{
...
class EntityEquipment : Java315Packet
{
	...
	this(uint entityId, uint slot=uint.init, soupply.protocol.java315.types.Slot item=soupply.protocol.java315.types.Slot.init) pure nothrow @safe @nogc
	{
		this.entityId = entityId;
		this.slot = slot;
		this.item = item;
...
class SetExperience : Java315Packet
{
...
class ScoreboardObjective : Java315Packet
{
...
class SetPassengers : Java315Packet
{
...
class Teams : Java315Packet
{
	...
	class CreateTeam : Java315Packet
	{
	...
	class RemoveTeam : Java315Packet
	{
	...
	class UpdateTeamInfo : Java315Packet
	{
	...
	class AddPlayers : Java315Packet
	{
	...
	class RemovePlayers : Java315Packet
	{
...
class UpdateScore : Java315Packet
{
...
class SpawnPosition : Java315Packet
{
...
class TimeUpdate : Java315Packet
{
...
class Title : Java315Packet
{
	...
	class SetSubtitle : Java315Packet
	{
	...
	class SetActionBar : Java315Packet
	{
	...
	class SetTimings : Java315Packet
	{
...
class SoundEffect : Java315Packet
{
...
class PlayerListHeaderAndFooter : Java315Packet
{
...
class CollectItem : Java315Packet
{
...
class EntityTeleport : Java315Packet
{
...
class EntityProperties : Java315Packet
{
	...
	@Var uint entityId;
	@Length!uint soupply.protocol.java315.types.Attribute[] attributes;

	this() pure nothrow @safe @nogc {}

	this(uint entityId, soupply.protocol.java315.types.Attribute[] attributes=(soupply.protocol.java315.types.Attribute[]).init) pure nothrow @safe @nogc
	{
		this.entityId = entityId;
...
class EntityEffect : Java315Packet
{
