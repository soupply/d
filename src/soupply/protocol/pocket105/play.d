 ...
 * Generated from protocol/pocket105
 */
module soupply.protocol.pocket105.play;
...
import soupply.metadata.pocket105;
import soupply.protocol.pocket105.packet : Pocket105Packet;

static import soupply.protocol.pocket105.types;
...
class PlayStatus : Pocket105Packet
{
...
class ServerToClientHandshake : Pocket105Packet
{
...
class ClientToServerHandshake : Pocket105Packet
{
...
class Disconnect : Pocket105Packet
{
...
class ResourcePacksInfo : Pocket105Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket105.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket105.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.pocket105.types.PackWithSize[] behaviourPacks=(soupply.protocol.pocket105.types.PackWithSize[]).init, soupply.protocol.pocket105.types.PackWithSize[] resourcePacks=(soupply.protocol.pocket105.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Pocket105Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket105.types.Pack[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.protocol.pocket105.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.pocket105.types.Pack[] behaviourPacks=(soupply.protocol.pocket105.types.Pack[]).init, soupply.protocol.pocket105.types.Pack[] resourcePacks=(soupply.protocol.pocket105.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class ResourcePackClientResponse : Pocket105Packet
{
...
class Text : Pocket105Packet
{
    ...
    class Translation : Pocket105Packet
    {
...
class StartGame : Pocket105Packet
{
...
class AddPlayer : Pocket105Packet
{
...
class AddEntity : Pocket105Packet
{
    ...
    float pitch;
    float yaw;
    soupply.protocol.pocket105.types.Attribute[] attributes;
    Metadata metadata;
    soupply.protocol.pocket105.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, uint type=uint.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.protocol.pocket105.types.Attribute[] attributes=(soupply.protocol.pocket105.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.protocol.pocket105.types.Link[] links=(soupply.protocol.pocket105.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class RemoveEntity : Pocket105Packet
{
...
class AddItemEntity : Pocket105Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.protocol.pocket105.types.Slot item;
    Tuple!(float, "xyz") position;
    Tuple!(float, "xyz") motion;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket105.types.Slot item=soupply.protocol.pocket105.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Pocket105Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.protocol.pocket105.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket105.types.BlockPosition position=soupply.protocol.pocket105.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class TakeItemEntity : Pocket105Packet
{
...
class MoveEntity : Pocket105Packet
{
...
class MovePlayer : Pocket105Packet
{
...
class RiderJump : Pocket105Packet
{
...
class RemoveBlock : Pocket105Packet
{
    ...
    this(soupply.protocol.pocket105.types.BlockPosition position) pure nothrow @safe @nogc
    {
        this.position = position;
    }
...
class UpdateBlock : Pocket105Packet
{
    ...
    this(soupply.protocol.pocket105.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Pocket105Packet
{
    ...
    this(long entityId, long runtimeId=long.init, soupply.protocol.pocket105.types.BlockPosition position=soupply.protocol.pocket105.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Pocket105Packet
{
    ...
    Tuple!(float, "xyz") position;
    float radius;
    soupply.protocol.pocket105.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.protocol.pocket105.types.BlockPosition[] destroyedBlocks=(soupply.protocol.pocket105.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class LevelSoundEvent : Pocket105Packet
{
    ...
    enum ubyte HAGGLE = 90;
    enum ubyte HAGGLE_YES = 91;
    enum ubyte HAGGLE_NO = 92;
    enum ubyte HAGGLE_IDLE = 93;
    enum ubyte DEFAULT = 94;
    enum ubyte UNDEFINED = 95;
...
class LevelEvent : Pocket105Packet
{
...
class BlockEvent : Pocket105Packet
{
    ...
    this(soupply.protocol.pocket105.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class EntityEvent : Pocket105Packet
{
...
class MobEffect : Pocket105Packet
{
...
class UpdateAttributes : Pocket105Packet
{
    ...
    this(long entityId, soupply.protocol.pocket105.types.Attribute[] attributes=(soupply.protocol.pocket105.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class MobEquipment : Pocket105Packet
{
    ...
    this(long entityId, soupply.protocol.pocket105.types.Slot item=soupply.protocol.pocket105.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Pocket105Packet
{
    ...
    @Var long entityId;
    soupply.protocol.pocket105.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.protocol.pocket105.types.Slot[4] armor=(soupply.protocol.pocket105.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class Interact : Pocket105Packet
{
...
class BlockPickRequest : Pocket105Packet
{
...
class UseItem : Pocket105Packet
{
    ...
    soupply.protocol.pocket105.types.BlockPosition blockPosition;
    @Var uint hotbarSlot;
    @Var int face;
    ...
    this(soupply.protocol.pocket105.types.BlockPosition blockPosition, uint hotbarSlot=uint.init, int face=int.init, Tuple!(float, "xyz") facePosition=Tuple!(float, "xyz").init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, int slot=int.init, soupply.protocol.pocket105.types.Slot item=soupply.protocol.pocket105.types.Slot.init) pure nothrow @safe @nogc
    {
...
class PlayerAction : Pocket105Packet
{
    ...
    this(long entityId, int action=int.init, soupply.protocol.pocket105.types.BlockPosition position=soupply.protocol.pocket105.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class PlayerFall : Pocket105Packet
{
...
class HurtArmor : Pocket105Packet
{
...
class SetEntityData : Pocket105Packet
{
...
class SetEntityMotion : Pocket105Packet
{
...
class SetEntityLink : Pocket105Packet
{
...
class SetHealth : Pocket105Packet
{
...
class SetSpawnPosition : Pocket105Packet
{
    ...
    this(int unknown0, soupply.protocol.pocket105.types.BlockPosition position=soupply.protocol.pocket105.types.BlockPosition.init, bool unknown2=bool.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
        this.unknown2 = unknown2;
...
class DropItem : Pocket105Packet
{
    ...
    this(ubyte action, soupply.protocol.pocket105.types.Slot item=soupply.protocol.pocket105.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class InventoryAction : Pocket105Packet
{
    ...
    this(int action, soupply.protocol.pocket105.types.Slot item=soupply.protocol.pocket105.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class ContainerOpen : Pocket105Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, int slotCount=int.init, soupply.protocol.pocket105.types.BlockPosition position=soupply.protocol.pocket105.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
...
class ContainerClose : Pocket105Packet
{
...
class ContainerSetSlot : Pocket105Packet
{
    ...
    this(ubyte window, int slot=int.init, int hotbarSlot=int.init, soupply.protocol.pocket105.types.Slot item=soupply.protocol.pocket105.types.Slot.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.hotbarSlot = hotbarSlot;
...
class ContainerSetData : Pocket105Packet
{
...
class ContainerSetContent : Pocket105Packet
{
    ...
    ubyte window;
    soupply.protocol.pocket105.types.Slot[] slots;
    @Var int[] hotbar;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.protocol.pocket105.types.Slot[] slots=(soupply.protocol.pocket105.types.Slot[]).init, int[] hotbar=(int[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
        this.hotbar = hotbar;
...
class CraftingData : Pocket105Packet
{
    ...
    soupply.protocol.pocket105.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.pocket105.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Pocket105Packet
{
    ...
    @Var int type;
    UUID uuid;
    soupply.protocol.pocket105.types.Slot[] input;
    soupply.protocol.pocket105.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, UUID uuid=UUID.init, soupply.protocol.pocket105.types.Slot[] input=(soupply.protocol.pocket105.types.Slot[]).init, soupply.protocol.pocket105.types.Slot[] output=(soupply.protocol.pocket105.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class AdventureSettings : Pocket105Packet
{
...
class BlockEntityData : Pocket105Packet
{
    ...
    this(soupply.protocol.pocket105.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerInput : Pocket105Packet
{
...
class FullChunkData : Pocket105Packet
{
    ...
    soupply.protocol.pocket105.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") position, soupply.protocol.pocket105.types.ChunkData data=soupply.protocol.pocket105.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class SetCommandsEnabled : Pocket105Packet
{
...
class SetDifficulty : Pocket105Packet
{
...
class ChangeDimension : Pocket105Packet
{
...
class SetPlayerGameType : Pocket105Packet
{
...
class PlayerList : Pocket105Packet
{
    ...
    class Add : Pocket105Packet
    {
        ...
        soupply.protocol.pocket105.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.pocket105.types.PlayerList[] players) pure nothrow @safe @nogc
        {
...
class TelemetryEvent : Pocket105Packet
{
...
class SpawnExperienceOrb : Pocket105Packet
{
...
class ClientboundMapItemData : Pocket105Packet
{
    ...
    @Condition("update==4") soupply.protocol.pocket105.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.protocol.pocket105.types.Decoration[] decorations=(soupply.protocol.pocket105.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class MapInfoRequest : Pocket105Packet
{
...
class RequestChunkRadius : Pocket105Packet
{
...
class ChunkRadiusUpdated : Pocket105Packet
{
...
class ItemFrameDropItem : Pocket105Packet
{
    ...
    this(soupply.protocol.pocket105.types.BlockPosition position, soupply.protocol.pocket105.types.Slot item=soupply.protocol.pocket105.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class ReplaceItemInSlot : Pocket105Packet
{
    ...
    this(soupply.protocol.pocket105.types.Slot item) pure nothrow @safe @nogc
    {
        this.item = item;
    }
...
class GameRulesChanged : Pocket105Packet
{
    ...
    @Length!uint soupply.protocol.pocket105.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.pocket105.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class BossEvent : Pocket105Packet
{
...
class ShowCredits : Pocket105Packet
{
...
class AvailableCommands : Pocket105Packet
{
...
class CommandStep : Pocket105Packet
{
...
class CommandBlockUpdate : Pocket105Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.protocol.pocket105.types.BlockPosition position;
    ...
    this(bool updateBlock, soupply.protocol.pocket105.types.BlockPosition position=soupply.protocol.pocket105.types.BlockPosition.init, uint mode=uint.init, bool redstoneMode=bool.init, bool conditional=bool.init, long minecart=long.init, string command=string.init, string lastOutput=string.init, string hover=string.init, bool trackOutput=bool.init) pure nothrow @safe @nogc
    {
...
class UpdateTrade : Pocket105Packet
{
    ...
    enum string[] __fields = ["unknown0", "unknown1", "unknown2", "unknown3", "unknown4", "trader", "player", "unknown7", "offers"];
    ...
    this(ubyte unknown0, ubyte unknown1=ubyte.init, int unknown2=int.init, int unknown3=int.init, bool unknown4=bool.init, long trader=long.init, long player=long.init, string unknown7=string.init, ubyte[] offers=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.unknown1 = unknown1;
        this.unknown2 = unknown2;
...
class ResourcePackDataInfo : Pocket105Packet
{
...
class ResourcePackChunkData : Pocket105Packet
{
...
class ResourcePackChunkRequest : Pocket105Packet
{
...
class Transfer : Pocket105Packet
{
...
class PlaySound : Pocket105Packet
{
    ...
    enum string[] __fields = ["unknown0", "position", "unknown2", "unknown3"];
    ...
    this(string unknown0, soupply.protocol.pocket105.types.BlockPosition position=soupply.protocol.pocket105.types.BlockPosition.init, float unknown2=float.init, float unknown3=float.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
        this.unknown2 = unknown2;
...
class StopSound : Pocket105Packet
{
    ...
    this(string unknown0, bool unknown1=bool.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.unknown1 = unknown1;
    }
...
class SetTitle : Pocket105Packet
{
