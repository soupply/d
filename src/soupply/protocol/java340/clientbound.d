 ...
 */
module soupply.protocol.java340.clientbound;
...
import soupply.protocol.java340.packet : Java340Packet;

static import soupply.protocol.java340.types;
...
class SpawnObject : Java340Packet
{
...
class SpawnExperienceOrb : Java340Packet
{
...
class SpawnGlobalEntity : Java340Packet
{
...
class SpawnPainting : Java340Packet
{
...
class SpawnPlayer : Java340Packet
{
...
class Statistics : Java340Packet
{
	...
	soupply.protocol.java340.types.Statistic[] statistics;

	this() pure nothrow @safe @nogc {}

	this(soupply.protocol.java340.types.Statistic[] statistics) pure nothrow @safe @nogc
	{
...
class BlockBreakAnimation : Java340Packet
{
...
class UpdateBlockEntity : Java340Packet
{
...
class BlockAction : Java340Packet
{
...
class BlockChange : Java340Packet
{
...
class BossBar : Java340Packet
{
	...
	class UpdateHealth : Java340Packet
	{
	...
	class UpdateTitle : Java340Packet
	{
	...
	class UpdateStyle : Java340Packet
	{
	...
	class UpdateFlags : Java340Packet
	{
...
class ServerDifficulty : Java340Packet
{
...
class TabComplete : Java340Packet
{
...
class ChatMessage : Java340Packet
{
...
class MultiBlockChange : Java340Packet
{
	...
	Tuple!(int, "xz") chunk;
	soupply.protocol.java340.types.BlockChange[] changes;

	this() pure nothrow @safe @nogc {}

	this(Tuple!(int, "xz") chunk, soupply.protocol.java340.types.BlockChange[] changes=(soupply.protocol.java340.types.BlockChange[]).init) pure nothrow @safe @nogc
	{
		this.chunk = chunk;
...
class ConfirmTransaction : Java340Packet
{
...
class CloseWindow : Java340Packet
{
...
class OpenWindow : Java340Packet
{
...
class WindowItems : Java340Packet
{
	...
	ubyte window;
	@Length!ushort soupply.protocol.java340.types.Slot[] slots;

	this() pure nothrow @safe @nogc {}

	this(ubyte window, soupply.protocol.java340.types.Slot[] slots=(soupply.protocol.java340.types.Slot[]).init) pure nothrow @safe @nogc
	{
		this.window = window;
		this.slots = slots;
	}
...
class WindowProperty : Java340Packet
{
...
class SetSlot : Java340Packet
{
	...
	this(ubyte window, ushort slot=ushort.init, soupply.protocol.java340.types.Slot item=soupply.protocol.java340.types.Slot.init) pure nothrow @safe @nogc
	{
		this.window = window;
		this.slot = slot;
		this.item = item;
...
class SetCooldown : Java340Packet
{
...
class PluginMessage : Java340Packet
{
...
class NamedSoundEffect : Java340Packet
{
...
class EntityStatus : Java340Packet
{
...
class UnloadChunk : Java340Packet
{
...
class ChangeGameState : Java340Packet
{
...
class Map : Java340Packet
{
	...
	ubyte scale;
	bool showIcons;
	soupply.protocol.java340.types.Icon[] icons;
	ubyte colums;
	ubyte rows;
	...
	this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.protocol.java340.types.Icon[] icons=(soupply.protocol.java340.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "xz") offset=Tuple!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
	{
		this.mapId = mapId;
		this.scale = scale;
...
class EntityRelativeMove : Java340Packet
{
...
class EntityLookAndRelativeMove : Java340Packet
{
...
class EntityLook : Java340Packet
{
...
class VehicleMove : Java340Packet
{
...
class OpenSignEditor : Java340Packet
{
...
class CraftRecipeResponse : Java340Packet
{
...
class PlayerAbilities : Java340Packet
{
...
class CombatEvent : Java340Packet
{
	...
	class EnterCombat : Java340Packet
	{
	...
	class EntityDead : Java340Packet
	{
...
class PlayerListItem : Java340Packet
{
	...
	class AddPlayer : Java340Packet
	{
		...
		soupply.protocol.java340.types.ListAddPlayer[] players;

		this() pure nothrow @safe @nogc {}

		this(soupply.protocol.java340.types.ListAddPlayer[] players) pure nothrow @safe @nogc
		{
	...
	class UpdateGamemode : Java340Packet
	{
		...
		soupply.protocol.java340.types.ListUpdateGamemode[] players;

		this() pure nothrow @safe @nogc {}

		this(soupply.protocol.java340.types.ListUpdateGamemode[] players) pure nothrow @safe @nogc
		{
			this.players = players;
		}
	...
	class UpdateLatency : Java340Packet
	{
		...
		soupply.protocol.java340.types.ListUpdateLatency[] players;

		this() pure nothrow @safe @nogc {}

		this(soupply.protocol.java340.types.ListUpdateLatency[] players) pure nothrow @safe @nogc
		{
			this.players = players;
		}
	...
	class UpdateDisplayName : Java340Packet
	{
		...
		soupply.protocol.java340.types.ListUpdateDisplayName[] players;

		this() pure nothrow @safe @nogc {}

		this(soupply.protocol.java340.types.ListUpdateDisplayName[] players) pure nothrow @safe @nogc
		{
			this.players = players;
		}
	...
	class RemovePlayer : Java340Packet
	{
...
class PlayerPositionAndLook : Java340Packet
{
...
class DestroyEntities : Java340Packet
{
...
class RemoveEntityEffect : Java340Packet
{
...
class ResourcePackSend : Java340Packet
{
...
class EntityHeadLook : Java340Packet
{
...
class AdvancementProgress : Java340Packet
{
...
class WorldBorder : Java340Packet
{
	...
	class Initialize : Java340Packet
	{
	...
	class SetWarningTime : Java340Packet
	{
	...
	class SetWarningBlocks : Java340Packet
	{
...
class HeldItemChange : Java340Packet
{
...
class DisplayScoreboard : Java340Packet
{
...
class EntityMetadata : Java340Packet
{
...
class AttachEntity : Java340Packet
{
...
class EntityVelocity : Java340Packet
{
...
class EntityEquipment : Java340Packet
{
	...
	this(uint entityId, uint slot=uint.init, soupply.protocol.java340.types.Slot item=soupply.protocol.java340.types.Slot.init) pure nothrow @safe @nogc
	{
		this.entityId = entityId;
		this.slot = slot;
		this.item = item;
...
class SetExperience : Java340Packet
{
...
class ScoreboardObjective : Java340Packet
{
...
class SetPassengers : Java340Packet
{
...
class Teams : Java340Packet
{
	...
	class CreateTeam : Java340Packet
	{
	...
	class RemoveTeam : Java340Packet
	{
	...
	class UpdateTeamInfo : Java340Packet
	{
	...
	class AddPlayers : Java340Packet
	{
	...
	class RemovePlayers : Java340Packet
	{
...
class UpdateScore : Java340Packet
{
...
class SpawnPosition : Java340Packet
{
...
class TimeUpdate : Java340Packet
{
...
class Title : Java340Packet
{
	...
	class SetSubtitle : Java340Packet
	{
	...
	class SetActionBar : Java340Packet
	{
	...
	class SetTimings : Java340Packet
	{
...
class SoundEffect : Java340Packet
{
...
class PlayerListHeaderAndFooter : Java340Packet
{
...
class CollectItem : Java340Packet
{
...
class EntityTeleport : Java340Packet
{
...
class Advencements : Java340Packet
{
...
class EntityProperties : Java340Packet
{
	...
	@Var uint entityId;
	@Length!uint soupply.protocol.java340.types.Attribute[] attributes;

	this() pure nothrow @safe @nogc {}

	this(uint entityId, soupply.protocol.java340.types.Attribute[] attributes=(soupply.protocol.java340.types.Attribute[]).init) pure nothrow @safe @nogc
	{
		this.entityId = entityId;
...
class EntityEffect : Java340Packet
{
