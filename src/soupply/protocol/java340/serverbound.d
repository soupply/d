 ...
 */
module soupply.protocol.java340.serverbound;
...
class TeleportConfirm : Java340Packet
{
...
class ClientStatus : Java340Packet
{
...
class ClientSettings : Java340Packet
{
...
class EnchantItem : Java340Packet
{
...
class ClickWindow : Java340Packet
{
	...
	ushort action;
	@Var uint mode;
	soupply.protocol.java340.types.Slot clickedItem;

	this() pure nothrow @safe @nogc {}

	this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, soupply.protocol.java340.types.Slot clickedItem=soupply.protocol.java340.types.Slot.init) pure nothrow @safe @nogc
	{
		this.window = window;
		this.slot = slot;
		this.button = button;
...
class PlayerPosition : Java340Packet
{
...
class PlayerLook : Java340Packet
{
...
class CraftRecipeRequest : Java340Packet
{
...
class PlayerDigging : Java340Packet
{
...
class EntityAction : Java340Packet
{
...
class SteerVehicle : Java340Packet
{
...
class CraftingBookData : Java340Packet
{
	...
	class DisplayedRecipe : Java340Packet
	{
	...
	class CraftingBookStatus : Java340Packet
	{
...
class ResourcePackStatus : Java340Packet
{
...
class AdvencementTab : Java340Packet
{
...
class CreativeInventoryAction : Java340Packet
{
	...
	this(ushort slot, soupply.protocol.java340.types.Slot clickedItem=soupply.protocol.java340.types.Slot.init) pure nothrow @safe @nogc
	{
		this.slot = slot;
		this.clickedItem = clickedItem;
	}
...
class UpdateSign : Java340Packet
{
...
class PlayerBlockPlacement : Java340Packet
{
