 ...
 * Generated from protocol/bedrock201
 */
module soupply.protocol.bedrock201.play;
...
import soupply.metadata.bedrock201;
import soupply.protocol.bedrock201.packet : Bedrock201Packet;

static import soupply.protocol.bedrock201.types;
...
class Login : Bedrock201Packet
{
    ...
    @BigEndian uint protocol = 201;
    soupply.protocol.bedrock201.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.protocol.bedrock201.types.LoginBody body_=soupply.protocol.bedrock201.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class PlayStatus : Bedrock201Packet
{
...
class ServerToClientHandshake : Bedrock201Packet
{
...
class ClientToServerHandshake : Bedrock201Packet
{
...
class Disconnect : Bedrock201Packet
{
...
class ResourcePacksInfo : Bedrock201Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.bigEndian) soupply.protocol.bedrock201.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.bigEndian) soupply.protocol.bedrock201.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.bedrock201.types.PackWithSize[] behaviourPacks=(soupply.protocol.bedrock201.types.PackWithSize[]).init, soupply.protocol.bedrock201.types.PackWithSize[] resourcePacks=(soupply.protocol.bedrock201.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock201Packet
{
    ...
    bool mustAccept;
    soupply.protocol.bedrock201.types.Pack[] behaviourPacks;
    soupply.protocol.bedrock201.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.bedrock201.types.Pack[] behaviourPacks=(soupply.protocol.bedrock201.types.Pack[]).init, soupply.protocol.bedrock201.types.Pack[] resourcePacks=(soupply.protocol.bedrock201.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class ResourcePackClientResponse : Bedrock201Packet
{
...
class Text : Bedrock201Packet
{
    ...
    class Translation : Bedrock201Packet
    {
    ...
    class JukeboxPopup : Bedrock201Packet
    {
    ...
    class Whisper : Bedrock201Packet
    {
    ...
    class Announcement : Bedrock201Packet
    {
...
class SetTime : Bedrock201Packet
{
...
class StartGame : Bedrock201Packet
{
    ...
    soupply.protocol.bedrock201.types.Rule[] gameRules;
...
class AddPlayer : Bedrock201Packet
{
    ...
    soupply.protocol.bedrock201.types.McpeUuid uuid;
    string username;
    @Var long entityId;
    @Var ulong runtimeId;
    Tuple!(float, "xyz") position;
    ...
    float headYaw;
    float yaw;
    soupply.protocol.bedrock201.types.Slot heldItem;
    Metadata metadata;
    @Var uint unknown11;
    @Var uint unknown12;
    @Var uint unknown13;
    ...
    @Var uint unknown15;
    long unknown16;
    soupply.protocol.bedrock201.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock201.types.McpeUuid uuid, string username=string.init, long entityId=long.init, ulong runtimeId=ulong.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float headYaw=float.init, float yaw=float.init, soupply.protocol.bedrock201.types.Slot heldItem=soupply.protocol.bedrock201.types.Slot.init, Metadata metadata=Metadata.init, uint unknown11=uint.init, uint unknown12=uint.init, uint unknown13=uint.init, uint unknown14=uint.init, uint unknown15=uint.init, long unknown16=long.init, soupply.protocol.bedrock201.types.Link[] links=(soupply.protocol.bedrock201.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
...
class AddEntity : Bedrock201Packet
{
    ...
    float pitch;
    float yaw;
    soupply.protocol.bedrock201.types.Attribute[] attributes;
    Metadata metadata;
    soupply.protocol.bedrock201.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, uint type=uint.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.protocol.bedrock201.types.Attribute[] attributes=(soupply.protocol.bedrock201.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.protocol.bedrock201.types.Link[] links=(soupply.protocol.bedrock201.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class RemoveEntity : Bedrock201Packet
{
...
class AddItemEntity : Bedrock201Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.protocol.bedrock201.types.Slot item;
    Tuple!(float, "xyz") position;
    Tuple!(float, "xyz") motion;
    Metadata metadata;
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock201.types.Slot item=soupply.protocol.bedrock201.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Bedrock201Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.protocol.bedrock201.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock201.types.BlockPosition position=soupply.protocol.bedrock201.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class TakeItemEntity : Bedrock201Packet
{
...
class MoveEntity : Bedrock201Packet
{
...
class MovePlayer : Bedrock201Packet
{
...
class RiderJump : Bedrock201Packet
{
...
class UpdateBlock : Bedrock201Packet
{
    ...
    this(soupply.protocol.bedrock201.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Bedrock201Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock201.types.BlockPosition position=soupply.protocol.bedrock201.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Bedrock201Packet
{
    ...
    Tuple!(float, "xyz") position;
    float radius;
    soupply.protocol.bedrock201.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.protocol.bedrock201.types.BlockPosition[] destroyedBlocks=(soupply.protocol.bedrock201.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class LevelSoundEvent : Bedrock201Packet
{
...
class LevelEvent : Bedrock201Packet
{
...
class BlockEvent : Bedrock201Packet
{
    ...
    this(soupply.protocol.bedrock201.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class EntityEvent : Bedrock201Packet
{
...
class MobEffect : Bedrock201Packet
{
...
class UpdateAttributes : Bedrock201Packet
{
    ...
    this(long entityId, soupply.protocol.bedrock201.types.Attribute[] attributes=(soupply.protocol.bedrock201.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock201Packet
{
    ...
    @Var uint type;
    soupply.protocol.bedrock201.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.protocol.bedrock201.types.InventoryAction[] actions=(soupply.protocol.bedrock201.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class Normal0 : Bedrock201Packet
    {
    ...
    class Normal1 : Bedrock201Packet
    {
    ...
    class UseItem : Bedrock201Packet
    {
        ...
        @Var uint actionType;
        soupply.protocol.bedrock201.types.BlockPosition blockPosition;
        @Var int face;
        @Var int hotbarSlot;
        soupply.protocol.bedrock201.types.Slot item;
        ...
        this(uint actionType, soupply.protocol.bedrock201.types.BlockPosition blockPosition=soupply.protocol.bedrock201.types.BlockPosition.init, int face=int.init, int hotbarSlot=int.init, soupply.protocol.bedrock201.types.Slot item=soupply.protocol.bedrock201.types.Slot.init, Tuple!(float, "xyz") playerPosition=Tuple!(float, "xyz").init, Tuple!(float, "xyz") clickPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
    ...
    class UseItemOnEntity : Bedrock201Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.protocol.bedrock201.types.Slot item=soupply.protocol.bedrock201.types.Slot.init, Tuple!(float, "xyz") unknown4=Tuple!(float, "xyz").init, Tuple!(float, "xyz") unknown5=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock201Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.protocol.bedrock201.types.Slot item=soupply.protocol.bedrock201.types.Slot.init, Tuple!(float, "xyz") headPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class MobEquipment : Bedrock201Packet
{
    ...
    this(long entityId, soupply.protocol.bedrock201.types.Slot item=soupply.protocol.bedrock201.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock201Packet
{
    ...
    @Var long entityId;
    soupply.protocol.bedrock201.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.protocol.bedrock201.types.Slot[4] armor=(soupply.protocol.bedrock201.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class Interact : Bedrock201Packet
{
...
class BlockPickRequest : Bedrock201Packet
{
...
class EntityPickRequest : Bedrock201Packet
{
...
class PlayerAction : Bedrock201Packet
{
    ...
    this(long entityId, int action=int.init, soupply.protocol.bedrock201.types.BlockPosition position=soupply.protocol.bedrock201.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class EntityFall : Bedrock201Packet
{
...
class HurtArmor : Bedrock201Packet
{
...
class SetEntityData : Bedrock201Packet
{
...
class SetEntityMotion : Bedrock201Packet
{
...
class SetEntityLink : Bedrock201Packet
{
...
class SetHealth : Bedrock201Packet
{
...
class SetSpawnPosition : Bedrock201Packet
{
    ...
    this(int type, soupply.protocol.bedrock201.types.BlockPosition position=soupply.protocol.bedrock201.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class Animate : Bedrock201Packet
{
...
class Respawn : Bedrock201Packet
{
...
class ContainerOpen : Bedrock201Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.protocol.bedrock201.types.BlockPosition position=soupply.protocol.bedrock201.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class ContainerClose : Bedrock201Packet
{
...
class PlayerHotbar : Bedrock201Packet
{
...
class InventoryContent : Bedrock201Packet
{
    ...
    @Var uint window;
    soupply.protocol.bedrock201.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.protocol.bedrock201.types.Slot[] slots=(soupply.protocol.bedrock201.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class InventorySlot : Bedrock201Packet
{
...
class ContainerSetData : Bedrock201Packet
{
...
class CraftingData : Bedrock201Packet
{
    ...
    soupply.protocol.bedrock201.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock201.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock201Packet
{
    ...
    @Var int type;
    soupply.protocol.bedrock201.types.McpeUuid uuid;
    soupply.protocol.bedrock201.types.Slot[] input;
    soupply.protocol.bedrock201.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.protocol.bedrock201.types.McpeUuid uuid=soupply.protocol.bedrock201.types.McpeUuid.init, soupply.protocol.bedrock201.types.Slot[] input=(soupply.protocol.bedrock201.types.Slot[]).init, soupply.protocol.bedrock201.types.Slot[] output=(soupply.protocol.bedrock201.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class GuiDataPickItem : Bedrock201Packet
{
...
class AdventureSettings : Bedrock201Packet
{
...
class BlockEntityData : Bedrock201Packet
{
    ...
    this(soupply.protocol.bedrock201.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerInput : Bedrock201Packet
{
...
class FullChunkData : Bedrock201Packet
{
    ...
    soupply.protocol.bedrock201.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") position, soupply.protocol.bedrock201.types.ChunkData data=soupply.protocol.bedrock201.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class SetCommandsEnabled : Bedrock201Packet
{
...
class SetDifficulty : Bedrock201Packet
{
...
class ChangeDimension : Bedrock201Packet
{
...
class SetPlayerGameType : Bedrock201Packet
{
...
class PlayerList : Bedrock201Packet
{
    ...
    class Add : Bedrock201Packet
    {
        ...
        soupply.protocol.bedrock201.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.bedrock201.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock201Packet
    {
        ...
        soupply.protocol.bedrock201.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.bedrock201.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class SimpleEvent : Bedrock201Packet
{
...
class TelemetryEvent : Bedrock201Packet
{
...
class SpawnExperienceOrb : Bedrock201Packet
{
...
class ClientboundMapItemData : Bedrock201Packet
{
    ...
    @Condition("update==4") soupply.protocol.bedrock201.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.protocol.bedrock201.types.Decoration[] decorations=(soupply.protocol.bedrock201.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class MapInfoRequest : Bedrock201Packet
{
...
class RequestChunkRadius : Bedrock201Packet
{
...
class ChunkRadiusUpdated : Bedrock201Packet
{
...
class ItemFrameDropItem : Bedrock201Packet
{
    ...
    this(soupply.protocol.bedrock201.types.BlockPosition position, soupply.protocol.bedrock201.types.Slot item=soupply.protocol.bedrock201.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock201Packet
{
    ...
    soupply.protocol.bedrock201.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock201.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class BossEvent : Bedrock201Packet
{
...
class ShowCredits : Bedrock201Packet
{
...
class AvailableCommands : Bedrock201Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.protocol.bedrock201.types.Enum[] enums;
    soupply.protocol.bedrock201.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.protocol.bedrock201.types.Enum[] enums=(soupply.protocol.bedrock201.types.Enum[]).init, soupply.protocol.bedrock201.types.Command[] commands=(soupply.protocol.bedrock201.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandRequest : Bedrock201Packet
{
    ...
    this(string command, uint type=uint.init, soupply.protocol.bedrock201.types.McpeUuid uuid=soupply.protocol.bedrock201.types.McpeUuid.init, string requestId=string.init, int playerId=int.init, bool internal=bool.init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock201Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.protocol.bedrock201.types.BlockPosition position;
    ...
    this(bool updateBlock, soupply.protocol.bedrock201.types.BlockPosition position=soupply.protocol.bedrock201.types.BlockPosition.init, uint mode=uint.init, bool redstoneMode=bool.init, bool conditional=bool.init, long minecart=long.init, string command=string.init, string lastOutput=string.init, string hover=string.init, bool trackOutput=bool.init) pure nothrow @safe @nogc
    {
...
class UpdateTrade : Bedrock201Packet
{
...
class UpdateEquip : Bedrock201Packet
{
...
class ResourcePackDataInfo : Bedrock201Packet
{
...
class ResourcePackChunkData : Bedrock201Packet
{
...
class ResourcePackChunkRequest : Bedrock201Packet
{
...
class Transfer : Bedrock201Packet
{
...
class PlaySound : Bedrock201Packet
{
    ...
    this(string name, soupply.protocol.bedrock201.types.BlockPosition position=soupply.protocol.bedrock201.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class StopSound : Bedrock201Packet
{
...
class SetTitle : Bedrock201Packet
{
...
class AddBehaviorTree : Bedrock201Packet
{
...
class StructureBlockUpdate : Bedrock201Packet
{
...
class ShowStoreOffer : Bedrock201Packet
{
...
class PurchaseReceipt : Bedrock201Packet
{
...
class PlayerSkin : Bedrock201Packet
{
    ...
    this(soupply.protocol.bedrock201.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
...
class SubClientLogin : Bedrock201Packet
{
...
class InitiateWebSocketConnection : Bedrock201Packet
{
...
class SetLastHurtBy : Bedrock201Packet
{
...
class BookEdit : Bedrock201Packet
{
    ...
    class ReplacePage : Bedrock201Packet
    {
    ...
    class AddPage : Bedrock201Packet
    {
    ...
    class DeletePage : Bedrock201Packet
    {
    ...
    class SwapPages : Bedrock201Packet
    {
...
class NpcRequest : Bedrock201Packet
{
...
class PhotoTransfer : Bedrock201Packet
{
...
class ModalFormRequest : Bedrock201Packet
{
...
class ModalFormResponse : Bedrock201Packet
{
...
class ServerSettingsRequest : Bedrock201Packet
{
...
class ServerSettingsResponse : Bedrock201Packet
{
...
class ShowProfile : Bedrock201Packet
{
...
class SetDefaultGameType : Bedrock201Packet
{
