 ...
 */
module soupply.protocol.bedrock201.types;
...
struct PlayerList
{
	...
	@Var long entityId;
	string displayName;
	soupply.protocol.bedrock201.types.Skin skin;
	string unknown4;
...
struct InventoryAction
{
	...
	@Var uint slot;
	soupply.protocol.bedrock201.types.Slot oldItem;
	soupply.protocol.bedrock201.types.Slot newItem;
...
struct ChunkData
{
	...
	soupply.protocol.bedrock201.types.Section[] sections;
	ushort[256] heights;
	ubyte[256] biomes;
	ubyte[] borders;
	soupply.protocol.bedrock201.types.ExtraData[] extraData;
...
struct Command
{
	...
	int aliasesEnum = -1;
	soupply.protocol.bedrock201.types.Overload[] overloads;
...
struct Overload
{
	...
	soupply.protocol.bedrock201.types.Parameter[] parameters;
