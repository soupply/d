 ...
 */
module soupply.protocol.java210.serverbound;
...
class ClickWindow : Java210Packet
{
    ...
    ushort action;
    @Var uint mode;
    soupply.protocol.java210.types.Slot clickedItem;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, soupply.protocol.java210.types.Slot clickedItem=soupply.protocol.java210.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.button = button;
...
class CreativeInventoryAction : Java210Packet
{
    ...
    this(ushort slot, soupply.protocol.java210.types.Slot clickedItem=soupply.protocol.java210.types.Slot.init) pure nothrow @safe @nogc
    {
        this.slot = slot;
        this.clickedItem = clickedItem;
    }
...
class PlayerBlockPlacement : Java210Packet
{
    ...
    @Var uint face;
    @Var uint hand;
    Tuple!(ubyte, "xyz") cursorPosition;

    this() pure nothrow @safe @nogc {}

    this(ulong position, uint face=uint.init, uint hand=uint.init, Tuple!(ubyte, "xyz") cursorPosition=Tuple!(ubyte, "xyz").init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.face = face;
        this.hand = hand;
