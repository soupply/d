 ...
 * Generated from protocol/java210
 */
module soupply.protocol.java210.clientbound;
...
class SpawnObject : Java210Packet
{
...
class SpawnExperienceOrb : Java210Packet
{
...
class SpawnGlobalEntity : Java210Packet
{
...
class SpawnPainting : Java210Packet
{
...
class SpawnPlayer : Java210Packet
{
...
class Statistics : Java210Packet
{
    ...
    soupply.protocol.java210.types.Statistic[] statistics;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.java210.types.Statistic[] statistics) pure nothrow @safe @nogc
    {
...
class BlockBreakAnimation : Java210Packet
{
...
class UpdateBlockEntity : Java210Packet
{
...
class BlockAction : Java210Packet
{
...
class BlockChange : Java210Packet
{
...
class BossBar : Java210Packet
{
    ...
    class UpdateHealth : Java210Packet
    {
    ...
    class UpdateTitle : Java210Packet
    {
    ...
    class UpdateStyle : Java210Packet
    {
    ...
    class UpdateFlags : Java210Packet
    {
...
class ServerDifficulty : Java210Packet
{
...
class MultiBlockChange : Java210Packet
{
    ...
    Tuple!(int, "xz") chunk;
    soupply.protocol.java210.types.BlockChange[] changes;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") chunk, soupply.protocol.java210.types.BlockChange[] changes=(soupply.protocol.java210.types.BlockChange[]).init) pure nothrow @safe @nogc
    {
        this.chunk = chunk;
...
class OpenWindow : Java210Packet
{
...
class WindowItems : Java210Packet
{
    ...
    ubyte window;
    @Length!ushort soupply.protocol.java210.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.protocol.java210.types.Slot[] slots=(soupply.protocol.java210.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class WindowProperty : Java210Packet
{
...
class SetSlot : Java210Packet
{
    ...
    ubyte window;
    ushort slot;
    soupply.protocol.java210.types.Slot item;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, soupply.protocol.java210.types.Slot item=soupply.protocol.java210.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.item = item;
...
class SetCooldown : Java210Packet
{
...
class NamedSoundEffect : Java210Packet
{
...
class Disconnect : Java210Packet
{
...
class EntityStatus : Java210Packet
{
...
class UnloadChunk : Java210Packet
{
...
class ChangeGameState : Java210Packet
{
...
class Map : Java210Packet
{
    ...
    ubyte scale;
    bool showIcons;
    soupply.protocol.java210.types.Icon[] icons;
    ubyte colums;
    ubyte rows;
    ...
    this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.protocol.java210.types.Icon[] icons=(soupply.protocol.java210.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "xz") offset=Tuple!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.scale = scale;
...
class EntityRelativeMove : Java210Packet
{
...
class EntityLookAndRelativeMove : Java210Packet
{
...
class EntityLook : Java210Packet
{
...
class OpenSignEditor : Java210Packet
{
...
class CombatEvent : Java210Packet
{
    ...
    class EnterCombat : Java210Packet
    {
    ...
    class EntityDead : Java210Packet
    {
...
class PlayerListItem : Java210Packet
{
    ...
    class AddPlayer : Java210Packet
    {
        ...
        soupply.protocol.java210.types.ListAddPlayer[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java210.types.ListAddPlayer[] players) pure nothrow @safe @nogc
        {
    ...
    class UpdateGamemode : Java210Packet
    {
        ...
        soupply.protocol.java210.types.ListUpdateGamemode[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java210.types.ListUpdateGamemode[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateLatency : Java210Packet
    {
        ...
        soupply.protocol.java210.types.ListUpdateLatency[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java210.types.ListUpdateLatency[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateDisplayName : Java210Packet
    {
        ...
        soupply.protocol.java210.types.ListUpdateDisplayName[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.java210.types.ListUpdateDisplayName[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class RemovePlayer : Java210Packet
    {
...
class DestroyEntities : Java210Packet
{
...
class RemoveEntityEffect : Java210Packet
{
...
class ResourcePackSend : Java210Packet
{
...
class EntityHeadLook : Java210Packet
{
...
class WorldBorder : Java210Packet
{
    ...
    class Initialize : Java210Packet
    {
    ...
    class SetWarningTime : Java210Packet
    {
    ...
    class SetWarningBlocks : Java210Packet
    {
...
class DisplayScoreboard : Java210Packet
{
...
class EntityMetadata : Java210Packet
{
...
class AttachEntity : Java210Packet
{
...
class EntityVelocity : Java210Packet
{
...
class EntityEquipment : Java210Packet
{
    ...
    this(uint entityId, uint slot=uint.init, soupply.protocol.java210.types.Slot item=soupply.protocol.java210.types.Slot.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.slot = slot;
        this.item = item;
...
class SetExperience : Java210Packet
{
...
class ScoreboardObjective : Java210Packet
{
...
class SetPassengers : Java210Packet
{
...
class Teams : Java210Packet
{
    ...
    class CreateTeam : Java210Packet
    {
    ...
    class RemoveTeam : Java210Packet
    {
    ...
    class UpdateTeamInfo : Java210Packet
    {
    ...
    class AddPlayers : Java210Packet
    {
    ...
    class RemovePlayers : Java210Packet
    {
...
class UpdateScore : Java210Packet
{
...
class SpawnPosition : Java210Packet
{
...
class TimeUpdate : Java210Packet
{
...
class Title : Java210Packet
{
    ...
    class SetSubtitle : Java210Packet
    {
    ...
    class SetTimings : Java210Packet
    {
...
class SoundEffect : Java210Packet
{
...
class PlayerListHeaderAndFooter : Java210Packet
{
...
class CollectItem : Java210Packet
{
    ...
    this(uint collected, uint collector=uint.init) pure nothrow @safe @nogc
    {
...
class EntityTeleport : Java210Packet
{
...
class EntityProperties : Java210Packet
{
    ...
    @Var uint entityId;
    @Length!uint soupply.protocol.java210.types.Attribute[] attributes;

    this() pure nothrow @safe @nogc {}

    this(uint entityId, soupply.protocol.java210.types.Attribute[] attributes=(soupply.protocol.java210.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
...
class EntityEffect : Java210Packet
{
