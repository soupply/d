 ...
 */
module soupply.protocol.bedrock160.types;
...
struct PlayerList
{
	...
	@Var long entityId;
	string displayName;
	soupply.protocol.bedrock160.types.Skin skin;
	string unknown4;
...
struct InventoryAction
{
	...
	@Var uint slot;
	soupply.protocol.bedrock160.types.Slot oldItem;
	soupply.protocol.bedrock160.types.Slot newItem;
...
struct ChunkData
{
	...
	soupply.protocol.bedrock160.types.Section[] sections;
	ushort[256] heights;
	ubyte[256] biomes;
	ubyte[] borders;
	soupply.protocol.bedrock160.types.ExtraData[] extraData;
...
struct Command
{
	...
	int aliasesEnum = -1;
	soupply.protocol.bedrock160.types.Overload[] overloads;
...
struct Overload
{
	...
	soupply.protocol.bedrock160.types.Parameter[] parameters;
