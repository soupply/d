 ...
 * Generated from protocol/bedrock160
 */
module soupply.protocol.bedrock160.play;
...
import soupply.metadata.bedrock160;
import soupply.protocol.bedrock160.packet : Bedrock160Packet;

static import soupply.protocol.bedrock160.types;
...
class Login : Bedrock160Packet
{
    ...
    @BigEndian uint protocol = 160;
    soupply.protocol.bedrock160.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.protocol.bedrock160.types.LoginBody body_=soupply.protocol.bedrock160.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class PlayStatus : Bedrock160Packet
{
...
class ServerToClientHandshake : Bedrock160Packet
{
...
class ClientToServerHandshake : Bedrock160Packet
{
...
class Disconnect : Bedrock160Packet
{
...
class ResourcePacksInfo : Bedrock160Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.bigEndian) soupply.protocol.bedrock160.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.bigEndian) soupply.protocol.bedrock160.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.bedrock160.types.PackWithSize[] behaviourPacks=(soupply.protocol.bedrock160.types.PackWithSize[]).init, soupply.protocol.bedrock160.types.PackWithSize[] resourcePacks=(soupply.protocol.bedrock160.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock160Packet
{
    ...
    bool mustAccept;
    soupply.protocol.bedrock160.types.Pack[] behaviourPacks;
    soupply.protocol.bedrock160.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.protocol.bedrock160.types.Pack[] behaviourPacks=(soupply.protocol.bedrock160.types.Pack[]).init, soupply.protocol.bedrock160.types.Pack[] resourcePacks=(soupply.protocol.bedrock160.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class ResourcePackClientResponse : Bedrock160Packet
{
...
class Text : Bedrock160Packet
{
    ...
    class Translation : Bedrock160Packet
    {
    ...
    class JukeboxPopup : Bedrock160Packet
    {
    ...
    class Whisper : Bedrock160Packet
    {
    ...
    class Announcement : Bedrock160Packet
    {
...
class SetTime : Bedrock160Packet
{
...
class StartGame : Bedrock160Packet
{
    ...
    soupply.protocol.bedrock160.types.Rule[] gameRules;
...
class AddPlayer : Bedrock160Packet
{
    ...
    soupply.protocol.bedrock160.types.McpeUuid uuid;
    string username;
    @Var long entityId;
    @Var ulong runtimeId;
    Tuple!(float, "xyz") position;
    ...
    float headYaw;
    float yaw;
    soupply.protocol.bedrock160.types.Slot heldItem;
    Metadata metadata;
    @Var uint unknown11;
    @Var uint unknown12;
    @Var uint unknown13;
    ...
    @Var uint unknown15;
    long unknown16;
    soupply.protocol.bedrock160.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock160.types.McpeUuid uuid, string username=string.init, long entityId=long.init, ulong runtimeId=ulong.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float headYaw=float.init, float yaw=float.init, soupply.protocol.bedrock160.types.Slot heldItem=soupply.protocol.bedrock160.types.Slot.init, Metadata metadata=Metadata.init, uint unknown11=uint.init, uint unknown12=uint.init, uint unknown13=uint.init, uint unknown14=uint.init, uint unknown15=uint.init, long unknown16=long.init, soupply.protocol.bedrock160.types.Link[] links=(soupply.protocol.bedrock160.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
...
class AddEntity : Bedrock160Packet
{
    ...
    float pitch;
    float yaw;
    soupply.protocol.bedrock160.types.Attribute[] attributes;
    Metadata metadata;
    soupply.protocol.bedrock160.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, uint type=uint.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.protocol.bedrock160.types.Attribute[] attributes=(soupply.protocol.bedrock160.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.protocol.bedrock160.types.Link[] links=(soupply.protocol.bedrock160.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class RemoveEntity : Bedrock160Packet
{
...
class AddItemEntity : Bedrock160Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.protocol.bedrock160.types.Slot item;
    Tuple!(float, "xyz") position;
    Tuple!(float, "xyz") motion;
    Metadata metadata;
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock160.types.Slot item=soupply.protocol.bedrock160.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Bedrock160Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.protocol.bedrock160.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock160.types.BlockPosition position=soupply.protocol.bedrock160.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class TakeItemEntity : Bedrock160Packet
{
...
class MoveEntity : Bedrock160Packet
{
...
class MovePlayer : Bedrock160Packet
{
...
class RiderJump : Bedrock160Packet
{
...
class UpdateBlock : Bedrock160Packet
{
    ...
    this(soupply.protocol.bedrock160.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Bedrock160Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.protocol.bedrock160.types.BlockPosition position=soupply.protocol.bedrock160.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Bedrock160Packet
{
    ...
    Tuple!(float, "xyz") position;
    float radius;
    soupply.protocol.bedrock160.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.protocol.bedrock160.types.BlockPosition[] destroyedBlocks=(soupply.protocol.bedrock160.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class LevelSoundEvent : Bedrock160Packet
{
...
class LevelEvent : Bedrock160Packet
{
...
class BlockEvent : Bedrock160Packet
{
    ...
    this(soupply.protocol.bedrock160.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class EntityEvent : Bedrock160Packet
{
...
class MobEffect : Bedrock160Packet
{
...
class UpdateAttributes : Bedrock160Packet
{
    ...
    this(long entityId, soupply.protocol.bedrock160.types.Attribute[] attributes=(soupply.protocol.bedrock160.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock160Packet
{
    ...
    @Var uint type;
    soupply.protocol.bedrock160.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.protocol.bedrock160.types.InventoryAction[] actions=(soupply.protocol.bedrock160.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class Normal0 : Bedrock160Packet
    {
    ...
    class Normal1 : Bedrock160Packet
    {
    ...
    class UseItem : Bedrock160Packet
    {
        ...
        @Var uint actionType;
        soupply.protocol.bedrock160.types.BlockPosition blockPosition;
        @Var int face;
        @Var int hotbarSlot;
        soupply.protocol.bedrock160.types.Slot item;
        ...
        this(uint actionType, soupply.protocol.bedrock160.types.BlockPosition blockPosition=soupply.protocol.bedrock160.types.BlockPosition.init, int face=int.init, int hotbarSlot=int.init, soupply.protocol.bedrock160.types.Slot item=soupply.protocol.bedrock160.types.Slot.init, Tuple!(float, "xyz") playerPosition=Tuple!(float, "xyz").init, Tuple!(float, "xyz") clickPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
    ...
    class UseItemOnEntity : Bedrock160Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.protocol.bedrock160.types.Slot item=soupply.protocol.bedrock160.types.Slot.init, Tuple!(float, "xyz") unknown4=Tuple!(float, "xyz").init, Tuple!(float, "xyz") unknown5=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock160Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.protocol.bedrock160.types.Slot item=soupply.protocol.bedrock160.types.Slot.init, Tuple!(float, "xyz") headPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class MobEquipment : Bedrock160Packet
{
    ...
    this(long entityId, soupply.protocol.bedrock160.types.Slot item=soupply.protocol.bedrock160.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock160Packet
{
    ...
    @Var long entityId;
    soupply.protocol.bedrock160.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.protocol.bedrock160.types.Slot[4] armor=(soupply.protocol.bedrock160.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class Interact : Bedrock160Packet
{
...
class BlockPickRequest : Bedrock160Packet
{
...
class EntityPickRequest : Bedrock160Packet
{
...
class PlayerAction : Bedrock160Packet
{
    ...
    this(long entityId, int action=int.init, soupply.protocol.bedrock160.types.BlockPosition position=soupply.protocol.bedrock160.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class EntityFall : Bedrock160Packet
{
...
class HurtArmor : Bedrock160Packet
{
...
class SetEntityData : Bedrock160Packet
{
...
class SetEntityMotion : Bedrock160Packet
{
...
class SetEntityLink : Bedrock160Packet
{
...
class SetHealth : Bedrock160Packet
{
...
class SetSpawnPosition : Bedrock160Packet
{
    ...
    this(int type, soupply.protocol.bedrock160.types.BlockPosition position=soupply.protocol.bedrock160.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class Animate : Bedrock160Packet
{
...
class Respawn : Bedrock160Packet
{
...
class ContainerOpen : Bedrock160Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.protocol.bedrock160.types.BlockPosition position=soupply.protocol.bedrock160.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class ContainerClose : Bedrock160Packet
{
...
class PlayerHotbar : Bedrock160Packet
{
...
class InventoryContent : Bedrock160Packet
{
    ...
    @Var uint window;
    soupply.protocol.bedrock160.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.protocol.bedrock160.types.Slot[] slots=(soupply.protocol.bedrock160.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class InventorySlot : Bedrock160Packet
{
...
class ContainerSetData : Bedrock160Packet
{
...
class CraftingData : Bedrock160Packet
{
    ...
    soupply.protocol.bedrock160.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock160.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock160Packet
{
    ...
    @Var int type;
    soupply.protocol.bedrock160.types.McpeUuid uuid;
    soupply.protocol.bedrock160.types.Slot[] input;
    soupply.protocol.bedrock160.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.protocol.bedrock160.types.McpeUuid uuid=soupply.protocol.bedrock160.types.McpeUuid.init, soupply.protocol.bedrock160.types.Slot[] input=(soupply.protocol.bedrock160.types.Slot[]).init, soupply.protocol.bedrock160.types.Slot[] output=(soupply.protocol.bedrock160.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class GuiDataPickItem : Bedrock160Packet
{
...
class AdventureSettings : Bedrock160Packet
{
...
class BlockEntityData : Bedrock160Packet
{
    ...
    this(soupply.protocol.bedrock160.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerInput : Bedrock160Packet
{
...
class FullChunkData : Bedrock160Packet
{
    ...
    soupply.protocol.bedrock160.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") position, soupply.protocol.bedrock160.types.ChunkData data=soupply.protocol.bedrock160.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class SetCommandsEnabled : Bedrock160Packet
{
...
class SetDifficulty : Bedrock160Packet
{
...
class ChangeDimension : Bedrock160Packet
{
...
class SetPlayerGameType : Bedrock160Packet
{
...
class PlayerList : Bedrock160Packet
{
    ...
    class Add : Bedrock160Packet
    {
        ...
        soupply.protocol.bedrock160.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.bedrock160.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock160Packet
    {
        ...
        soupply.protocol.bedrock160.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.protocol.bedrock160.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class SimpleEvent : Bedrock160Packet
{
...
class TelemetryEvent : Bedrock160Packet
{
...
class SpawnExperienceOrb : Bedrock160Packet
{
...
class ClientboundMapItemData : Bedrock160Packet
{
    ...
    @Condition("update==4") soupply.protocol.bedrock160.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.protocol.bedrock160.types.Decoration[] decorations=(soupply.protocol.bedrock160.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class MapInfoRequest : Bedrock160Packet
{
...
class RequestChunkRadius : Bedrock160Packet
{
...
class ChunkRadiusUpdated : Bedrock160Packet
{
...
class ItemFrameDropItem : Bedrock160Packet
{
    ...
    this(soupply.protocol.bedrock160.types.BlockPosition position, soupply.protocol.bedrock160.types.Slot item=soupply.protocol.bedrock160.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock160Packet
{
    ...
    soupply.protocol.bedrock160.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.protocol.bedrock160.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class BossEvent : Bedrock160Packet
{
...
class ShowCredits : Bedrock160Packet
{
...
class AvailableCommands : Bedrock160Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.protocol.bedrock160.types.Enum[] enums;
    soupply.protocol.bedrock160.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.protocol.bedrock160.types.Enum[] enums=(soupply.protocol.bedrock160.types.Enum[]).init, soupply.protocol.bedrock160.types.Command[] commands=(soupply.protocol.bedrock160.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandRequest : Bedrock160Packet
{
    ...
    this(string command, uint type=uint.init, soupply.protocol.bedrock160.types.McpeUuid uuid=soupply.protocol.bedrock160.types.McpeUuid.init, string requestId=string.init, int playerId=int.init, bool internal=bool.init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock160Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.protocol.bedrock160.types.BlockPosition position;
    ...
    this(bool updateBlock, soupply.protocol.bedrock160.types.BlockPosition position=soupply.protocol.bedrock160.types.BlockPosition.init, uint mode=uint.init, bool redstoneMode=bool.init, bool conditional=bool.init, long minecart=long.init, string command=string.init, string lastOutput=string.init, string hover=string.init, bool trackOutput=bool.init) pure nothrow @safe @nogc
    {
...
class UpdateTrade : Bedrock160Packet
{
...
class UpdateEquip : Bedrock160Packet
{
...
class ResourcePackDataInfo : Bedrock160Packet
{
...
class ResourcePackChunkData : Bedrock160Packet
{
...
class ResourcePackChunkRequest : Bedrock160Packet
{
...
class Transfer : Bedrock160Packet
{
...
class PlaySound : Bedrock160Packet
{
    ...
    this(string name, soupply.protocol.bedrock160.types.BlockPosition position=soupply.protocol.bedrock160.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class StopSound : Bedrock160Packet
{
...
class SetTitle : Bedrock160Packet
{
...
class AddBehaviorTree : Bedrock160Packet
{
...
class StructureBlockUpdate : Bedrock160Packet
{
...
class ShowStoreOffer : Bedrock160Packet
{
...
class PurchaseReceipt : Bedrock160Packet
{
...
class PlayerSkin : Bedrock160Packet
{
    ...
    this(soupply.protocol.bedrock160.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
...
class SubClientLogin : Bedrock160Packet
{
...
class InitiateWebSocketConnection : Bedrock160Packet
{
...
class SetLastHurtBy : Bedrock160Packet
{
...
class BookEdit : Bedrock160Packet
{
    ...
    class ReplacePage : Bedrock160Packet
    {
    ...
    class AddPage : Bedrock160Packet
    {
    ...
    class DeletePage : Bedrock160Packet
    {
    ...
    class SwapPages : Bedrock160Packet
    {
...
class NpcRequest : Bedrock160Packet
{
...
class PhotoTransfer : Bedrock160Packet
{
...
class ModalFormRequest : Bedrock160Packet
{
...
class ModalFormResponse : Bedrock160Packet
{
...
class ServerSettingsRequest : Bedrock160Packet
{
...
class ServerSettingsResponse : Bedrock160Packet
{
...
class ShowProfile : Bedrock160Packet
{
...
class SetDefaultGameType : Bedrock160Packet
{
