 ...
 */
module soupply.bedrock137.protocol.play;
...
class Login : Bedrock137Packet
{
    ...
    soupply.bedrock137.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.bedrock137.types.LoginBody body_=soupply.bedrock137.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class ResourcePacksInfo : Bedrock137Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.bigEndian) soupply.bedrock137.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.bigEndian) soupply.bedrock137.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock137.types.PackWithSize[] behaviourPacks=(soupply.bedrock137.types.PackWithSize[]).init, soupply.bedrock137.types.PackWithSize[] resourcePacks=(soupply.bedrock137.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock137Packet
{
    ...
    bool mustAccept;
    soupply.bedrock137.types.Pack[] behaviourPacks;
    soupply.bedrock137.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock137.types.Pack[] behaviourPacks=(soupply.bedrock137.types.Pack[]).init, soupply.bedrock137.types.Pack[] resourcePacks=(soupply.bedrock137.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class StartGame : Bedrock137Packet
{
    ...
    soupply.bedrock137.types.Rule[] gameRules;
...
class AddPlayer : Bedrock137Packet
{
    ...
    soupply.bedrock137.types.McpeUuid uuid;
    string username;
    @Var long entityId;
    @Var ulong runtimeId;
    Tuple!(float, "xyz") position;
    ...
    float headYaw;
    float yaw;
    soupply.bedrock137.types.Slot heldItem;
    Metadata metadata;
    @Var uint unknown11;
    @Var uint unknown12;
    @Var uint unknown13;
    ...
    @Var uint unknown15;
    long unknown16;
    soupply.bedrock137.types.Link[] links;
...
class AddHangingEntity : Bedrock137Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock137.types.BlockPosition position=soupply.bedrock137.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class UpdateBlock : Bedrock137Packet
{
    ...
    this(soupply.bedrock137.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Bedrock137Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock137.types.BlockPosition position=soupply.bedrock137.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class BlockEvent : Bedrock137Packet
{
    ...
    this(soupply.bedrock137.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class UpdateAttributes : Bedrock137Packet
{
    ...
    this(long entityId, soupply.bedrock137.types.Attribute[] attributes=(soupply.bedrock137.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock137Packet
{
    ...
    @Var uint type;
    soupply.bedrock137.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.bedrock137.types.InventoryAction[] actions=(soupply.bedrock137.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class UseItem : Bedrock137Packet
    {
        ...
        @Var uint actionType;
        soupply.bedrock137.types.BlockPosition blockPosition;
        @Var int face;
        @Var int hotbarSlot;
        soupply.bedrock137.types.Slot item;
...
class MobEquipment : Bedrock137Packet
{
    ...
    this(long entityId, soupply.bedrock137.types.Slot item=soupply.bedrock137.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock137Packet
{
    ...
    @Var long entityId;
    soupply.bedrock137.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.bedrock137.types.Slot[4] armor=(soupply.bedrock137.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class PlayerAction : Bedrock137Packet
{
    ...
    this(long entityId, int action=int.init, soupply.bedrock137.types.BlockPosition position=soupply.bedrock137.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class SetSpawnPosition : Bedrock137Packet
{
    ...
    this(int type, soupply.bedrock137.types.BlockPosition position=soupply.bedrock137.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class ContainerOpen : Bedrock137Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.bedrock137.types.BlockPosition position=soupply.bedrock137.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class InventoryContent : Bedrock137Packet
{
    ...
    @Var uint window;
    soupply.bedrock137.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.bedrock137.types.Slot[] slots=(soupply.bedrock137.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class CraftingData : Bedrock137Packet
{
    ...
    soupply.bedrock137.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock137.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock137Packet
{
    ...
    @Var int type;
    soupply.bedrock137.types.McpeUuid uuid;
    soupply.bedrock137.types.Slot[] input;
    soupply.bedrock137.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.bedrock137.types.McpeUuid uuid=soupply.bedrock137.types.McpeUuid.init, soupply.bedrock137.types.Slot[] input=(soupply.bedrock137.types.Slot[]).init, soupply.bedrock137.types.Slot[] output=(soupply.bedrock137.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class BlockEntityData : Bedrock137Packet
{
    ...
    this(soupply.bedrock137.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerList : Bedrock137Packet
{
    ...
    class Add : Bedrock137Packet
    {
        ...
        this(soupply.bedrock137.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock137Packet
    {
        ...
        soupply.bedrock137.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock137.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class ItemFrameDropItem : Bedrock137Packet
{
    ...
    this(soupply.bedrock137.types.BlockPosition position, soupply.bedrock137.types.Slot item=soupply.bedrock137.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock137Packet
{
    ...
    soupply.bedrock137.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock137.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class AvailableCommands : Bedrock137Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.bedrock137.types.Enum[] enums;
    soupply.bedrock137.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.bedrock137.types.Enum[] enums=(soupply.bedrock137.types.Enum[]).init, soupply.bedrock137.types.Command[] commands=(soupply.bedrock137.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock137Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.bedrock137.types.BlockPosition position;
...
class PlaySound : Bedrock137Packet
{
    ...
    this(string name, soupply.bedrock137.types.BlockPosition position=soupply.bedrock137.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class PlayerSkin : Bedrock137Packet
{
    ...
    this(soupply.bedrock137.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
