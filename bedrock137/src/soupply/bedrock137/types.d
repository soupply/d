...
import soupply.bedrock137.metadata;
...
struct PlayerList
{
    ...
    @Var long entityId;
    string displayName;
    soupply.bedrock137.types.Skin skin;
    string unknown4;
...
struct InventoryAction
{
    ...
    @Var uint slot;
    soupply.bedrock137.types.Slot oldItem;
    soupply.bedrock137.types.Slot newItem;
...
struct ChunkData
{
    ...
    private struct Container
    {
        ...
        soupply.bedrock137.types.Section[] sections;
        ushort[256] heights;
        ubyte[256] biomes;
        ubyte[] borders;
        soupply.bedrock137.types.ExtraData[] extraData;
...
struct Command
{
    ...
    int aliasesEnum = -1;
    soupply.bedrock137.types.Overload[] overloads;
...
struct Overload
{
    ...
    soupply.bedrock137.types.Parameter[] parameters;
