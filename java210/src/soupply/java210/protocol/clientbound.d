 ...
 */
module soupply.java210.protocol.clientbound;
...
class Statistics : Java210Packet
{
    ...
    soupply.java210.types.Statistic[] statistics;

    this() pure nothrow @safe @nogc {}

    this(soupply.java210.types.Statistic[] statistics) pure nothrow @safe @nogc
    {
...
class WindowItems : Java210Packet
{
    ...
    ubyte window;
    @Length!ushort soupply.java210.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.java210.types.Slot[] slots=(soupply.java210.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class SetSlot : Java210Packet
{
    ...
    ubyte window;
    ushort slot;
    soupply.java210.types.Slot item;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, soupply.java210.types.Slot item=soupply.java210.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.item = item;
...
class PlayerListItem : Java210Packet
{
    ...
    class AddPlayer : Java210Packet
    {
        ...
        soupply.java210.types.ListAddPlayer[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java210.types.ListAddPlayer[] players) pure nothrow @safe @nogc
        {
    ...
    class UpdateGamemode : Java210Packet
    {
        ...
        soupply.java210.types.ListUpdateGamemode[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java210.types.ListUpdateGamemode[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateLatency : Java210Packet
    {
        ...
        soupply.java210.types.ListUpdateLatency[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java210.types.ListUpdateLatency[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateDisplayName : Java210Packet
    {
        ...
        soupply.java210.types.ListUpdateDisplayName[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java210.types.ListUpdateDisplayName[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class EntityEquipment : Java210Packet
{
    ...
    this(uint entityId, uint slot=uint.init, soupply.java210.types.Slot item=soupply.java210.types.Slot.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.slot = slot;
        this.item = item;
...
class EntityProperties : Java210Packet
{
    ...
    @Var uint entityId;
    @Length!uint soupply.java210.types.Attribute[] attributes;

    this() pure nothrow @safe @nogc {}

    this(uint entityId, soupply.java210.types.Attribute[] attributes=(soupply.java210.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
