 ...
 */
module soupply.java335.protocol.clientbound;
...
class Statistics : Java335Packet
{
    ...
    soupply.java335.types.Statistic[] statistics;

    this() pure nothrow @safe @nogc {}

    this(soupply.java335.types.Statistic[] statistics) pure nothrow @safe @nogc
    {
...
class MultiBlockChange : Java335Packet
{
    ...
    Tuple!(int, "xz") chunk;
    soupply.java335.types.BlockChange[] changes;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") chunk, soupply.java335.types.BlockChange[] changes=(soupply.java335.types.BlockChange[]).init) pure nothrow @safe @nogc
    {
        this.chunk = chunk;
...
class WindowItems : Java335Packet
{
    ...
    ubyte window;
    @Length!ushort soupply.java335.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.java335.types.Slot[] slots=(soupply.java335.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class SetSlot : Java335Packet
{
    ...
    ubyte window;
    ushort slot;
    soupply.java335.types.Slot item;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, soupply.java335.types.Slot item=soupply.java335.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.item = item;
...
class Map : Java335Packet
{
    ...
    ubyte scale;
    bool showIcons;
    soupply.java335.types.Icon[] icons;
    ubyte colums;
    ubyte rows;
    ...
    this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.java335.types.Icon[] icons=(soupply.java335.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "xz") offset=Tuple!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.scale = scale;
...
class PlayerListItem : Java335Packet
{
    ...
    class AddPlayer : Java335Packet
    {
        ...
        soupply.java335.types.ListAddPlayer[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java335.types.ListAddPlayer[] players) pure nothrow @safe @nogc
        {
    ...
    class UpdateGamemode : Java335Packet
    {
        ...
        soupply.java335.types.ListUpdateGamemode[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java335.types.ListUpdateGamemode[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateLatency : Java335Packet
    {
        ...
        soupply.java335.types.ListUpdateLatency[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java335.types.ListUpdateLatency[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateDisplayName : Java335Packet
    {
        ...
        soupply.java335.types.ListUpdateDisplayName[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java335.types.ListUpdateDisplayName[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class EntityEquipment : Java335Packet
{
    ...
    this(uint entityId, uint slot=uint.init, soupply.java335.types.Slot item=soupply.java335.types.Slot.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.slot = slot;
        this.item = item;
...
class EntityProperties : Java335Packet
{
    ...
    @Var uint entityId;
    @Length!uint soupply.java335.types.Attribute[] attributes;

    this() pure nothrow @safe @nogc {}

    this(uint entityId, soupply.java335.types.Attribute[] attributes=(soupply.java335.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
