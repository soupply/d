 ...
 */
module soupply.bedrock160.protocol.play;
...
import soupply.bedrock160.metadata : Metadata;
import soupply.bedrock160.packet : Bedrock160Packet;
...
class Login : Bedrock160Packet
{
    ...
    soupply.bedrock160.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.bedrock160.types.LoginBody body_=soupply.bedrock160.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class ResourcePacksInfo : Bedrock160Packet
{
    ...
    this(bool mustAccept, soupply.bedrock160.types.PackWithSize[] behaviourPacks=(soupply.bedrock160.types.PackWithSize[]).init, soupply.bedrock160.types.PackWithSize[] resourcePacks=(soupply.bedrock160.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock160Packet
{
    ...
    bool mustAccept;
    soupply.bedrock160.types.Pack[] behaviourPacks;
    soupply.bedrock160.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock160.types.Pack[] behaviourPacks=(soupply.bedrock160.types.Pack[]).init, soupply.bedrock160.types.Pack[] resourcePacks=(soupply.bedrock160.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class AddEntity : Bedrock160Packet
{
    ...
    float pitch;
    float yaw;
    soupply.bedrock160.types.Attribute[] attributes;
    Metadata metadata;
    soupply.bedrock160.types.Link[] links;
...
class AddItemEntity : Bedrock160Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock160.types.Slot item=soupply.bedrock160.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Bedrock160Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock160.types.BlockPosition position=soupply.bedrock160.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class UpdateBlock : Bedrock160Packet
{
    ...
    this(soupply.bedrock160.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Bedrock160Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock160.types.BlockPosition position=soupply.bedrock160.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Bedrock160Packet
{
    ...
    Tuple!(float, "xyz") position;
    float radius;
    soupply.bedrock160.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.bedrock160.types.BlockPosition[] destroyedBlocks=(soupply.bedrock160.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class BlockEvent : Bedrock160Packet
{
    ...
    this(soupply.bedrock160.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class UpdateAttributes : Bedrock160Packet
{
    ...
    this(long entityId, soupply.bedrock160.types.Attribute[] attributes=(soupply.bedrock160.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock160Packet
{
    ...
    @Var uint type;
    soupply.bedrock160.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.bedrock160.types.InventoryAction[] actions=(soupply.bedrock160.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class UseItemOnEntity : Bedrock160Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.bedrock160.types.Slot item=soupply.bedrock160.types.Slot.init, Tuple!(float, "xyz") unknown4=Tuple!(float, "xyz").init, Tuple!(float, "xyz") unknown5=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock160Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.bedrock160.types.Slot item=soupply.bedrock160.types.Slot.init, Tuple!(float, "xyz") headPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class MobEquipment : Bedrock160Packet
{
    ...
    this(long entityId, soupply.bedrock160.types.Slot item=soupply.bedrock160.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock160Packet
{
    ...
    @Var long entityId;
    soupply.bedrock160.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.bedrock160.types.Slot[4] armor=(soupply.bedrock160.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class PlayerAction : Bedrock160Packet
{
    ...
    this(long entityId, int action=int.init, soupply.bedrock160.types.BlockPosition position=soupply.bedrock160.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class SetSpawnPosition : Bedrock160Packet
{
    ...
    this(int type, soupply.bedrock160.types.BlockPosition position=soupply.bedrock160.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class ContainerOpen : Bedrock160Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.bedrock160.types.BlockPosition position=soupply.bedrock160.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class InventoryContent : Bedrock160Packet
{
    ...
    @Var uint window;
    soupply.bedrock160.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.bedrock160.types.Slot[] slots=(soupply.bedrock160.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class CraftingData : Bedrock160Packet
{
    ...
    soupply.bedrock160.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock160.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock160Packet
{
    ...
    @Var int type;
    soupply.bedrock160.types.McpeUuid uuid;
    soupply.bedrock160.types.Slot[] input;
    soupply.bedrock160.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.bedrock160.types.McpeUuid uuid=soupply.bedrock160.types.McpeUuid.init, soupply.bedrock160.types.Slot[] input=(soupply.bedrock160.types.Slot[]).init, soupply.bedrock160.types.Slot[] output=(soupply.bedrock160.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class BlockEntityData : Bedrock160Packet
{
    ...
    this(soupply.bedrock160.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class FullChunkData : Bedrock160Packet
{
    ...
    soupply.bedrock160.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") position, soupply.bedrock160.types.ChunkData data=soupply.bedrock160.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class PlayerList : Bedrock160Packet
{
    ...
    class Add : Bedrock160Packet
    {
        ...
        soupply.bedrock160.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock160.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock160Packet
    {
        ...
        soupply.bedrock160.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock160.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class ClientboundMapItemData : Bedrock160Packet
{
    ...
    @Condition("update==4") soupply.bedrock160.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.bedrock160.types.Decoration[] decorations=(soupply.bedrock160.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class ItemFrameDropItem : Bedrock160Packet
{
    ...
    this(soupply.bedrock160.types.BlockPosition position, soupply.bedrock160.types.Slot item=soupply.bedrock160.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock160Packet
{
    ...
    soupply.bedrock160.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock160.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class AvailableCommands : Bedrock160Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.bedrock160.types.Enum[] enums;
    soupply.bedrock160.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.bedrock160.types.Enum[] enums=(soupply.bedrock160.types.Enum[]).init, soupply.bedrock160.types.Command[] commands=(soupply.bedrock160.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandRequest : Bedrock160Packet
{
    ...
    this(string command, uint type=uint.init, soupply.bedrock160.types.McpeUuid uuid=soupply.bedrock160.types.McpeUuid.init, string requestId=string.init, int playerId=int.init, bool internal=bool.init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock160Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.bedrock160.types.BlockPosition position;
...
class PlaySound : Bedrock160Packet
{
    ...
    this(string name, soupply.bedrock160.types.BlockPosition position=soupply.bedrock160.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class PlayerSkin : Bedrock160Packet
{
    ...
    this(soupply.bedrock160.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
