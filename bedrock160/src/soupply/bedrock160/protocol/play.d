...
class AddItemEntity : Bedrock160Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock160.types.Slot item=soupply.bedrock160.types.Slot.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class Explode : Bedrock160Packet
{
    ...
    this(Vector!(float, "xyz") position, float radius=float.init, soupply.bedrock160.types.BlockPosition[] destroyedBlocks=(soupply.bedrock160.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class InventoryTransaction : Bedrock160Packet
{
    ...
    class UseItemOnEntity : Bedrock160Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.bedrock160.types.Slot item=soupply.bedrock160.types.Slot.init, Vector!(float, "xyz") unknown4=Vector!(float, "xyz").init, Vector!(float, "xyz") unknown5=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock160Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.bedrock160.types.Slot item=soupply.bedrock160.types.Slot.init, Vector!(float, "xyz") headPosition=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class FullChunkData : Bedrock160Packet
{
    ...
    this(Vector!(int, "xz") position, soupply.bedrock160.types.ChunkData data=soupply.bedrock160.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class ClientboundMapItemData : Bedrock160Packet
{
    ...
    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Vector!(int, "xz") size=Vector!(int, "xz").init, Vector!(int, "xz") offset=Vector!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.bedrock160.types.Decoration[] decorations=(soupply.bedrock160.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
