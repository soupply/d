...
import soupply.bedrock160.metadata;
...
struct PlayerList
{
    ...
    @Var long entityId;
    string displayName;
    soupply.bedrock160.types.Skin skin;
    string unknown4;
...
struct ChunkData
{
    ...
    private struct Container
    {
        ...
        soupply.bedrock160.types.Section[] sections;
        ushort[256] heights;
        ubyte[256] biomes;
        ubyte[] borders;
        soupply.bedrock160.types.ExtraData[] extraData;
...
struct Command
{
    ...
    int aliasesEnum = -1;
    soupply.bedrock160.types.Overload[] overloads;
...
struct Overload
{
    ...
    soupply.bedrock160.types.Parameter[] parameters;
