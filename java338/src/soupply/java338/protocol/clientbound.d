 ...
 */
module soupply.java338.protocol.clientbound;
...
import soupply.java338.metadata : Metadata;
import soupply.java338.packet : Java338Packet;

static import soupply.java338.types;
...
class Statistics : Java338Packet
{
    ...
    soupply.java338.types.Statistic[] statistics;

    this() pure nothrow @safe @nogc {}

    this(soupply.java338.types.Statistic[] statistics) pure nothrow @safe @nogc
    {
...
class MultiBlockChange : Java338Packet
{
    ...
    Tuple!(int, "xz") chunk;
    soupply.java338.types.BlockChange[] changes;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") chunk, soupply.java338.types.BlockChange[] changes=(soupply.java338.types.BlockChange[]).init) pure nothrow @safe @nogc
    {
        this.chunk = chunk;
...
class WindowItems : Java338Packet
{
    ...
    ubyte window;
    @Length!ushort soupply.java338.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.java338.types.Slot[] slots=(soupply.java338.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class SetSlot : Java338Packet
{
    ...
    ubyte window;
    ushort slot;
    soupply.java338.types.Slot item;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, soupply.java338.types.Slot item=soupply.java338.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.item = item;
...
class Map : Java338Packet
{
    ...
    ubyte scale;
    bool showIcons;
    soupply.java338.types.Icon[] icons;
    ubyte colums;
    ubyte rows;
    ...
    this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.java338.types.Icon[] icons=(soupply.java338.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "xz") offset=Tuple!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.scale = scale;
...
class PlayerListItem : Java338Packet
{
    ...
    class AddPlayer : Java338Packet
    {
        ...
        soupply.java338.types.ListAddPlayer[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java338.types.ListAddPlayer[] players) pure nothrow @safe @nogc
        {
    ...
    class UpdateGamemode : Java338Packet
    {
        ...
        soupply.java338.types.ListUpdateGamemode[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java338.types.ListUpdateGamemode[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateLatency : Java338Packet
    {
        ...
        soupply.java338.types.ListUpdateLatency[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java338.types.ListUpdateLatency[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateDisplayName : Java338Packet
    {
        ...
        soupply.java338.types.ListUpdateDisplayName[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java338.types.ListUpdateDisplayName[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class EntityEquipment : Java338Packet
{
    ...
    this(uint entityId, uint slot=uint.init, soupply.java338.types.Slot item=soupply.java338.types.Slot.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.slot = slot;
        this.item = item;
...
class EntityProperties : Java338Packet
{
    ...
    @Var uint entityId;
    @Length!uint soupply.java338.types.Attribute[] attributes;

    this() pure nothrow @safe @nogc {}

    this(uint entityId, soupply.java338.types.Attribute[] attributes=(soupply.java338.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
