...
class MetadataValue : Java338Packet
{
...
class MetadataValue5 : MetadataValue
{
    ...
    this(ubyte id, soupply.java338.types.Slot value) pure nothrow @safe @nogc
    {
        super(id, 5);
        this.value = value;
    }
...
class MetadataValue9 : MetadataValue
{
    ...
    this(ubyte id, soupply.java338.types.OptionalPosition value) pure nothrow @safe @nogc
    {
        super(id, 9);
        this.value = value;
    }
...
class MetadataValue11 : MetadataValue
{
    ...
    this(ubyte id, soupply.java338.types.OptionalUuid value) pure nothrow @safe @nogc
    {
        super(id, 11);
        this.value = value;
    }
