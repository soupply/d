 ...
 */
module soupply.java340.protocol.serverbound;
...
class ClickWindow : Java340Packet
{
    ...
    ushort action;
    @Var uint mode;
    soupply.java340.types.Slot clickedItem;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, soupply.java340.types.Slot clickedItem=soupply.java340.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.button = button;
...
class CreativeInventoryAction : Java340Packet
{
    ...
    this(ushort slot, soupply.java340.types.Slot clickedItem=soupply.java340.types.Slot.init) pure nothrow @safe @nogc
    {
        this.slot = slot;
        this.clickedItem = clickedItem;
    }
