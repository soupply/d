 ...
 */
module soupply.java340.protocol.clientbound;
...
class Statistics : Java340Packet
{
    ...
    soupply.java340.types.Statistic[] statistics;

    this() pure nothrow @safe @nogc {}

    this(soupply.java340.types.Statistic[] statistics) pure nothrow @safe @nogc
    {
...
class MultiBlockChange : Java340Packet
{
    ...
    Tuple!(int, "xz") chunk;
    soupply.java340.types.BlockChange[] changes;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") chunk, soupply.java340.types.BlockChange[] changes=(soupply.java340.types.BlockChange[]).init) pure nothrow @safe @nogc
    {
        this.chunk = chunk;
...
class WindowItems : Java340Packet
{
    ...
    ubyte window;
    @Length!ushort soupply.java340.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.java340.types.Slot[] slots=(soupply.java340.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class SetSlot : Java340Packet
{
    ...
    ubyte window;
    ushort slot;
    soupply.java340.types.Slot item;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, soupply.java340.types.Slot item=soupply.java340.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.item = item;
...
class Map : Java340Packet
{
    ...
    ubyte scale;
    bool showIcons;
    soupply.java340.types.Icon[] icons;
    ubyte colums;
    ubyte rows;
    ...
    this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.java340.types.Icon[] icons=(soupply.java340.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "xz") offset=Tuple!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.scale = scale;
...
class PlayerListItem : Java340Packet
{
    ...
    class AddPlayer : Java340Packet
    {
        ...
        soupply.java340.types.ListAddPlayer[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java340.types.ListAddPlayer[] players) pure nothrow @safe @nogc
        {
    ...
    class UpdateGamemode : Java340Packet
    {
        ...
        soupply.java340.types.ListUpdateGamemode[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java340.types.ListUpdateGamemode[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateLatency : Java340Packet
    {
        ...
        soupply.java340.types.ListUpdateLatency[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java340.types.ListUpdateLatency[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateDisplayName : Java340Packet
    {
        ...
        this(soupply.java340.types.ListUpdateDisplayName[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class EntityEquipment : Java340Packet
{
    ...
    this(uint entityId, uint slot=uint.init, soupply.java340.types.Slot item=soupply.java340.types.Slot.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.slot = slot;
        this.item = item;
...
class EntityProperties : Java340Packet
{
    ...
    @Var uint entityId;
    @Length!uint soupply.java340.types.Attribute[] attributes;

    this() pure nothrow @safe @nogc {}

    this(uint entityId, soupply.java340.types.Attribute[] attributes=(soupply.java340.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
