...
class MultiBlockChange : Java316Packet
{
    ...
    this(Tuple!(int, "xz") chunk, soupply.java316.types.BlockChange[] changes=(soupply.java316.types.BlockChange[]).init) pure nothrow @safe @nogc
    {
        this.chunk = chunk;
...
class Map : Java316Packet
{
    ...
    this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.java316.types.Icon[] icons=(soupply.java316.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "xz") offset=Tuple!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.scale = scale;
