...
class AddItemEntity : Bedrock150Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock150.types.Slot item=soupply.bedrock150.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class Explode : Bedrock150Packet
{
    ...
    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.bedrock150.types.BlockPosition[] destroyedBlocks=(soupply.bedrock150.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class InventoryTransaction : Bedrock150Packet
{
    ...
    class UseItemOnEntity : Bedrock150Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.bedrock150.types.Slot item=soupply.bedrock150.types.Slot.init, Tuple!(float, "xyz") unknown4=Tuple!(float, "xyz").init, Tuple!(float, "xyz") unknown5=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock150Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.bedrock150.types.Slot item=soupply.bedrock150.types.Slot.init, Tuple!(float, "xyz") headPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class FullChunkData : Bedrock150Packet
{
    ...
    this(Tuple!(int, "xz") position, soupply.bedrock150.types.ChunkData data=soupply.bedrock150.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class ClientboundMapItemData : Bedrock150Packet
{
    ...
    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.bedrock150.types.Decoration[] decorations=(soupply.bedrock150.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
