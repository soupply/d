 ...
 */
module soupply.java315.protocol.clientbound;
...
class Statistics : Java315Packet
{
    ...
    soupply.java315.types.Statistic[] statistics;

    this() pure nothrow @safe @nogc {}

    this(soupply.java315.types.Statistic[] statistics) pure nothrow @safe @nogc
    {
...
class MultiBlockChange : Java315Packet
{
    ...
    Tuple!(int, "xz") chunk;
    soupply.java315.types.BlockChange[] changes;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") chunk, soupply.java315.types.BlockChange[] changes=(soupply.java315.types.BlockChange[]).init) pure nothrow @safe @nogc
    {
        this.chunk = chunk;
...
class WindowItems : Java315Packet
{
    ...
    ubyte window;
    @Length!ushort soupply.java315.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.java315.types.Slot[] slots=(soupply.java315.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class SetSlot : Java315Packet
{
    ...
    ubyte window;
    ushort slot;
    soupply.java315.types.Slot item;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, soupply.java315.types.Slot item=soupply.java315.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.item = item;
...
class Map : Java315Packet
{
    ...
    ubyte scale;
    bool showIcons;
    soupply.java315.types.Icon[] icons;
    ubyte colums;
    ubyte rows;
    ...
    this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.java315.types.Icon[] icons=(soupply.java315.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "xz") offset=Tuple!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.scale = scale;
...
class PlayerListItem : Java315Packet
{
    ...
    class AddPlayer : Java315Packet
    {
        ...
        soupply.java315.types.ListAddPlayer[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java315.types.ListAddPlayer[] players) pure nothrow @safe @nogc
        {
    ...
    class UpdateGamemode : Java315Packet
    {
        ...
        soupply.java315.types.ListUpdateGamemode[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java315.types.ListUpdateGamemode[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateLatency : Java315Packet
    {
        ...
        soupply.java315.types.ListUpdateLatency[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java315.types.ListUpdateLatency[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
    ...
    class UpdateDisplayName : Java315Packet
    {
        ...
        soupply.java315.types.ListUpdateDisplayName[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.java315.types.ListUpdateDisplayName[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class EntityEquipment : Java315Packet
{
    ...
    this(uint entityId, uint slot=uint.init, soupply.java315.types.Slot item=soupply.java315.types.Slot.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.slot = slot;
        this.item = item;
...
class EntityProperties : Java315Packet
{
    ...
    @Var uint entityId;
    @Length!uint soupply.java315.types.Attribute[] attributes;

    this() pure nothrow @safe @nogc {}

    this(uint entityId, soupply.java315.types.Attribute[] attributes=(soupply.java315.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
