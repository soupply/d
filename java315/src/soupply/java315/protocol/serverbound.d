 ...
 */
module soupply.java315.protocol.serverbound;
...
class ClickWindow : Java315Packet
{
    ...
    ushort action;
    @Var uint mode;
    soupply.java315.types.Slot clickedItem;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, soupply.java315.types.Slot clickedItem=soupply.java315.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.button = button;
...
class CreativeInventoryAction : Java315Packet
{
    ...
    this(ushort slot, soupply.java315.types.Slot clickedItem=soupply.java315.types.Slot.init) pure nothrow @safe @nogc
    {
        this.slot = slot;
        this.clickedItem = clickedItem;
    }
