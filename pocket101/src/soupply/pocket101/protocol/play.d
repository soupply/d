 ...
 */
module soupply.pocket101.protocol.play;
...
import soupply.pocket101.metadata : Metadata;
...
class ResourcePacksInfo : Pocket101Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket101.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket101.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.pocket101.types.PackWithSize[] behaviourPacks=(soupply.pocket101.types.PackWithSize[]).init, soupply.pocket101.types.PackWithSize[] resourcePacks=(soupply.pocket101.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Pocket101Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket101.types.Pack[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket101.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.pocket101.types.Pack[] behaviourPacks=(soupply.pocket101.types.Pack[]).init, soupply.pocket101.types.Pack[] resourcePacks=(soupply.pocket101.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class AddItemEntity : Pocket101Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.pocket101.types.Slot item;
    Vector!(float, "xyz") position;
    Vector!(float, "xyz") motion;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.pocket101.types.Slot item=soupply.pocket101.types.Slot.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Pocket101Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.pocket101.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.pocket101.types.BlockPosition position=soupply.pocket101.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class RemoveBlock : Pocket101Packet
{
    ...
    this(soupply.pocket101.types.BlockPosition position) pure nothrow @safe @nogc
    {
        this.position = position;
    }
...
class UpdateBlock : Pocket101Packet
{
    ...
    this(soupply.pocket101.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Pocket101Packet
{
    ...
    this(long entityId, long runtimeId=long.init, soupply.pocket101.types.BlockPosition position=soupply.pocket101.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Pocket101Packet
{
    ...
    Vector!(float, "xyz") position;
    float radius;
    soupply.pocket101.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Vector!(float, "xyz") position, float radius=float.init, soupply.pocket101.types.BlockPosition[] destroyedBlocks=(soupply.pocket101.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class BlockEvent : Pocket101Packet
{
    ...
    this(soupply.pocket101.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class UpdateAttributes : Pocket101Packet
{
    ...
    this(long entityId, soupply.pocket101.types.Attribute[] attributes=(soupply.pocket101.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class MobEquipment : Pocket101Packet
{
    ...
    this(long entityId, soupply.pocket101.types.Slot item=soupply.pocket101.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Pocket101Packet
{
    ...
    @Var long entityId;
    soupply.pocket101.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.pocket101.types.Slot[4] armor=(soupply.pocket101.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class UseItem : Pocket101Packet
{
    ...
    soupply.pocket101.types.BlockPosition blockPosition;
    @Var uint hotbarSlot;
    @Var int face;
    ...
    this(soupply.pocket101.types.BlockPosition blockPosition, uint hotbarSlot=uint.init, int face=int.init, Vector!(float, "xyz") facePosition=Vector!(float, "xyz").init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, int slot=int.init, soupply.pocket101.types.Slot item=soupply.pocket101.types.Slot.init) pure nothrow @safe @nogc
    {
...
class PlayerAction : Pocket101Packet
{
    ...
    this(long entityId, int action=int.init, soupply.pocket101.types.BlockPosition position=soupply.pocket101.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class SetSpawnPosition : Pocket101Packet
{
    ...
    this(int unknown0, soupply.pocket101.types.BlockPosition position=soupply.pocket101.types.BlockPosition.init, bool unknown2=bool.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
        this.unknown2 = unknown2;
...
class DropItem : Pocket101Packet
{
    ...
    this(ubyte action, soupply.pocket101.types.Slot item=soupply.pocket101.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class InventoryAction : Pocket101Packet
{
    ...
    this(int action, soupply.pocket101.types.Slot item=soupply.pocket101.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class ContainerOpen : Pocket101Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, int slotCount=int.init, soupply.pocket101.types.BlockPosition position=soupply.pocket101.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
...
class ContainerSetSlot : Pocket101Packet
{
    ...
    this(ubyte window, int slot=int.init, int hotbarSlot=int.init, soupply.pocket101.types.Slot item=soupply.pocket101.types.Slot.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.hotbarSlot = hotbarSlot;
...
class ContainerSetContent : Pocket101Packet
{
    ...
    ubyte window;
    soupply.pocket101.types.Slot[] slots;
    @Var int[] hotbar;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.pocket101.types.Slot[] slots=(soupply.pocket101.types.Slot[]).init, int[] hotbar=(int[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
        this.hotbar = hotbar;
...
class CraftingData : Pocket101Packet
{
    ...
    soupply.pocket101.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.pocket101.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Pocket101Packet
{
    ...
    @Var int type;
    UUID uuid;
    soupply.pocket101.types.Slot[] input;
    soupply.pocket101.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, UUID uuid=UUID.init, soupply.pocket101.types.Slot[] input=(soupply.pocket101.types.Slot[]).init, soupply.pocket101.types.Slot[] output=(soupply.pocket101.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class BlockEntityData : Pocket101Packet
{
    ...
    this(soupply.pocket101.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class FullChunkData : Pocket101Packet
{
    ...
    soupply.pocket101.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Vector!(int, "xz") position, soupply.pocket101.types.ChunkData data=soupply.pocket101.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class PlayerList : Pocket101Packet
{
    ...
    class Add : Pocket101Packet
    {
        ...
        soupply.pocket101.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.pocket101.types.PlayerList[] players) pure nothrow @safe @nogc
        {
...
class ClientboundMapItemData : Pocket101Packet
{
    ...
    @Condition("update==4") soupply.pocket101.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Vector!(int, "xz") size=Vector!(int, "xz").init, Vector!(int, "xz") offset=Vector!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.pocket101.types.Decoration[] decorations=(soupply.pocket101.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class ItemFrameDropItem : Pocket101Packet
{
    ...
    this(soupply.pocket101.types.BlockPosition position, soupply.pocket101.types.Slot item=soupply.pocket101.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class ReplaceSelectedItem : Pocket101Packet
{
    ...
    this(soupply.pocket101.types.Slot item) pure nothrow @safe @nogc
    {
        this.item = item;
    }
...
class GameRulesChanged : Pocket101Packet
{
    ...
    @Length!uint soupply.pocket101.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.pocket101.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
