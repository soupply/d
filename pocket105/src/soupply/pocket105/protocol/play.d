 ...
 */
module soupply.pocket105.protocol.play;
...
import soupply.pocket105.metadata : Metadata;
import soupply.pocket105.packet : Pocket105Packet;

static import soupply.pocket105.types;
...
class ResourcePacksInfo : Pocket105Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket105.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket105.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.pocket105.types.PackWithSize[] behaviourPacks=(soupply.pocket105.types.PackWithSize[]).init, soupply.pocket105.types.PackWithSize[] resourcePacks=(soupply.pocket105.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Pocket105Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket105.types.Pack[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket105.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.pocket105.types.Pack[] behaviourPacks=(soupply.pocket105.types.Pack[]).init, soupply.pocket105.types.Pack[] resourcePacks=(soupply.pocket105.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class AddEntity : Pocket105Packet
{
    ...
    float pitch;
    float yaw;
    soupply.pocket105.types.Attribute[] attributes;
    Metadata metadata;
    soupply.pocket105.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, uint type=uint.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.pocket105.types.Attribute[] attributes=(soupply.pocket105.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.pocket105.types.Link[] links=(soupply.pocket105.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class AddItemEntity : Pocket105Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.pocket105.types.Slot item;
    Vector!(float, "xyz") position;
    Vector!(float, "xyz") motion;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.pocket105.types.Slot item=soupply.pocket105.types.Slot.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Pocket105Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.pocket105.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.pocket105.types.BlockPosition position=soupply.pocket105.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class RemoveBlock : Pocket105Packet
{
    ...
    this(soupply.pocket105.types.BlockPosition position) pure nothrow @safe @nogc
    {
        this.position = position;
    }
...
class UpdateBlock : Pocket105Packet
{
    ...
    this(soupply.pocket105.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Pocket105Packet
{
    ...
    this(long entityId, long runtimeId=long.init, soupply.pocket105.types.BlockPosition position=soupply.pocket105.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Pocket105Packet
{
    ...
    Vector!(float, "xyz") position;
    float radius;
    soupply.pocket105.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Vector!(float, "xyz") position, float radius=float.init, soupply.pocket105.types.BlockPosition[] destroyedBlocks=(soupply.pocket105.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class BlockEvent : Pocket105Packet
{
    ...
    this(soupply.pocket105.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class UpdateAttributes : Pocket105Packet
{
    ...
    this(long entityId, soupply.pocket105.types.Attribute[] attributes=(soupply.pocket105.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class MobEquipment : Pocket105Packet
{
    ...
    this(long entityId, soupply.pocket105.types.Slot item=soupply.pocket105.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Pocket105Packet
{
    ...
    @Var long entityId;
    soupply.pocket105.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.pocket105.types.Slot[4] armor=(soupply.pocket105.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class UseItem : Pocket105Packet
{
    ...
    soupply.pocket105.types.BlockPosition blockPosition;
    @Var uint hotbarSlot;
    @Var int face;
    ...
    this(soupply.pocket105.types.BlockPosition blockPosition, uint hotbarSlot=uint.init, int face=int.init, Vector!(float, "xyz") facePosition=Vector!(float, "xyz").init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, int slot=int.init, soupply.pocket105.types.Slot item=soupply.pocket105.types.Slot.init) pure nothrow @safe @nogc
    {
...
class PlayerAction : Pocket105Packet
{
    ...
    this(long entityId, int action=int.init, soupply.pocket105.types.BlockPosition position=soupply.pocket105.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class SetSpawnPosition : Pocket105Packet
{
    ...
    this(int unknown0, soupply.pocket105.types.BlockPosition position=soupply.pocket105.types.BlockPosition.init, bool unknown2=bool.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
        this.unknown2 = unknown2;
...
class DropItem : Pocket105Packet
{
    ...
    this(ubyte action, soupply.pocket105.types.Slot item=soupply.pocket105.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class InventoryAction : Pocket105Packet
{
    ...
    this(int action, soupply.pocket105.types.Slot item=soupply.pocket105.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class ContainerOpen : Pocket105Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, int slotCount=int.init, soupply.pocket105.types.BlockPosition position=soupply.pocket105.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
...
class ContainerSetSlot : Pocket105Packet
{
    ...
    this(ubyte window, int slot=int.init, int hotbarSlot=int.init, soupply.pocket105.types.Slot item=soupply.pocket105.types.Slot.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.hotbarSlot = hotbarSlot;
...
class ContainerSetContent : Pocket105Packet
{
    ...
    ubyte window;
    soupply.pocket105.types.Slot[] slots;
    @Var int[] hotbar;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.pocket105.types.Slot[] slots=(soupply.pocket105.types.Slot[]).init, int[] hotbar=(int[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
        this.hotbar = hotbar;
...
class CraftingData : Pocket105Packet
{
    ...
    soupply.pocket105.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.pocket105.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Pocket105Packet
{
    ...
    @Var int type;
    UUID uuid;
    soupply.pocket105.types.Slot[] input;
    soupply.pocket105.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, UUID uuid=UUID.init, soupply.pocket105.types.Slot[] input=(soupply.pocket105.types.Slot[]).init, soupply.pocket105.types.Slot[] output=(soupply.pocket105.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class BlockEntityData : Pocket105Packet
{
    ...
    this(soupply.pocket105.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class FullChunkData : Pocket105Packet
{
    ...
    soupply.pocket105.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Vector!(int, "xz") position, soupply.pocket105.types.ChunkData data=soupply.pocket105.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class PlayerList : Pocket105Packet
{
    ...
    class Add : Pocket105Packet
    {
        ...
        soupply.pocket105.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.pocket105.types.PlayerList[] players) pure nothrow @safe @nogc
        {
...
class ClientboundMapItemData : Pocket105Packet
{
    ...
    @Condition("update==4") soupply.pocket105.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Vector!(int, "xz") size=Vector!(int, "xz").init, Vector!(int, "xz") offset=Vector!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.pocket105.types.Decoration[] decorations=(soupply.pocket105.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class ItemFrameDropItem : Pocket105Packet
{
    ...
    this(soupply.pocket105.types.BlockPosition position, soupply.pocket105.types.Slot item=soupply.pocket105.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class ReplaceItemInSlot : Pocket105Packet
{
    ...
    this(soupply.pocket105.types.Slot item) pure nothrow @safe @nogc
    {
        this.item = item;
    }
...
class GameRulesChanged : Pocket105Packet
{
    ...
    @Length!uint soupply.pocket105.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.pocket105.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class CommandBlockUpdate : Pocket105Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.pocket105.types.BlockPosition position;
    ...
    this(bool updateBlock, soupply.pocket105.types.BlockPosition position=soupply.pocket105.types.BlockPosition.init, uint mode=uint.init, bool redstoneMode=bool.init, bool conditional=bool.init, long minecart=long.init, string command=string.init, string lastOutput=string.init, string hover=string.init, bool trackOutput=bool.init) pure nothrow @safe @nogc
    {
...
class PlaySound : Pocket105Packet
{
    ...
    this(string unknown0, soupply.pocket105.types.BlockPosition position=soupply.pocket105.types.BlockPosition.init, float unknown2=float.init, float unknown3=float.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
        this.unknown2 = unknown2;
