...
class AddItemEntity : Pocket105Packet
{
    ...
    this(long entityId, long runtimeId=long.init, soupply.pocket105.types.Slot item=soupply.pocket105.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class Explode : Pocket105Packet
{
    ...
    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.pocket105.types.BlockPosition[] destroyedBlocks=(soupply.pocket105.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class FullChunkData : Pocket105Packet
{
    ...
    this(Tuple!(int, "xz") position, soupply.pocket105.types.ChunkData data=soupply.pocket105.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class ClientboundMapItemData : Pocket105Packet
{
    ...
    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.pocket105.types.Decoration[] decorations=(soupply.pocket105.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
