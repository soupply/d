 ...
 */
module soupply.bedrock201.protocol.play;
...
class Login : Bedrock201Packet
{
    ...
    soupply.bedrock201.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.bedrock201.types.LoginBody body_=soupply.bedrock201.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class ResourcePacksInfo : Bedrock201Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.bigEndian) soupply.bedrock201.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.bigEndian) soupply.bedrock201.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock201.types.PackWithSize[] behaviourPacks=(soupply.bedrock201.types.PackWithSize[]).init, soupply.bedrock201.types.PackWithSize[] resourcePacks=(soupply.bedrock201.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock201Packet
{
    ...
    bool mustAccept;
    soupply.bedrock201.types.Pack[] behaviourPacks;
    soupply.bedrock201.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock201.types.Pack[] behaviourPacks=(soupply.bedrock201.types.Pack[]).init, soupply.bedrock201.types.Pack[] resourcePacks=(soupply.bedrock201.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class StartGame : Bedrock201Packet
{
    ...
    soupply.bedrock201.types.Rule[] gameRules;
...
class AddPlayer : Bedrock201Packet
{
    ...
    float headYaw;
    float yaw;
    soupply.bedrock201.types.Slot heldItem;
    Metadata metadata;
    @Var uint unknown11;
    @Var uint unknown12;
    @Var uint unknown13;
...
class AddEntity : Bedrock201Packet
{
    ...
    float pitch;
    float yaw;
    soupply.bedrock201.types.Attribute[] attributes;
    Metadata metadata;
    soupply.bedrock201.types.Link[] links;
...
class AddItemEntity : Bedrock201Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.bedrock201.types.Slot item;
    Tuple!(float, "xyz") position;
    Tuple!(float, "xyz") motion;
    Metadata metadata;
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock201.types.Slot item=soupply.bedrock201.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Bedrock201Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.bedrock201.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock201.types.BlockPosition position=soupply.bedrock201.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class UpdateBlock : Bedrock201Packet
{
    ...
    this(soupply.bedrock201.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Bedrock201Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock201.types.BlockPosition position=soupply.bedrock201.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Bedrock201Packet
{
    ...
    Tuple!(float, "xyz") position;
    float radius;
    soupply.bedrock201.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.bedrock201.types.BlockPosition[] destroyedBlocks=(soupply.bedrock201.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class BlockEvent : Bedrock201Packet
{
    ...
    this(soupply.bedrock201.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class UpdateAttributes : Bedrock201Packet
{
    ...
    this(long entityId, soupply.bedrock201.types.Attribute[] attributes=(soupply.bedrock201.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock201Packet
{
    ...
    @Var uint type;
    soupply.bedrock201.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.bedrock201.types.InventoryAction[] actions=(soupply.bedrock201.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class UseItem : Bedrock201Packet
    {
        ...
        @Var uint actionType;
        soupply.bedrock201.types.BlockPosition blockPosition;
        @Var int face;
        @Var int hotbarSlot;
        soupply.bedrock201.types.Slot item;
    ...
    class UseItemOnEntity : Bedrock201Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.bedrock201.types.Slot item=soupply.bedrock201.types.Slot.init, Tuple!(float, "xyz") unknown4=Tuple!(float, "xyz").init, Tuple!(float, "xyz") unknown5=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock201Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.bedrock201.types.Slot item=soupply.bedrock201.types.Slot.init, Tuple!(float, "xyz") headPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class MobEquipment : Bedrock201Packet
{
    ...
    this(long entityId, soupply.bedrock201.types.Slot item=soupply.bedrock201.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock201Packet
{
    ...
    @Var long entityId;
    soupply.bedrock201.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.bedrock201.types.Slot[4] armor=(soupply.bedrock201.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class PlayerAction : Bedrock201Packet
{
    ...
    this(long entityId, int action=int.init, soupply.bedrock201.types.BlockPosition position=soupply.bedrock201.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class SetSpawnPosition : Bedrock201Packet
{
    ...
    this(int type, soupply.bedrock201.types.BlockPosition position=soupply.bedrock201.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class ContainerOpen : Bedrock201Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.bedrock201.types.BlockPosition position=soupply.bedrock201.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class InventoryContent : Bedrock201Packet
{
    ...
    @Var uint window;
    soupply.bedrock201.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.bedrock201.types.Slot[] slots=(soupply.bedrock201.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class CraftingData : Bedrock201Packet
{
    ...
    soupply.bedrock201.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock201.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock201Packet
{
    ...
    @Var int type;
    soupply.bedrock201.types.McpeUuid uuid;
    soupply.bedrock201.types.Slot[] input;
    soupply.bedrock201.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.bedrock201.types.McpeUuid uuid=soupply.bedrock201.types.McpeUuid.init, soupply.bedrock201.types.Slot[] input=(soupply.bedrock201.types.Slot[]).init, soupply.bedrock201.types.Slot[] output=(soupply.bedrock201.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class BlockEntityData : Bedrock201Packet
{
    ...
    this(soupply.bedrock201.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class FullChunkData : Bedrock201Packet
{
    ...
    soupply.bedrock201.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Tuple!(int, "xz") position, soupply.bedrock201.types.ChunkData data=soupply.bedrock201.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class PlayerList : Bedrock201Packet
{
    ...
    class Add : Bedrock201Packet
    {
        ...
        soupply.bedrock201.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock201.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock201Packet
    {
        ...
        soupply.bedrock201.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock201.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class ClientboundMapItemData : Bedrock201Packet
{
    ...
    @Condition("update==4") soupply.bedrock201.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.bedrock201.types.Decoration[] decorations=(soupply.bedrock201.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class ItemFrameDropItem : Bedrock201Packet
{
    ...
    this(soupply.bedrock201.types.BlockPosition position, soupply.bedrock201.types.Slot item=soupply.bedrock201.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock201Packet
{
    ...
    soupply.bedrock201.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock201.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class AvailableCommands : Bedrock201Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.bedrock201.types.Enum[] enums;
    soupply.bedrock201.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.bedrock201.types.Enum[] enums=(soupply.bedrock201.types.Enum[]).init, soupply.bedrock201.types.Command[] commands=(soupply.bedrock201.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandRequest : Bedrock201Packet
{
    ...
    this(string command, uint type=uint.init, soupply.bedrock201.types.McpeUuid uuid=soupply.bedrock201.types.McpeUuid.init, string requestId=string.init, int playerId=int.init, bool internal=bool.init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock201Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.bedrock201.types.BlockPosition position;
...
class PlaySound : Bedrock201Packet
{
    ...
    this(string name, soupply.bedrock201.types.BlockPosition position=soupply.bedrock201.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class PlayerSkin : Bedrock201Packet
{
    ...
    this(soupply.bedrock201.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
