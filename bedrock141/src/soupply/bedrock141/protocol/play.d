 ...
 */
module soupply.bedrock141.protocol.play;
...
import soupply.bedrock141.metadata : Metadata;
import soupply.bedrock141.packet : Bedrock141Packet;
...
class Login : Bedrock141Packet
{
    ...
    soupply.bedrock141.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.bedrock141.types.LoginBody body_=soupply.bedrock141.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class ResourcePacksInfo : Bedrock141Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.bigEndian) soupply.bedrock141.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.bigEndian) soupply.bedrock141.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock141.types.PackWithSize[] behaviourPacks=(soupply.bedrock141.types.PackWithSize[]).init, soupply.bedrock141.types.PackWithSize[] resourcePacks=(soupply.bedrock141.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock141Packet
{
    ...
    bool mustAccept;
    soupply.bedrock141.types.Pack[] behaviourPacks;
    soupply.bedrock141.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock141.types.Pack[] behaviourPacks=(soupply.bedrock141.types.Pack[]).init, soupply.bedrock141.types.Pack[] resourcePacks=(soupply.bedrock141.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class StartGame : Bedrock141Packet
{
    ...
    soupply.bedrock141.types.Rule[] gameRules;
...
class AddPlayer : Bedrock141Packet
{
    ...
    soupply.bedrock141.types.McpeUuid uuid;
    string username;
    @Var long entityId;
    @Var ulong runtimeId;
    Vector!(float, "xyz") position;
    ...
    float headYaw;
    float yaw;
    soupply.bedrock141.types.Slot heldItem;
    Metadata metadata;
    @Var uint unknown11;
    @Var uint unknown12;
    @Var uint unknown13;
    ...
    @Var uint unknown15;
    long unknown16;
    soupply.bedrock141.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock141.types.McpeUuid uuid, string username=string.init, long entityId=long.init, ulong runtimeId=ulong.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, float pitch=float.init, float headYaw=float.init, float yaw=float.init, soupply.bedrock141.types.Slot heldItem=soupply.bedrock141.types.Slot.init, Metadata metadata=Metadata.init, uint unknown11=uint.init, uint unknown12=uint.init, uint unknown13=uint.init, uint unknown14=uint.init, uint unknown15=uint.init, long unknown16=long.init, soupply.bedrock141.types.Link[] links=(soupply.bedrock141.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
...
class AddEntity : Bedrock141Packet
{
    ...
    float pitch;
    float yaw;
    soupply.bedrock141.types.Attribute[] attributes;
    Metadata metadata;
    soupply.bedrock141.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, uint type=uint.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.bedrock141.types.Attribute[] attributes=(soupply.bedrock141.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.bedrock141.types.Link[] links=(soupply.bedrock141.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class AddItemEntity : Bedrock141Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.bedrock141.types.Slot item;
    Vector!(float, "xyz") position;
    Vector!(float, "xyz") motion;
    Metadata metadata;
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock141.types.Slot item=soupply.bedrock141.types.Slot.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Bedrock141Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.bedrock141.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock141.types.BlockPosition position=soupply.bedrock141.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class UpdateBlock : Bedrock141Packet
{
    ...
    this(soupply.bedrock141.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Bedrock141Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock141.types.BlockPosition position=soupply.bedrock141.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Bedrock141Packet
{
    ...
    Vector!(float, "xyz") position;
    float radius;
    soupply.bedrock141.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Vector!(float, "xyz") position, float radius=float.init, soupply.bedrock141.types.BlockPosition[] destroyedBlocks=(soupply.bedrock141.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class BlockEvent : Bedrock141Packet
{
    ...
    this(soupply.bedrock141.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class UpdateAttributes : Bedrock141Packet
{
    ...
    this(long entityId, soupply.bedrock141.types.Attribute[] attributes=(soupply.bedrock141.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock141Packet
{
    ...
    @Var uint type;
    soupply.bedrock141.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.bedrock141.types.InventoryAction[] actions=(soupply.bedrock141.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class UseItem : Bedrock141Packet
    {
        ...
        @Var uint actionType;
        soupply.bedrock141.types.BlockPosition blockPosition;
        @Var int face;
        @Var int hotbarSlot;
        soupply.bedrock141.types.Slot item;
        ...
        this(uint actionType, soupply.bedrock141.types.BlockPosition blockPosition=soupply.bedrock141.types.BlockPosition.init, int face=int.init, int hotbarSlot=int.init, soupply.bedrock141.types.Slot item=soupply.bedrock141.types.Slot.init, Vector!(float, "xyz") playerPosition=Vector!(float, "xyz").init, Vector!(float, "xyz") clickPosition=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
    ...
    class UseItemOnEntity : Bedrock141Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.bedrock141.types.Slot item=soupply.bedrock141.types.Slot.init, Vector!(float, "xyz") unknown4=Vector!(float, "xyz").init, Vector!(float, "xyz") unknown5=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock141Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.bedrock141.types.Slot item=soupply.bedrock141.types.Slot.init, Vector!(float, "xyz") headPosition=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class MobEquipment : Bedrock141Packet
{
    ...
    this(long entityId, soupply.bedrock141.types.Slot item=soupply.bedrock141.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock141Packet
{
    ...
    @Var long entityId;
    soupply.bedrock141.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.bedrock141.types.Slot[4] armor=(soupply.bedrock141.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class PlayerAction : Bedrock141Packet
{
    ...
    this(long entityId, int action=int.init, soupply.bedrock141.types.BlockPosition position=soupply.bedrock141.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class SetSpawnPosition : Bedrock141Packet
{
    ...
    this(int type, soupply.bedrock141.types.BlockPosition position=soupply.bedrock141.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class ContainerOpen : Bedrock141Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.bedrock141.types.BlockPosition position=soupply.bedrock141.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class InventoryContent : Bedrock141Packet
{
    ...
    @Var uint window;
    soupply.bedrock141.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.bedrock141.types.Slot[] slots=(soupply.bedrock141.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class CraftingData : Bedrock141Packet
{
    ...
    soupply.bedrock141.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock141.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock141Packet
{
    ...
    @Var int type;
    soupply.bedrock141.types.McpeUuid uuid;
    soupply.bedrock141.types.Slot[] input;
    soupply.bedrock141.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.bedrock141.types.McpeUuid uuid=soupply.bedrock141.types.McpeUuid.init, soupply.bedrock141.types.Slot[] input=(soupply.bedrock141.types.Slot[]).init, soupply.bedrock141.types.Slot[] output=(soupply.bedrock141.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class BlockEntityData : Bedrock141Packet
{
    ...
    this(soupply.bedrock141.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class FullChunkData : Bedrock141Packet
{
    ...
    soupply.bedrock141.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Vector!(int, "xz") position, soupply.bedrock141.types.ChunkData data=soupply.bedrock141.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class PlayerList : Bedrock141Packet
{
    ...
    class Add : Bedrock141Packet
    {
        ...
        soupply.bedrock141.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock141.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock141Packet
    {
        ...
        soupply.bedrock141.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock141.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class ClientboundMapItemData : Bedrock141Packet
{
    ...
    @Condition("update==4") soupply.bedrock141.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Vector!(int, "xz") size=Vector!(int, "xz").init, Vector!(int, "xz") offset=Vector!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.bedrock141.types.Decoration[] decorations=(soupply.bedrock141.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class ItemFrameDropItem : Bedrock141Packet
{
    ...
    this(soupply.bedrock141.types.BlockPosition position, soupply.bedrock141.types.Slot item=soupply.bedrock141.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock141Packet
{
    ...
    soupply.bedrock141.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock141.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class AvailableCommands : Bedrock141Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.bedrock141.types.Enum[] enums;
    soupply.bedrock141.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.bedrock141.types.Enum[] enums=(soupply.bedrock141.types.Enum[]).init, soupply.bedrock141.types.Command[] commands=(soupply.bedrock141.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandRequest : Bedrock141Packet
{
    ...
    this(string command, uint type=uint.init, soupply.bedrock141.types.McpeUuid uuid=soupply.bedrock141.types.McpeUuid.init, string requestId=string.init, int playerId=int.init, bool internal=bool.init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock141Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.bedrock141.types.BlockPosition position;
    ...
    this(bool updateBlock, soupply.bedrock141.types.BlockPosition position=soupply.bedrock141.types.BlockPosition.init, uint mode=uint.init, bool redstoneMode=bool.init, bool conditional=bool.init, long minecart=long.init, string command=string.init, string lastOutput=string.init, string hover=string.init, bool trackOutput=bool.init) pure nothrow @safe @nogc
    {
...
class PlaySound : Bedrock141Packet
{
    ...
    this(string name, soupply.bedrock141.types.BlockPosition position=soupply.bedrock141.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class PlayerSkin : Bedrock141Packet
{
    ...
    this(soupply.bedrock141.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
