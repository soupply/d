...
class AddItemEntity : Bedrock141Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock141.types.Slot item=soupply.bedrock141.types.Slot.init, Tuple!(float, "xyz") position=Tuple!(float, "xyz").init, Tuple!(float, "xyz") motion=Tuple!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class Explode : Bedrock141Packet
{
    ...
    this(Tuple!(float, "xyz") position, float radius=float.init, soupply.bedrock141.types.BlockPosition[] destroyedBlocks=(soupply.bedrock141.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class InventoryTransaction : Bedrock141Packet
{
    ...
    class UseItemOnEntity : Bedrock141Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.bedrock141.types.Slot item=soupply.bedrock141.types.Slot.init, Tuple!(float, "xyz") unknown4=Tuple!(float, "xyz").init, Tuple!(float, "xyz") unknown5=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock141Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.bedrock141.types.Slot item=soupply.bedrock141.types.Slot.init, Tuple!(float, "xyz") headPosition=Tuple!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class FullChunkData : Bedrock141Packet
{
    ...
    this(Tuple!(int, "xz") position, soupply.bedrock141.types.ChunkData data=soupply.bedrock141.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class ClientboundMapItemData : Bedrock141Packet
{
    ...
    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "xz") size=Tuple!(int, "xz").init, Tuple!(int, "xz") offset=Tuple!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.bedrock141.types.Decoration[] decorations=(soupply.bedrock141.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
