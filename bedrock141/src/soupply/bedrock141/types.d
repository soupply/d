...
struct PlayerList
{
    ...
    @Var long entityId;
    string displayName;
    soupply.bedrock141.types.Skin skin;
    string unknown4;
...
struct InventoryAction
{
    ...
    @Var uint slot;
    soupply.bedrock141.types.Slot oldItem;
    soupply.bedrock141.types.Slot newItem;
...
struct ChunkData
{
    ...
    private struct Container
    {
        ...
        soupply.bedrock141.types.Section[] sections;
        ushort[256] heights;
        ubyte[256] biomes;
        ubyte[] borders;
        soupply.bedrock141.types.ExtraData[] extraData;
...
struct Command
{
    ...
    int aliasesEnum = -1;
    soupply.bedrock141.types.Overload[] overloads;
...
struct Overload
{
    ...
    soupply.bedrock141.types.Parameter[] parameters;
