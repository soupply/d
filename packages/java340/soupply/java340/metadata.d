...
class MetadataSlot : MetadataValue
{
    ...
    this(soupply.java340.types.Slot value) pure nothrow @safe @nogc
    {
        this();
        this.value = value;
    }
...
class MetadataOptionalPosition : MetadataValue
{
    ...
    this(soupply.java340.types.OptionalPosition value) pure nothrow @safe @nogc
    {
        this();
        this.value = value;
    }
...
class MetadataUuid : MetadataValue
{
    ...
    this(soupply.java340.types.OptionalUuid value) pure nothrow @safe @nogc
    {
        this();
        this.value = value;
    }
...
class Metadata
{
    ...
    @property soupply.java340.types.Slot potion()
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataSlot)*ptr) return (cast(MetadataSlot)*ptr).value;
        return (soupply.java340.types.Slot).init;
    }

    @property soupply.java340.types.Slot potion(soupply.java340.types.Slot value)
    {
        auto ptr = 6 in this.values;
    ...
    @property soupply.java340.types.OptionalPosition beamTarget()
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataOptionalPosition)*ptr) return (cast(MetadataOptionalPosition)*ptr).value;
        return (soupply.java340.types.OptionalPosition).init;
    }

    @property soupply.java340.types.OptionalPosition beamTarget(soupply.java340.types.OptionalPosition value)
    {
        auto ptr = 6 in this.values;
    ...
    @property soupply.java340.types.Slot firework()
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataSlot)*ptr) return (cast(MetadataSlot)*ptr).value;
        return (soupply.java340.types.Slot).init;
    ...
    @property soupply.java340.types.Slot firework(soupply.java340.types.Slot value)
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataSlot)*ptr) (cast(MetadataSlot)*ptr).value = value;
        else this.values[6] = new MetadataSlot(value);
    ...
    @property soupply.java340.types.Slot item()
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataSlot)*ptr) return (cast(MetadataSlot)*ptr).value;
        return (soupply.java340.types.Slot).init;
    ...
    @property soupply.java340.types.Slot item(soupply.java340.types.Slot value)
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataSlot)*ptr) (cast(MetadataSlot)*ptr).value = value;
        else this.values[6] = new MetadataSlot(value);
    ...
    @property soupply.java340.types.OptionalUuid ownerUuid()
    {
        auto ptr = 14 in this.values;
        if(ptr && cast(MetadataUuid)*ptr) return (cast(MetadataUuid)*ptr).value;
        return (soupply.java340.types.OptionalUuid).init;
    }

    @property soupply.java340.types.OptionalUuid ownerUuid(soupply.java340.types.OptionalUuid value)
    {
        auto ptr = 14 in this.values;
    ...
    @property soupply.java340.types.OptionalPosition shulkerAttachment()
    {
        auto ptr = 13 in this.values;
        if(ptr && cast(MetadataOptionalPosition)*ptr) return (cast(MetadataOptionalPosition)*ptr).value;
        return (soupply.java340.types.OptionalPosition).init;
    ...
    @property soupply.java340.types.OptionalPosition shulkerAttachment(soupply.java340.types.OptionalPosition value)
    {
        auto ptr = 13 in this.values;
        if(ptr && cast(MetadataOptionalPosition)*ptr) (cast(MetadataOptionalPosition)*ptr).value = value;
