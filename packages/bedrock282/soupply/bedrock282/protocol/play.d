 ...
 */
module soupply.bedrock282.protocol.play;
...
class Login : Bedrock282Packet
{
    ...
    @BigEndian uint protocol = 282;
    soupply.bedrock282.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.bedrock282.types.LoginBody body_=soupply.bedrock282.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class PlayStatus : Bedrock282Packet
{
...
class ServerToClientHandshake : Bedrock282Packet
{
...
class ClientToServerHandshake : Bedrock282Packet
{
...
class Disconnect : Bedrock282Packet
{
...
class ResourcePacksInfo : Bedrock282Packet
{
    ...
    bool mustAccept;
    @Length!ushort soupply.bedrock282.types.PackWithSize[] behaviourPacks;
    @Length!ushort soupply.bedrock282.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock282.types.PackWithSize[] behaviourPacks=(soupply.bedrock282.types.PackWithSize[]).init, soupply.bedrock282.types.PackWithSize[] resourcePacks=(soupply.bedrock282.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock282Packet
{
    ...
    bool mustAccept;
    soupply.bedrock282.types.Pack[] behaviourPacks;
    soupply.bedrock282.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock282.types.Pack[] behaviourPacks=(soupply.bedrock282.types.Pack[]).init, soupply.bedrock282.types.Pack[] resourcePacks=(soupply.bedrock282.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class ResourcePackClientResponse : Bedrock282Packet
{
...
class Text : Bedrock282Packet
{
    ...
    class Translation : Bedrock282Packet
    {
    ...
    class JukeboxPopup : Bedrock282Packet
    {
    ...
    class Whisper : Bedrock282Packet
    {
    ...
    class Announcement : Bedrock282Packet
    {
...
class SetTime : Bedrock282Packet
{
...
class StartGame : Bedrock282Packet
{
    ...
    soupply.bedrock282.types.Rule[] gameRules;
...
class AddPlayer : Bedrock282Packet
{
    ...
    enum string[] __fields = ["uuid", "username", "entityId", "runtimeId", "position", "motion", "pitch", "headYaw", "yaw", "heldItem", "metadata", "unknown11", "unknown12", "unknown13", "unknown14", "unknown15", "unknown16", "links", "deviceId"];

    soupply.bedrock282.types.McpeUuid uuid;
    string username;
    @Var long entityId;
    @Var ulong runtimeId;
    Vector!(float, "xyz") position;
    ...
    float headYaw;
    float yaw;
    soupply.bedrock282.types.Slot heldItem;
    Metadata metadata;
    @Var uint unknown11;
    @Var uint unknown12;
    @Var uint unknown13;
...
class AddEntity : Bedrock282Packet
{
    ...
    enum string[] __fields = ["entityId", "runtimeId", "type", "position", "motion", "pitch", "yaw", "headYaw", "attributes", "metadata", "links"];
    ...
    override string toString()
    {
        return "AddEntity(entityId: " ~ std.conv.to!string(this.entityId) ~ ", runtimeId: " ~ std.conv.to!string(this.runtimeId) ~ ", type: " ~ std.conv.to!string(this.type) ~ ", position: " ~ std.conv.to!string(this.position) ~ ", motion: " ~ std.conv.to!string(this.motion) ~ ", pitch: " ~ std.conv.to!string(this.pitch) ~ ", yaw: " ~ std.conv.to!string(this.yaw) ~ ", headYaw: " ~ std.conv.to!string(this.headYaw) ~ ", attributes: " ~ std.conv.to!string(this.attributes) ~ ", metadata: " ~ std.conv.to!string(this.metadata) ~ ", links: " ~ std.conv.to!string(this.links) ~ ")";
    }

}

class RemoveEntity : Bedrock282Packet
{
...
class AddItemEntity : Bedrock282Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.bedrock282.types.Slot item;
    Vector!(float, "xyz") position;
    Vector!(float, "xyz") motion;
    Metadata metadata;
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock282.types.Slot item=soupply.bedrock282.types.Slot.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Bedrock282Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.bedrock282.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock282.types.BlockPosition position=soupply.bedrock282.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class TakeItemEntity : Bedrock282Packet
{
...
class MoveEntityAbsolute : Bedrock282Packet
{
    ...
    enum string[] __fields = ["entityId", "flags", "position", "rotation"];

    @Var long entityId;
    ubyte flags;
    Vector!(float, "xyz") position;
    Vector!(byte, "xyz") rotation;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ubyte flags=ubyte.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(byte, "xyz") rotation=Vector!(byte, "xyz").init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.flags = flags;
        this.position = position;
    ...
    public static typeof(this) fromBuffer(ubyte[] buffer)
    {
        MoveEntityAbsolute ret = new MoveEntityAbsolute();
        ret.decode(buffer);
        return ret;
    }
    ...
    override string toString()
    {
        return "MoveEntityAbsolute(entityId: " ~ std.conv.to!string(this.entityId) ~ ", flags: " ~ std.conv.to!string(this.flags) ~ ", position: " ~ std.conv.to!string(this.position) ~ ", rotation: " ~ std.conv.to!string(this.rotation) ~ ")";
    }

}

class MovePlayer : Bedrock282Packet
{
...
class RiderJump : Bedrock282Packet
{
...
class UpdateBlock : Bedrock282Packet
{
    ...
    this(soupply.bedrock282.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init, uint dataLayerId=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Bedrock282Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock282.types.BlockPosition position=soupply.bedrock282.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Bedrock282Packet
{
    ...
    Vector!(float, "xyz") position;
    float radius;
    soupply.bedrock282.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Vector!(float, "xyz") position, float radius=float.init, soupply.bedrock282.types.BlockPosition[] destroyedBlocks=(soupply.bedrock282.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class LevelSoundEvent : Bedrock282Packet
{
...
class LevelEvent : Bedrock282Packet
{
...
class BlockEvent : Bedrock282Packet
{
    ...
    this(soupply.bedrock282.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class EntityEvent : Bedrock282Packet
{
    ...
    enum ubyte ZOMBIE_VILLAGER_CURE = 16;
    enum ubyte RESPAWN = 18;
    enum ubyte IRON_GOLEM_OFFER_FLOWER = 19;
    enum ubyte IRON_GOLEM_WITHDRAW_FLOWER = 20;
    enum ubyte LOVE_PARTICLES = 21;
    enum ubyte WITCH_SPELL_ANIMATION = 24;
    enum ubyte FIREWORK_PARTICLES = 25;
    enum ubyte SILVERFISH_SPAWN_ANIMATION = 27;
    enum ubyte WITCH_DRINK_POTION = 29;
    enum ubyte WITCH_THROWN_POTION = 30;
    enum ubyte MINECART_TNT_PRIME_FUSE = 31;
    enum ubyte PLAYER_ADD_XP_LEVELS = 34;
    enum ubyte ELDER_GUARDIAN_CURSE = 35;
    enum ubyte AGENT_ARM_SWING = 36;
    enum ubyte ENDER_DRAGON_DEATH = 37;
    enum ubyte DUST_PARTICLES = 38;
    enum ubyte EATING_ITEM = 57;
    enum ubyte BABY_ANIMAL_FEED = 60;
    enum ubyte DEATH_SMOKE_CLOUD = 61;
    enum ubyte COMPLETE_TRADE = 62;
    enum ubyte REMOVE_LEASH = 63;
    enum ubyte CONSUME_TOTEM = 65;
    enum ubyte ENTITY_SPAWN = 67;
    enum ubyte DRAGON_PUKE = 68;
    enum ubyte ITEM_ENTITY_MERGE = 69;
...
class MobEffect : Bedrock282Packet
{
...
class UpdateAttributes : Bedrock282Packet
{
    ...
    this(long entityId, soupply.bedrock282.types.Attribute[] attributes=(soupply.bedrock282.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock282Packet
{
    ...
    @Var uint type;
    soupply.bedrock282.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.bedrock282.types.InventoryAction[] actions=(soupply.bedrock282.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class Normal0 : Bedrock282Packet
    {
    ...
    class Normal1 : Bedrock282Packet
    {
    ...
    class UseItem : Bedrock282Packet
    {
        ...
        @Var uint actionType;
        soupply.bedrock282.types.BlockPosition blockPosition;
        @Var int face;
        @Var int hotbarSlot;
        soupply.bedrock282.types.Slot item;
    ...
    class UseItemOnEntity : Bedrock282Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.bedrock282.types.Slot item=soupply.bedrock282.types.Slot.init, Vector!(float, "xyz") unknown4=Vector!(float, "xyz").init, Vector!(float, "xyz") unknown5=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock282Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.bedrock282.types.Slot item=soupply.bedrock282.types.Slot.init, Vector!(float, "xyz") headPosition=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class MobEquipment : Bedrock282Packet
{
    ...
    this(long entityId, soupply.bedrock282.types.Slot item=soupply.bedrock282.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock282Packet
{
    ...
    @Var long entityId;
    soupply.bedrock282.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.bedrock282.types.Slot[4] armor=(soupply.bedrock282.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class Interact : Bedrock282Packet
{
...
class BlockPickRequest : Bedrock282Packet
{
...
class EntityPickRequest : Bedrock282Packet
{
...
class PlayerAction : Bedrock282Packet
{
    ...
    enum int SET_ENCHANTMENT_SEED = 20;
    enum int START_SWIMMING = 21;
    enum int STOP_SWIMMING = 22;
    enum int START_SPIN_ATTACK = 23;
    enum int STOP_SPIN_ATTACK = 24;
    ...
    this(long entityId, int action=int.init, soupply.bedrock282.types.BlockPosition position=soupply.bedrock282.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class EntityFall : Bedrock282Packet
{
...
class HurtArmor : Bedrock282Packet
{
...
class SetEntityData : Bedrock282Packet
{
...
class SetEntityMotion : Bedrock282Packet
{
...
class SetEntityLink : Bedrock282Packet
{
...
class SetHealth : Bedrock282Packet
{
...
class SetSpawnPosition : Bedrock282Packet
{
    ...
    this(int type, soupply.bedrock282.types.BlockPosition position=soupply.bedrock282.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class Animate : Bedrock282Packet
{
...
class Respawn : Bedrock282Packet
{
...
class ContainerOpen : Bedrock282Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.bedrock282.types.BlockPosition position=soupply.bedrock282.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class ContainerClose : Bedrock282Packet
{
...
class PlayerHotbar : Bedrock282Packet
{
...
class InventoryContent : Bedrock282Packet
{
    ...
    @Var uint window;
    soupply.bedrock282.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.bedrock282.types.Slot[] slots=(soupply.bedrock282.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class InventorySlot : Bedrock282Packet
{
...
class ContainerSetData : Bedrock282Packet
{
...
class CraftingData : Bedrock282Packet
{
    ...
    soupply.bedrock282.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock282.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock282Packet
{
    ...
    @Var int type;
    soupply.bedrock282.types.McpeUuid uuid;
    soupply.bedrock282.types.Slot[] input;
    soupply.bedrock282.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.bedrock282.types.McpeUuid uuid=soupply.bedrock282.types.McpeUuid.init, soupply.bedrock282.types.Slot[] input=(soupply.bedrock282.types.Slot[]).init, soupply.bedrock282.types.Slot[] output=(soupply.bedrock282.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class GuiDataPickItem : Bedrock282Packet
{
...
class AdventureSettings : Bedrock282Packet
{
...
class BlockEntityData : Bedrock282Packet
{
    ...
    this(soupply.bedrock282.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerInput : Bedrock282Packet
{
...
class FullChunkData : Bedrock282Packet
{
    ...
    soupply.bedrock282.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Vector!(int, "xz") position, soupply.bedrock282.types.ChunkData data=soupply.bedrock282.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class SetCommandsEnabled : Bedrock282Packet
{
...
class SetDifficulty : Bedrock282Packet
{
...
class ChangeDimension : Bedrock282Packet
{
...
class SetPlayerGameType : Bedrock282Packet
{
...
class PlayerList : Bedrock282Packet
{
    ...
    class Add : Bedrock282Packet
    {
        ...
        soupply.bedrock282.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock282.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock282Packet
    {
        ...
        soupply.bedrock282.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock282.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class SimpleEvent : Bedrock282Packet
{
...
class Event : Bedrock282Packet
{
    ...
    override string toString()
    {
        return "Event(entityId: " ~ std.conv.to!string(this.entityId) ~ ", eventId: " ~ std.conv.to!string(this.eventId) ~ ")";
    }

}

class SpawnExperienceOrb : Bedrock282Packet
{
...
class ClientboundMapItemData : Bedrock282Packet
{
    ...
    @Condition("update==4") soupply.bedrock282.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Vector!(int, "xz") size=Vector!(int, "xz").init, Vector!(int, "xz") offset=Vector!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.bedrock282.types.Decoration[] decorations=(soupply.bedrock282.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class MapInfoRequest : Bedrock282Packet
{
...
class RequestChunkRadius : Bedrock282Packet
{
...
class ChunkRadiusUpdated : Bedrock282Packet
{
...
class ItemFrameDropItem : Bedrock282Packet
{
    ...
    this(soupply.bedrock282.types.BlockPosition position, soupply.bedrock282.types.Slot item=soupply.bedrock282.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock282Packet
{
    ...
    soupply.bedrock282.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock282.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class BossEvent : Bedrock282Packet
{
...
class ShowCredits : Bedrock282Packet
{
...
class AvailableCommands : Bedrock282Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.bedrock282.types.Enum[] enums;
    soupply.bedrock282.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.bedrock282.types.Enum[] enums=(soupply.bedrock282.types.Enum[]).init, soupply.bedrock282.types.Command[] commands=(soupply.bedrock282.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandRequest : Bedrock282Packet
{
    ...
    enum string[] __fields = ["command", "type", "uuid", "requestId", "playerId", "internal"];
    ...
    this(string command, uint type=uint.init, soupply.bedrock282.types.McpeUuid uuid=soupply.bedrock282.types.McpeUuid.init, string requestId=string.init, int playerId=int.init, bool internal=bool.init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock282Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.bedrock282.types.BlockPosition position;
...
class CommandOutput : Bedrock282Packet
{
    ...
    enum string[] __fields = ["originData", "outputType", "successCount", "messages", "unknown4"];

    soupply.bedrock282.types.CommandOriginData originData;
    ubyte outputType;
    @Var uint successCount;
    soupply.bedrock282.types.CommandMessage[] messages;
    @Condition("outputType==4") string unknown4;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock282.types.CommandOriginData originData, ubyte outputType=ubyte.init, uint successCount=uint.init, soupply.bedrock282.types.CommandMessage[] messages=(soupply.bedrock282.types.CommandMessage[]).init, string unknown4=string.init) pure nothrow @safe @nogc
    {
    ...
    override string toString()
    {
        return "CommandOutput(originData: " ~ std.conv.to!string(this.originData) ~ ", outputType: " ~ std.conv.to!string(this.outputType) ~ ", successCount: " ~ std.conv.to!string(this.successCount) ~ ", messages: " ~ std.conv.to!string(this.messages) ~ ", unknown4: " ~ std.conv.to!string(this.unknown4) ~ ")";
    }

}

class UpdateTrade : Bedrock282Packet
{
...
class UpdateEquip : Bedrock282Packet
{
...
class ResourcePackDataInfo : Bedrock282Packet
{
...
class ResourcePackChunkData : Bedrock282Packet
{
...
class ResourcePackChunkRequest : Bedrock282Packet
{
...
class Transfer : Bedrock282Packet
{
...
class PlaySound : Bedrock282Packet
{
    ...
    this(string name, soupply.bedrock282.types.BlockPosition position=soupply.bedrock282.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class StopSound : Bedrock282Packet
{
...
class SetTitle : Bedrock282Packet
{
...
class AddBehaviorTree : Bedrock282Packet
{
...
class StructureBlockUpdate : Bedrock282Packet
{
...
class ShowStoreOffer : Bedrock282Packet
{
...
class PurchaseReceipt : Bedrock282Packet
{
...
class PlayerSkin : Bedrock282Packet
{
    ...
    this(soupply.bedrock282.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
...
class SubClientLogin : Bedrock282Packet
{
...
class WSConnect : Bedrock282Packet
{
    ...
    override string toString()
    {
        return "WSConnect(unknown0: " ~ std.conv.to!string(this.unknown0) ~ ")";
    }

}

class SetLastHurtBy : Bedrock282Packet
{
...
class BookEdit : Bedrock282Packet
{
    ...
    class ReplacePage : Bedrock282Packet
    {
    ...
    class AddPage : Bedrock282Packet
    {
    ...
    class DeletePage : Bedrock282Packet
    {
    ...
    class SwapPages : Bedrock282Packet
    {
...
class NpcRequest : Bedrock282Packet
{
...
class PhotoTransfer : Bedrock282Packet
{
...
class ModalFormRequest : Bedrock282Packet
{
...
class ModalFormResponse : Bedrock282Packet
{
...
class ServerSettingsRequest : Bedrock282Packet
{
...
class ServerSettingsResponse : Bedrock282Packet
{
...
class ShowProfile : Bedrock282Packet
{
...
class SetDefaultGameType : Bedrock282Packet
{
...
class RemoveObject : Bedrock282Packet
{
    ...
    enum string[] __fields = ["objectName"];

    string objectName;

    this() pure nothrow @safe @nogc {}

    this(string objectName) pure nothrow @safe @nogc
    {
    ...
    override string toString()
    {
        return "RemoveObject(objectName: " ~ std.conv.to!string(this.objectName) ~ ")";
    }

}

class SetDisplayObjective : Bedrock282Packet
{
    ...
    enum string[] __fields = ["displaySlot", "objectiveName", "displayName", "criteriaName", "sortOrder"];
    ...
    this(string displaySlot, string objectiveName=string.init, string displayName=string.init, string criteriaName=string.init, int sortOrder=int.init) pure nothrow @safe @nogc
    {
    ...
    public static typeof(this) fromBuffer(ubyte[] buffer)
    {
        SetDisplayObjective ret = new SetDisplayObjective();
        ret.decode(buffer);
        return ret;
    }
    ...
    override string toString()
    {
        return "SetDisplayObjective(displaySlot: " ~ std.conv.to!string(this.displaySlot) ~ ", objectiveName: " ~ std.conv.to!string(this.objectiveName) ~ ", displayName: " ~ std.conv.to!string(this.displayName) ~ ", criteriaName: " ~ std.conv.to!string(this.criteriaName) ~ ", sortOrder: " ~ std.conv.to!string(this.sortOrder) ~ ")";
    }

}

class SetScore : Bedrock282Packet
{
    ...
    enum string[] __fields = ["type", "scores"];

    ubyte type;
    soupply.bedrock282.types.Score[] scores;

    this() pure nothrow @safe @nogc {}

    this(ubyte type, soupply.bedrock282.types.Score[] scores=(soupply.bedrock282.types.Score[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.scores = scores;
    }
    ...
    override string toString()
    {
        return "SetScore(type: " ~ std.conv.to!string(this.type) ~ ", scores: " ~ std.conv.to!string(this.scores) ~ ")";
    }

}

class LabTable : Bedrock282Packet
{
    ...
    enum string[] __fields = ["unknown0", "position", "reactionType"];
    ...
    this(ubyte unknown0, soupply.bedrock282.types.BlockPosition position=soupply.bedrock282.types.BlockPosition.init, ubyte reactionType=ubyte.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
    ...
    override string toString()
    {
        return "LabTable(unknown0: " ~ std.conv.to!string(this.unknown0) ~ ", position: " ~ std.conv.to!string(this.position) ~ ", reactionType: " ~ std.conv.to!string(this.reactionType) ~ ")";
    }

}

class UpdateBlockSynced : Bedrock282Packet
{
    ...
    enum string[] __fields = ["position", "block", "flagsAndMeta", "entityId", "unknown4"];
    ...
    this(soupply.bedrock282.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init, long entityId=long.init, ulong unknown4=ulong.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
        this.flagsAndMeta = flagsAndMeta;
    ...
    public static typeof(this) fromBuffer(ubyte[] buffer)
    {
        UpdateBlockSynced ret = new UpdateBlockSynced();
        ret.decode(buffer);
        return ret;
    }
    ...
    override string toString()
    {
        return "UpdateBlockSynced(position: " ~ std.conv.to!string(this.position) ~ ", block: " ~ std.conv.to!string(this.block) ~ ", flagsAndMeta: " ~ std.conv.to!string(this.flagsAndMeta) ~ ", entityId: " ~ std.conv.to!string(this.entityId) ~ ", unknown4: " ~ std.conv.to!string(this.unknown4) ~ ")";
    }

}

class MoveEntityDelta : Bedrock282Packet
{
    ...
    // flags
    enum ubyte HAS_DIFF_X = 1;
    enum ubyte HAS_DIFF_Y = 2;
    enum ubyte HAS_DIFF_Z = 4;
    enum ubyte HAS_ROT_X = 8;
    enum ubyte HAS_ROT_Y = 16;
    enum ubyte HAS_ROT_Z = 32;

    enum string[] __fields = ["flags", "xDiff", "yDiff", "zDiff", "xRot", "yRot", "zRot"];

    ubyte flags;
    @Condition("(flags&1)!=0") @Var int xDiff;
    @Condition("(flags&2)!=0") @Var int yDiff;
    @Condition("(flags&4)!=0") @Var int zDiff;
    @Condition("(flags&8)!=0") byte xRot;
    @Condition("(flags&16)!=0") byte yRot;
    @Condition("(flags&32)!=0") byte zRot;

    this() pure nothrow @safe @nogc {}

    this(ubyte flags, int xDiff=int.init, int yDiff=int.init, int zDiff=int.init, byte xRot=byte.init, byte yRot=byte.init, byte zRot=byte.init) pure nothrow @safe @nogc
    {
        this.flags = flags;
        this.xDiff = xDiff;
        this.yDiff = yDiff;
    ...
    public static typeof(this) fromBuffer(ubyte[] buffer)
    {
        MoveEntityDelta ret = new MoveEntityDelta();
        ret.decode(buffer);
        return ret;
    }
    ...
    override string toString()
    {
        return "MoveEntityDelta(flags: " ~ std.conv.to!string(this.flags) ~ ", xDiff: " ~ std.conv.to!string(this.xDiff) ~ ", yDiff: " ~ std.conv.to!string(this.yDiff) ~ ", zDiff: " ~ std.conv.to!string(this.zDiff) ~ ", xRot: " ~ std.conv.to!string(this.xRot) ~ ", yRot: " ~ std.conv.to!string(this.yRot) ~ ", zRot: " ~ std.conv.to!string(this.zRot) ~ ")";
    }

}

class SetScoreboardIdentity : Bedrock282Packet
{
    ...
    // type
    enum ubyte REGISTER = 0;
    enum ubyte CLEAR = 1;

    enum string[] __fields = ["type", "registerEntries", "clearEntries"];

    ubyte type;
    @Condition("type==0") soupply.bedrock282.types.RegisterEntry[] registerEntries;
    @Condition("type==1") @Var long[] clearEntries;

    this() pure nothrow @safe @nogc {}

    this(ubyte type, soupply.bedrock282.types.RegisterEntry[] registerEntries=(soupply.bedrock282.types.RegisterEntry[]).init, long[] clearEntries=(long[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    public static typeof(this) fromBuffer(ubyte[] buffer)
    {
        SetScoreboardIdentity ret = new SetScoreboardIdentity();
        ret.decode(buffer);
        return ret;
    }
    ...
    override string toString()
    {
        return "SetScoreboardIdentity(type: " ~ std.conv.to!string(this.type) ~ ", registerEntries: " ~ std.conv.to!string(this.registerEntries) ~ ", clearEntries: " ~ std.conv.to!string(this.clearEntries) ~ ")";
    }

}

class SetLocalPlayerAsInitialized : Bedrock282Packet
{
    ...
    enum string[] __fields = ["entityRuntimeId"];

    @Var ulong entityRuntimeId;

    this() pure nothrow @safe @nogc {}

    this(ulong entityRuntimeId) pure nothrow @safe @nogc
    {
    ...
    public static typeof(this) fromBuffer(ubyte[] buffer)
    {
        SetLocalPlayerAsInitialized ret = new SetLocalPlayerAsInitialized();
        ret.decode(buffer);
        return ret;
    }
    ...
    override string toString()
    {
        return "SetLocalPlayerAsInitialized(entityRuntimeId: " ~ std.conv.to!string(this.entityRuntimeId) ~ ")";
    }

}

class UpdateSoftEnum : Bedrock282Packet
{
    ...
    enum string[] __fields = ["name", "values", "type"];
    ...
    this(string name, string[] values=(string[]).init, ubyte type=ubyte.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.values = values;
        this.type = type;
    ...
    public static typeof(this) fromBuffer(ubyte[] buffer)
    {
        UpdateSoftEnum ret = new UpdateSoftEnum();
        ret.decode(buffer);
        return ret;
    }
    ...
    override string toString()
    {
        return "UpdateSoftEnum(name: " ~ std.conv.to!string(this.name) ~ ", values: " ~ std.conv.to!string(this.values) ~ ", type: " ~ std.conv.to!string(this.type) ~ ")";
    }

}

class NetworkStackLatency : Bedrock282Packet
{
    ...
    enum string[] __fields = ["timestamp"];

    long timestamp;

    this() pure nothrow @safe @nogc {}

    this(long timestamp) pure nothrow @safe @nogc
    {
    ...
    public static typeof(this) fromBuffer(ubyte[] buffer)
    {
        NetworkStackLatency ret = new NetworkStackLatency();
        ret.decode(buffer);
        return ret;
    }
    ...
    override string toString()
    {
        return "NetworkStackLatency(timestamp: " ~ std.conv.to!string(this.timestamp) ~ ")";
    }
