 ...
 */
module soupply.bedrock282.types;
...
import soupply.util;
import soupply.bedrock282.metadata;
...
struct Varulong
{
    ...
    string toString()
    {
        return "Varulong(name: " ~ std.conv.to!string(this.name) ~ ", data: " ~ std.conv.to!string(this.data) ~ ")";
    }
...
struct InventoryAction
{
    ...
    @Var uint slot;
    soupply.bedrock282.types.Slot oldItem;
    soupply.bedrock282.types.Slot newItem;
...
struct ChunkData
{
    ...
    private struct Container
    {
        ...
        soupply.bedrock282.types.Section[] sections;
        ushort[256] heights;
        ubyte[256] biomes;
        ubyte[] borders;
        soupply.bedrock282.types.ExtraData[] extraData;
...
struct PlayerList
{
    ...
    @Var long entityId;
    string displayName;
    soupply.bedrock282.types.Skin skin;
    string unknown4;
...
struct Overload
{
    ...
    soupply.bedrock282.types.Parameter[] parameters;
...
struct Command
{
    ...
    int aliasesEnum = -1;
    soupply.bedrock282.types.Overload[] overloads;
...
struct RegisterEntry
{
    ...
    enum string[] __fields = ["scoreboardId", "uuid"];

    @Var long scoreboardId;
    UUID uuid;
    ...
    string toString()
    {
        return "RegisterEntry(scoreboardId: " ~ std.conv.to!string(this.scoreboardId) ~ ", uuid: " ~ std.conv.to!string(this.uuid) ~ ")";
    }
