...
class MultiBlockChange : Java335Packet
{
    ...
    this(Vector!(int, "xz") chunk, soupply.java335.types.BlockChange[] changes=(soupply.java335.types.BlockChange[]).init) pure nothrow @safe @nogc
    {
        this.chunk = chunk;
...
class Map : Java335Packet
{
    ...
    this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, soupply.java335.types.Icon[] icons=(soupply.java335.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Vector!(ubyte, "xz") offset=Vector!(ubyte, "xz").init, ubyte[] data=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.scale = scale;
