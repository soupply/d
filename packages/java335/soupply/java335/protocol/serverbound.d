 ...
 */
module soupply.java335.protocol.serverbound;
...
class CraftingGrid : Java335Packet
{
    ...
    ubyte window;
    ushort action;
    @Length!ushort soupply.java335.types.Entry[] returnEntry;
    @Length!ushort soupply.java335.types.Entry[] prepareEntry;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort action=ushort.init, soupply.java335.types.Entry[] returnEntry=(soupply.java335.types.Entry[]).init, soupply.java335.types.Entry[] prepareEntry=(soupply.java335.types.Entry[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.action = action;
...
class ClickWindow : Java335Packet
{
    ...
    ushort action;
    @Var uint mode;
    soupply.java335.types.Slot clickedItem;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, soupply.java335.types.Slot clickedItem=soupply.java335.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.button = button;
...
class CreativeInventoryAction : Java335Packet
{
    ...
    this(ushort slot, soupply.java335.types.Slot clickedItem=soupply.java335.types.Slot.init) pure nothrow @safe @nogc
    {
        this.slot = slot;
        this.clickedItem = clickedItem;
    }
