 ...
 */
module soupply.bedrock261.protocol.play;
...
import soupply.bedrock261.metadata : Metadata;
import soupply.bedrock261.packet : Bedrock261Packet;
...
class Login : Bedrock261Packet
{
    ...
    @BigEndian uint protocol = 261;
    soupply.bedrock261.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.bedrock261.types.LoginBody body_=soupply.bedrock261.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class PlayStatus : Bedrock261Packet
{
...
class ServerToClientHandshake : Bedrock261Packet
{
...
class ClientToServerHandshake : Bedrock261Packet
{
...
class Disconnect : Bedrock261Packet
{
...
class ResourcePacksInfo : Bedrock261Packet
{
    ...
    bool mustAccept;
    @Length!ushort soupply.bedrock261.types.PackWithSize[] behaviourPacks;
    @Length!ushort soupply.bedrock261.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock261.types.PackWithSize[] behaviourPacks=(soupply.bedrock261.types.PackWithSize[]).init, soupply.bedrock261.types.PackWithSize[] resourcePacks=(soupply.bedrock261.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock261Packet
{
    ...
    bool mustAccept;
    soupply.bedrock261.types.Pack[] behaviourPacks;
    soupply.bedrock261.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock261.types.Pack[] behaviourPacks=(soupply.bedrock261.types.Pack[]).init, soupply.bedrock261.types.Pack[] resourcePacks=(soupply.bedrock261.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class ResourcePackClientResponse : Bedrock261Packet
{
...
class Text : Bedrock261Packet
{
    ...
    class Translation : Bedrock261Packet
    {
    ...
    class JukeboxPopup : Bedrock261Packet
    {
    ...
    class Whisper : Bedrock261Packet
    {
    ...
    class Announcement : Bedrock261Packet
    {
...
class SetTime : Bedrock261Packet
{
...
class StartGame : Bedrock261Packet
{
...
class AddPlayer : Bedrock261Packet
{
    ...
    float headYaw;
    float yaw;
    soupply.bedrock261.types.Slot heldItem;
    Metadata metadata;
    @Var uint unknown11;
    @Var uint unknown12;
    @Var uint unknown13;
...
class AddEntity : Bedrock261Packet
{
    ...
    float pitch;
    float yaw;
    soupply.bedrock261.types.Attribute[] attributes;
    Metadata metadata;
    soupply.bedrock261.types.Link[] links;
...
class RemoveEntity : Bedrock261Packet
{
...
class AddItemEntity : Bedrock261Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.bedrock261.types.Slot item;
    Vector!(float, "xyz") position;
    Vector!(float, "xyz") motion;
    Metadata metadata;
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock261.types.Slot item=soupply.bedrock261.types.Slot.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Bedrock261Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock261.types.BlockPosition position=soupply.bedrock261.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class TakeItemEntity : Bedrock261Packet
{
...
class MoveEntity : Bedrock261Packet
{
...
class MovePlayer : Bedrock261Packet
{
...
class RiderJump : Bedrock261Packet
{
...
class UpdateBlock : Bedrock261Packet
{
...
class AddPainting : Bedrock261Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock261.types.BlockPosition position=soupply.bedrock261.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Bedrock261Packet
{
    ...
    Vector!(float, "xyz") position;
    float radius;
    soupply.bedrock261.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Vector!(float, "xyz") position, float radius=float.init, soupply.bedrock261.types.BlockPosition[] destroyedBlocks=(soupply.bedrock261.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class LevelSoundEvent : Bedrock261Packet
{
...
class LevelEvent : Bedrock261Packet
{
...
class BlockEvent : Bedrock261Packet
{
    ...
    this(soupply.bedrock261.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class EntityEvent : Bedrock261Packet
{
...
class MobEffect : Bedrock261Packet
{
...
class UpdateAttributes : Bedrock261Packet
{
    ...
    this(long entityId, soupply.bedrock261.types.Attribute[] attributes=(soupply.bedrock261.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock261Packet
{
    ...
    @Var uint type;
    soupply.bedrock261.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.bedrock261.types.InventoryAction[] actions=(soupply.bedrock261.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class Normal0 : Bedrock261Packet
    {
    ...
    class Normal1 : Bedrock261Packet
    {
    ...
    class UseItem : Bedrock261Packet
    {
        ...
        @Var uint actionType;
        soupply.bedrock261.types.BlockPosition blockPosition;
        @Var int face;
        @Var int hotbarSlot;
        soupply.bedrock261.types.Slot item;
    ...
    class UseItemOnEntity : Bedrock261Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.bedrock261.types.Slot item=soupply.bedrock261.types.Slot.init, Vector!(float, "xyz") unknown4=Vector!(float, "xyz").init, Vector!(float, "xyz") unknown5=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock261Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.bedrock261.types.Slot item=soupply.bedrock261.types.Slot.init, Vector!(float, "xyz") headPosition=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class MobEquipment : Bedrock261Packet
{
    ...
    this(long entityId, soupply.bedrock261.types.Slot item=soupply.bedrock261.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock261Packet
{
    ...
    @Var long entityId;
    soupply.bedrock261.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.bedrock261.types.Slot[4] armor=(soupply.bedrock261.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class Interact : Bedrock261Packet
{
...
class BlockPickRequest : Bedrock261Packet
{
...
class EntityPickRequest : Bedrock261Packet
{
...
class PlayerAction : Bedrock261Packet
{
    ...
    this(long entityId, int action=int.init, soupply.bedrock261.types.BlockPosition position=soupply.bedrock261.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class EntityFall : Bedrock261Packet
{
...
class HurtArmor : Bedrock261Packet
{
...
class SetEntityData : Bedrock261Packet
{
...
class SetEntityMotion : Bedrock261Packet
{
...
class SetEntityLink : Bedrock261Packet
{
...
class SetHealth : Bedrock261Packet
{
...
class SetSpawnPosition : Bedrock261Packet
{
    ...
    this(int type, soupply.bedrock261.types.BlockPosition position=soupply.bedrock261.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class Animate : Bedrock261Packet
{
...
class Respawn : Bedrock261Packet
{
...
class ContainerOpen : Bedrock261Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.bedrock261.types.BlockPosition position=soupply.bedrock261.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class ContainerClose : Bedrock261Packet
{
...
class PlayerHotbar : Bedrock261Packet
{
...
class InventoryContent : Bedrock261Packet
{
    ...
    @Var uint window;
    soupply.bedrock261.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.bedrock261.types.Slot[] slots=(soupply.bedrock261.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class InventorySlot : Bedrock261Packet
{
...
class ContainerSetData : Bedrock261Packet
{
...
class CraftingData : Bedrock261Packet
{
    ...
    soupply.bedrock261.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock261.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock261Packet
{
    ...
    @Var int type;
    soupply.bedrock261.types.McpeUuid uuid;
    soupply.bedrock261.types.Slot[] input;
    soupply.bedrock261.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.bedrock261.types.McpeUuid uuid=soupply.bedrock261.types.McpeUuid.init, soupply.bedrock261.types.Slot[] input=(soupply.bedrock261.types.Slot[]).init, soupply.bedrock261.types.Slot[] output=(soupply.bedrock261.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class GuiDataPickItem : Bedrock261Packet
{
...
class AdventureSettings : Bedrock261Packet
{
...
class BlockEntityData : Bedrock261Packet
{
    ...
    this(soupply.bedrock261.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerInput : Bedrock261Packet
{
...
class FullChunkData : Bedrock261Packet
{
    ...
    soupply.bedrock261.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Vector!(int, "xz") position, soupply.bedrock261.types.ChunkData data=soupply.bedrock261.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class SetCommandsEnabled : Bedrock261Packet
{
...
class SetDifficulty : Bedrock261Packet
{
...
class ChangeDimension : Bedrock261Packet
{
...
class SetPlayerGameType : Bedrock261Packet
{
...
class PlayerList : Bedrock261Packet
{
    ...
    class Add : Bedrock261Packet
    {
        ...
        soupply.bedrock261.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock261.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock261Packet
    {
        ...
        soupply.bedrock261.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock261.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class SimpleEvent : Bedrock261Packet
{
...
class SpawnExperienceOrb : Bedrock261Packet
{
...
class ClientboundMapItemData : Bedrock261Packet
{
    ...
    @Condition("update==4") soupply.bedrock261.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Vector!(int, "xz") size=Vector!(int, "xz").init, Vector!(int, "xz") offset=Vector!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.bedrock261.types.Decoration[] decorations=(soupply.bedrock261.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class MapInfoRequest : Bedrock261Packet
{
...
class RequestChunkRadius : Bedrock261Packet
{
...
class ChunkRadiusUpdated : Bedrock261Packet
{
...
class ItemFrameDropItem : Bedrock261Packet
{
    ...
    this(soupply.bedrock261.types.BlockPosition position, soupply.bedrock261.types.Slot item=soupply.bedrock261.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock261Packet
{
    ...
    soupply.bedrock261.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock261.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class BossEvent : Bedrock261Packet
{
...
class ShowCredits : Bedrock261Packet
{
...
class AvailableCommands : Bedrock261Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.bedrock261.types.Enum[] enums;
    soupply.bedrock261.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.bedrock261.types.Enum[] enums=(soupply.bedrock261.types.Enum[]).init, soupply.bedrock261.types.Command[] commands=(soupply.bedrock261.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandRequest : Bedrock261Packet
{
    ...
    this(string command, uint type=uint.init, soupply.bedrock261.types.McpeUuid uuid=soupply.bedrock261.types.McpeUuid.init, string requestId=string.init, int playerId=int.init, bool internal=bool.init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock261Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.bedrock261.types.BlockPosition position;
...
class CommandOutput : Bedrock261Packet
{
    ...
    soupply.bedrock261.types.CommandOriginData originData;
    ubyte outputType;
    @Var uint successCount;
    soupply.bedrock261.types.CommandMessage[] messages;
    @Condition("outputType==4") string unknown4;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock261.types.CommandOriginData originData, ubyte outputType=ubyte.init, uint successCount=uint.init, soupply.bedrock261.types.CommandMessage[] messages=(soupply.bedrock261.types.CommandMessage[]).init, string unknown4=string.init) pure nothrow @safe @nogc
    {
...
class UpdateTrade : Bedrock261Packet
{
...
class UpdateEquip : Bedrock261Packet
{
...
class ResourcePackDataInfo : Bedrock261Packet
{
...
class ResourcePackChunkData : Bedrock261Packet
{
...
class ResourcePackChunkRequest : Bedrock261Packet
{
...
class Transfer : Bedrock261Packet
{
...
class PlaySound : Bedrock261Packet
{
    ...
    this(string name, soupply.bedrock261.types.BlockPosition position=soupply.bedrock261.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class StopSound : Bedrock261Packet
{
...
class SetTitle : Bedrock261Packet
{
...
class AddBehaviorTree : Bedrock261Packet
{
...
class StructureBlockUpdate : Bedrock261Packet
{
...
class ShowStoreOffer : Bedrock261Packet
{
...
class PurchaseReceipt : Bedrock261Packet
{
...
class PlayerSkin : Bedrock261Packet
{
    ...
    this(soupply.bedrock261.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
...
class SubClientLogin : Bedrock261Packet
{
...
class WSConnect : Bedrock261Packet
{
...
class SetLastHurtBy : Bedrock261Packet
{
...
class BookEdit : Bedrock261Packet
{
    ...
    class ReplacePage : Bedrock261Packet
    {
    ...
    class AddPage : Bedrock261Packet
    {
    ...
    class DeletePage : Bedrock261Packet
    {
    ...
    class SwapPages : Bedrock261Packet
    {
...
class NpcRequest : Bedrock261Packet
{
...
class PhotoTransfer : Bedrock261Packet
{
...
class ModalFormRequest : Bedrock261Packet
{
...
class ModalFormResponse : Bedrock261Packet
{
...
class ServerSettingsRequest : Bedrock261Packet
{
...
class ServerSettingsResponse : Bedrock261Packet
{
...
class ShowProfile : Bedrock261Packet
{
...
class SetDefaultGameType : Bedrock261Packet
{
...
class RemoveObject : Bedrock261Packet
{
...
class SetDisplayObjective : Bedrock261Packet
{
...
class SetScore : Bedrock261Packet
{
    ...
    ubyte type;
    soupply.bedrock261.types.Score[] scores;

    this() pure nothrow @safe @nogc {}

    this(ubyte type, soupply.bedrock261.types.Score[] scores=(soupply.bedrock261.types.Score[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.scores = scores;
    }
...
class LabTable : Bedrock261Packet
{
    ...
    this(ubyte unknown0, soupply.bedrock261.types.BlockPosition position=soupply.bedrock261.types.BlockPosition.init, ubyte reactionType=ubyte.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
...
class UpdateBlockSynced : Bedrock261Packet
{
    ...
    this(soupply.bedrock261.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init, long entityId=long.init, ulong unknown4=ulong.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
        this.flagsAndMeta = flagsAndMeta;
