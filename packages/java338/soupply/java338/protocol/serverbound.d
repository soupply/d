 ...
 */
module soupply.java338.protocol.serverbound;
...
class ClickWindow : Java338Packet
{
    ...
    ushort action;
    @Var uint mode;
    soupply.java338.types.Slot clickedItem;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, soupply.java338.types.Slot clickedItem=soupply.java338.types.Slot.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.button = button;
...
class CreativeInventoryAction : Java338Packet
{
    ...
    this(ushort slot, soupply.java338.types.Slot clickedItem=soupply.java338.types.Slot.init) pure nothrow @safe @nogc
    {
        this.slot = slot;
        this.clickedItem = clickedItem;
    }
