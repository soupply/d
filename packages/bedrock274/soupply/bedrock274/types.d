...
import soupply.util;
import soupply.bedrock274.metadata;
...
struct InventoryAction
{
    ...
    @Var uint slot;
    soupply.bedrock274.types.Slot oldItem;
    soupply.bedrock274.types.Slot newItem;
...
struct ChunkData
{
    ...
    private struct Container
    {
        ...
        soupply.bedrock274.types.Section[] sections;
        ushort[256] heights;
        ubyte[256] biomes;
        ubyte[] borders;
...
struct PlayerList
{
    ...
    @Var long entityId;
    string displayName;
    soupply.bedrock274.types.Skin skin;
    string unknown4;
...
struct Overload
{
    ...
    soupply.bedrock274.types.Parameter[] parameters;
...
struct Command
{
    ...
    int aliasesEnum = -1;
    soupply.bedrock274.types.Overload[] overloads;
