 ...
 */
module soupply.bedrock274.protocol.play;
...
import soupply.util;
import soupply.bedrock274.metadata : Metadata;
import soupply.bedrock274.packet : Bedrock274Packet;

static import soupply.bedrock274.types;
...
class Login : Bedrock274Packet
{
    ...
    @BigEndian uint protocol = 274;
    soupply.bedrock274.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.bedrock274.types.LoginBody body_=soupply.bedrock274.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class PlayStatus : Bedrock274Packet
{
...
class ServerToClientHandshake : Bedrock274Packet
{
...
class ClientToServerHandshake : Bedrock274Packet
{
...
class Disconnect : Bedrock274Packet
{
...
class ResourcePacksInfo : Bedrock274Packet
{
    ...
    bool mustAccept;
    @Length!ushort soupply.bedrock274.types.PackWithSize[] behaviourPacks;
    @Length!ushort soupply.bedrock274.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock274.types.PackWithSize[] behaviourPacks=(soupply.bedrock274.types.PackWithSize[]).init, soupply.bedrock274.types.PackWithSize[] resourcePacks=(soupply.bedrock274.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock274Packet
{
    ...
    bool mustAccept;
    soupply.bedrock274.types.Pack[] behaviourPacks;
    soupply.bedrock274.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock274.types.Pack[] behaviourPacks=(soupply.bedrock274.types.Pack[]).init, soupply.bedrock274.types.Pack[] resourcePacks=(soupply.bedrock274.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class ResourcePackClientResponse : Bedrock274Packet
{
...
class Text : Bedrock274Packet
{
    ...
    class Translation : Bedrock274Packet
    {
    ...
    class JukeboxPopup : Bedrock274Packet
    {
    ...
    class Whisper : Bedrock274Packet
    {
    ...
    class Announcement : Bedrock274Packet
    {
...
class SetTime : Bedrock274Packet
{
...
class AddPlayer : Bedrock274Packet
{
    ...
    soupply.bedrock274.types.McpeUuid uuid;
    string username;
    @Var long entityId;
    @Var ulong runtimeId;
    Vector!(float, "xyz") position;
    ...
    float headYaw;
    float yaw;
    soupply.bedrock274.types.Slot heldItem;
    Metadata metadata;
    @Var uint unknown11;
    @Var uint unknown12;
    @Var uint unknown13;
...
class AddEntity : Bedrock274Packet
{
    ...
    float yaw;
    float headYaw;
    soupply.bedrock274.types.Attribute[] attributes;
    Metadata metadata;
    soupply.bedrock274.types.Link[] links;
...
class RemoveEntity : Bedrock274Packet
{
...
class AddItemEntity : Bedrock274Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.bedrock274.types.Slot item;
    Vector!(float, "xyz") position;
    Vector!(float, "xyz") motion;
    Metadata metadata;
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock274.types.Slot item=soupply.bedrock274.types.Slot.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Bedrock274Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.bedrock274.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock274.types.BlockPosition position=soupply.bedrock274.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class TakeItemEntity : Bedrock274Packet
{
...
class MoveEntityAbsolute : Bedrock274Packet
{
...
class MovePlayer : Bedrock274Packet
{
...
class RiderJump : Bedrock274Packet
{
...
class UpdateBlock : Bedrock274Packet
{
    ...
    this(soupply.bedrock274.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init, uint dataLayerId=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Bedrock274Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock274.types.BlockPosition position=soupply.bedrock274.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Bedrock274Packet
{
    ...
    Vector!(float, "xyz") position;
    float radius;
    soupply.bedrock274.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Vector!(float, "xyz") position, float radius=float.init, soupply.bedrock274.types.BlockPosition[] destroyedBlocks=(soupply.bedrock274.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class LevelSoundEvent : Bedrock274Packet
{
...
class LevelEvent : Bedrock274Packet
{
...
class BlockEvent : Bedrock274Packet
{
    ...
    this(soupply.bedrock274.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class EntityEvent : Bedrock274Packet
{
...
class MobEffect : Bedrock274Packet
{
...
class UpdateAttributes : Bedrock274Packet
{
    ...
    this(long entityId, soupply.bedrock274.types.Attribute[] attributes=(soupply.bedrock274.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock274Packet
{
    ...
    @Var uint type;
    soupply.bedrock274.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.bedrock274.types.InventoryAction[] actions=(soupply.bedrock274.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class Normal0 : Bedrock274Packet
    {
    ...
    class Normal1 : Bedrock274Packet
    {
    ...
    class UseItem : Bedrock274Packet
    {
        ...
        @Var uint actionType;
        soupply.bedrock274.types.BlockPosition blockPosition;
        @Var int face;
        @Var int hotbarSlot;
        soupply.bedrock274.types.Slot item;
    ...
    class UseItemOnEntity : Bedrock274Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.bedrock274.types.Slot item=soupply.bedrock274.types.Slot.init, Vector!(float, "xyz") unknown4=Vector!(float, "xyz").init, Vector!(float, "xyz") unknown5=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock274Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.bedrock274.types.Slot item=soupply.bedrock274.types.Slot.init, Vector!(float, "xyz") headPosition=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class MobEquipment : Bedrock274Packet
{
    ...
    this(long entityId, soupply.bedrock274.types.Slot item=soupply.bedrock274.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock274Packet
{
    ...
    @Var long entityId;
    soupply.bedrock274.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.bedrock274.types.Slot[4] armor=(soupply.bedrock274.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class Interact : Bedrock274Packet
{
...
class BlockPickRequest : Bedrock274Packet
{
...
class EntityPickRequest : Bedrock274Packet
{
...
class PlayerAction : Bedrock274Packet
{
    ...
    this(long entityId, int action=int.init, soupply.bedrock274.types.BlockPosition position=soupply.bedrock274.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class EntityFall : Bedrock274Packet
{
...
class HurtArmor : Bedrock274Packet
{
...
class SetEntityData : Bedrock274Packet
{
...
class SetEntityMotion : Bedrock274Packet
{
...
class SetEntityLink : Bedrock274Packet
{
...
class SetHealth : Bedrock274Packet
{
...
class SetSpawnPosition : Bedrock274Packet
{
    ...
    this(int type, soupply.bedrock274.types.BlockPosition position=soupply.bedrock274.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class Animate : Bedrock274Packet
{
...
class Respawn : Bedrock274Packet
{
...
class ContainerOpen : Bedrock274Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.bedrock274.types.BlockPosition position=soupply.bedrock274.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class ContainerClose : Bedrock274Packet
{
...
class PlayerHotbar : Bedrock274Packet
{
...
class InventoryContent : Bedrock274Packet
{
    ...
    @Var uint window;
    soupply.bedrock274.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.bedrock274.types.Slot[] slots=(soupply.bedrock274.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class InventorySlot : Bedrock274Packet
{
...
class ContainerSetData : Bedrock274Packet
{
...
class CraftingData : Bedrock274Packet
{
    ...
    soupply.bedrock274.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock274.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock274Packet
{
    ...
    @Var int type;
    soupply.bedrock274.types.McpeUuid uuid;
    soupply.bedrock274.types.Slot[] input;
    soupply.bedrock274.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.bedrock274.types.McpeUuid uuid=soupply.bedrock274.types.McpeUuid.init, soupply.bedrock274.types.Slot[] input=(soupply.bedrock274.types.Slot[]).init, soupply.bedrock274.types.Slot[] output=(soupply.bedrock274.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class GuiDataPickItem : Bedrock274Packet
{
...
class AdventureSettings : Bedrock274Packet
{
...
class BlockEntityData : Bedrock274Packet
{
    ...
    this(soupply.bedrock274.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerInput : Bedrock274Packet
{
...
class FullChunkData : Bedrock274Packet
{
    ...
    soupply.bedrock274.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Vector!(int, "xz") position, soupply.bedrock274.types.ChunkData data=soupply.bedrock274.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class SetCommandsEnabled : Bedrock274Packet
{
...
class SetDifficulty : Bedrock274Packet
{
...
class ChangeDimension : Bedrock274Packet
{
...
class SetPlayerGameType : Bedrock274Packet
{
...
class PlayerList : Bedrock274Packet
{
    ...
    class Add : Bedrock274Packet
    {
        ...
        soupply.bedrock274.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock274.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock274Packet
    {
        ...
        soupply.bedrock274.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock274.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class SimpleEvent : Bedrock274Packet
{
...
class SpawnExperienceOrb : Bedrock274Packet
{
...
class ClientboundMapItemData : Bedrock274Packet
{
    ...
    @Condition("update==4") soupply.bedrock274.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Vector!(int, "xz") size=Vector!(int, "xz").init, Vector!(int, "xz") offset=Vector!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.bedrock274.types.Decoration[] decorations=(soupply.bedrock274.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class MapInfoRequest : Bedrock274Packet
{
...
class RequestChunkRadius : Bedrock274Packet
{
...
class ChunkRadiusUpdated : Bedrock274Packet
{
...
class ItemFrameDropItem : Bedrock274Packet
{
    ...
    this(soupply.bedrock274.types.BlockPosition position, soupply.bedrock274.types.Slot item=soupply.bedrock274.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock274Packet
{
    ...
    soupply.bedrock274.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock274.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class BossEvent : Bedrock274Packet
{
...
class ShowCredits : Bedrock274Packet
{
...
class AvailableCommands : Bedrock274Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.bedrock274.types.Enum[] enums;
    soupply.bedrock274.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.bedrock274.types.Enum[] enums=(soupply.bedrock274.types.Enum[]).init, soupply.bedrock274.types.Command[] commands=(soupply.bedrock274.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandRequest : Bedrock274Packet
{
    ...
    this(string command, uint type=uint.init, soupply.bedrock274.types.McpeUuid uuid=soupply.bedrock274.types.McpeUuid.init, string requestId=string.init, int playerId=int.init, bool internal=bool.init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock274Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.bedrock274.types.BlockPosition position;
...
class CommandOutput : Bedrock274Packet
{
    ...
    soupply.bedrock274.types.CommandOriginData originData;
    ubyte outputType;
    @Var uint successCount;
    soupply.bedrock274.types.CommandMessage[] messages;
    @Condition("outputType==4") string unknown4;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock274.types.CommandOriginData originData, ubyte outputType=ubyte.init, uint successCount=uint.init, soupply.bedrock274.types.CommandMessage[] messages=(soupply.bedrock274.types.CommandMessage[]).init, string unknown4=string.init) pure nothrow @safe @nogc
    {
...
class UpdateTrade : Bedrock274Packet
{
...
class UpdateEquip : Bedrock274Packet
{
...
class ResourcePackDataInfo : Bedrock274Packet
{
...
class ResourcePackChunkData : Bedrock274Packet
{
...
class ResourcePackChunkRequest : Bedrock274Packet
{
...
class Transfer : Bedrock274Packet
{
...
class PlaySound : Bedrock274Packet
{
    ...
    this(string name, soupply.bedrock274.types.BlockPosition position=soupply.bedrock274.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class StopSound : Bedrock274Packet
{
...
class SetTitle : Bedrock274Packet
{
...
class AddBehaviorTree : Bedrock274Packet
{
...
class StructureBlockUpdate : Bedrock274Packet
{
...
class ShowStoreOffer : Bedrock274Packet
{
...
class PurchaseReceipt : Bedrock274Packet
{
...
class PlayerSkin : Bedrock274Packet
{
    ...
    this(soupply.bedrock274.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
...
class SubClientLogin : Bedrock274Packet
{
...
class WSConnect : Bedrock274Packet
{
...
class SetLastHurtBy : Bedrock274Packet
{
...
class BookEdit : Bedrock274Packet
{
    ...
    class ReplacePage : Bedrock274Packet
    {
    ...
    class AddPage : Bedrock274Packet
    {
    ...
    class DeletePage : Bedrock274Packet
    {
    ...
    class SwapPages : Bedrock274Packet
    {
...
class NpcRequest : Bedrock274Packet
{
...
class PhotoTransfer : Bedrock274Packet
{
...
class ModalFormRequest : Bedrock274Packet
{
...
class ModalFormResponse : Bedrock274Packet
{
...
class ServerSettingsRequest : Bedrock274Packet
{
...
class ServerSettingsResponse : Bedrock274Packet
{
...
class ShowProfile : Bedrock274Packet
{
...
class SetDefaultGameType : Bedrock274Packet
{
...
class RemoveObject : Bedrock274Packet
{
...
class SetDisplayObjective : Bedrock274Packet
{
...
class SetScore : Bedrock274Packet
{
    ...
    ubyte type;
    soupply.bedrock274.types.Score[] scores;

    this() pure nothrow @safe @nogc {}

    this(ubyte type, soupply.bedrock274.types.Score[] scores=(soupply.bedrock274.types.Score[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.scores = scores;
    }
...
class LabTable : Bedrock274Packet
{
    ...
    this(ubyte unknown0, soupply.bedrock274.types.BlockPosition position=soupply.bedrock274.types.BlockPosition.init, ubyte reactionType=ubyte.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
...
class UpdateBlockSynced : Bedrock274Packet
{
    ...
    this(soupply.bedrock274.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init, long entityId=long.init, ulong unknown4=ulong.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
        this.flagsAndMeta = flagsAndMeta;
...
class MoveEntityDelta : Bedrock274Packet
{
...
class SetLocalPlayerAsInitialized : Bedrock274Packet
{
