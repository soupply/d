...
class Metadata
{
    ...
    @property soupply.java210.types.Slot potion()
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataSlot)*ptr) return (cast(MetadataSlot)*ptr).value;
        return (soupply.java210.types.Slot).init;
    }

    @property soupply.java210.types.Slot potion(soupply.java210.types.Slot value)
    {
        auto ptr = 6 in this.values;
    ...
    @property soupply.java210.types.OptionalPosition beamTarget()
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataOptionalPosition)*ptr) return (cast(MetadataOptionalPosition)*ptr).value;
        return (soupply.java210.types.OptionalPosition).init;
    }

    @property soupply.java210.types.OptionalPosition beamTarget(soupply.java210.types.OptionalPosition value)
    {
        auto ptr = 6 in this.values;
    ...
    @property soupply.java210.types.Slot firework()
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataSlot)*ptr) return (cast(MetadataSlot)*ptr).value;
        return (soupply.java210.types.Slot).init;
    ...
    @property soupply.java210.types.Slot firework(soupply.java210.types.Slot value)
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataSlot)*ptr) (cast(MetadataSlot)*ptr).value = value;
        else this.values[6] = new MetadataSlot(value);
    ...
    @property soupply.java210.types.Slot item()
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataSlot)*ptr) return (cast(MetadataSlot)*ptr).value;
        return (soupply.java210.types.Slot).init;
    ...
    @property soupply.java210.types.Slot item(soupply.java210.types.Slot value)
    {
        auto ptr = 6 in this.values;
        if(ptr && cast(MetadataSlot)*ptr) (cast(MetadataSlot)*ptr).value = value;
        else this.values[6] = new MetadataSlot(value);
    ...
    @property uint horseType(uint value)
    {
        auto ptr = 14 in this.values;
        if(ptr && cast(MetadataInt)*ptr) (cast(MetadataInt)*ptr).value = value;
    ...
    @property soupply.java210.types.OptionalUuid ownerUuid()
    {
        auto ptr = 16 in this.values;
        if(ptr && cast(MetadataUuid)*ptr) return (cast(MetadataUuid)*ptr).value;
        return (soupply.java210.types.OptionalUuid).init;
    }

    @property soupply.java210.types.OptionalUuid ownerUuid(soupply.java210.types.OptionalUuid value)
    {
        auto ptr = 16 in this.values;
        if(ptr && cast(MetadataUuid)*ptr) (cast(MetadataUuid)*ptr).value = value;
        else this.values[16] = new MetadataUuid(value);
        return value;
    }
    ...
    @property soupply.java210.types.OptionalPosition shulkerAttachment()
    {
        auto ptr = 13 in this.values;
        if(ptr && cast(MetadataOptionalPosition)*ptr) return (cast(MetadataOptionalPosition)*ptr).value;
        return (soupply.java210.types.OptionalPosition).init;
    ...
    @property soupply.java210.types.OptionalPosition shulkerAttachment(soupply.java210.types.OptionalPosition value)
    {
        auto ptr = 13 in this.values;
        if(ptr && cast(MetadataOptionalPosition)*ptr) (cast(MetadataOptionalPosition)*ptr).value = value;
    ...
    @property byte guardianFlags(byte value)
    {
        auto ptr = 12 in this.values;
        if(ptr && cast(MetadataByte)*ptr) (cast(MetadataByte)*ptr).value = value;
        else this.values[12] = new MetadataByte(value);
    ...
    @property uint skeletonType(uint value)
    {
        auto ptr = 12 in this.values;
        if(ptr && cast(MetadataInt)*ptr) (cast(MetadataInt)*ptr).value = value;
        else this.values[12] = new MetadataInt(value);
    ...
    @property uint zombieType(uint value)
    {
        auto ptr = 13 in this.values;
        if(ptr && cast(MetadataInt)*ptr) (cast(MetadataInt)*ptr).value = value;
        else this.values[13] = new MetadataInt(value);
