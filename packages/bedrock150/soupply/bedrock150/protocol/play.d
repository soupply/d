 ...
 */
module soupply.bedrock150.protocol.play;
...
import soupply.bedrock150.metadata : Metadata;
import soupply.bedrock150.packet : Bedrock150Packet;

static import soupply.bedrock150.types;
...
class Login : Bedrock150Packet
{
    ...
    soupply.bedrock150.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, soupply.bedrock150.types.LoginBody body_=soupply.bedrock150.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class ResourcePacksInfo : Bedrock150Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.bigEndian) soupply.bedrock150.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.bigEndian) soupply.bedrock150.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock150.types.PackWithSize[] behaviourPacks=(soupply.bedrock150.types.PackWithSize[]).init, soupply.bedrock150.types.PackWithSize[] resourcePacks=(soupply.bedrock150.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Bedrock150Packet
{
    ...
    bool mustAccept;
    soupply.bedrock150.types.Pack[] behaviourPacks;
    soupply.bedrock150.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.bedrock150.types.Pack[] behaviourPacks=(soupply.bedrock150.types.Pack[]).init, soupply.bedrock150.types.Pack[] resourcePacks=(soupply.bedrock150.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class StartGame : Bedrock150Packet
{
    ...
    soupply.bedrock150.types.Rule[] gameRules;
...
class AddPlayer : Bedrock150Packet
{
    ...
    soupply.bedrock150.types.McpeUuid uuid;
    string username;
    @Var long entityId;
    @Var ulong runtimeId;
    Vector!(float, "xyz") position;
    ...
    float headYaw;
    float yaw;
    soupply.bedrock150.types.Slot heldItem;
    Metadata metadata;
    @Var uint unknown11;
    @Var uint unknown12;
    @Var uint unknown13;
    ...
    @Var uint unknown15;
    long unknown16;
    soupply.bedrock150.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock150.types.McpeUuid uuid, string username=string.init, long entityId=long.init, ulong runtimeId=ulong.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, float pitch=float.init, float headYaw=float.init, float yaw=float.init, soupply.bedrock150.types.Slot heldItem=soupply.bedrock150.types.Slot.init, Metadata metadata=Metadata.init, uint unknown11=uint.init, uint unknown12=uint.init, uint unknown13=uint.init, uint unknown14=uint.init, uint unknown15=uint.init, long unknown16=long.init, soupply.bedrock150.types.Link[] links=(soupply.bedrock150.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
...
class AddEntity : Bedrock150Packet
{
    ...
    float pitch;
    float yaw;
    soupply.bedrock150.types.Attribute[] attributes;
    Metadata metadata;
    soupply.bedrock150.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, uint type=uint.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.bedrock150.types.Attribute[] attributes=(soupply.bedrock150.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.bedrock150.types.Link[] links=(soupply.bedrock150.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class AddItemEntity : Bedrock150Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.bedrock150.types.Slot item;
    Vector!(float, "xyz") position;
    Vector!(float, "xyz") motion;
    Metadata metadata;
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock150.types.Slot item=soupply.bedrock150.types.Slot.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Bedrock150Packet
{
    ...
    @Var long entityId;
    @Var ulong runtimeId;
    soupply.bedrock150.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock150.types.BlockPosition position=soupply.bedrock150.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class UpdateBlock : Bedrock150Packet
{
    ...
    this(soupply.bedrock150.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Bedrock150Packet
{
    ...
    this(long entityId, ulong runtimeId=ulong.init, soupply.bedrock150.types.BlockPosition position=soupply.bedrock150.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Bedrock150Packet
{
    ...
    Vector!(float, "xyz") position;
    float radius;
    soupply.bedrock150.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Vector!(float, "xyz") position, float radius=float.init, soupply.bedrock150.types.BlockPosition[] destroyedBlocks=(soupply.bedrock150.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class BlockEvent : Bedrock150Packet
{
    ...
    this(soupply.bedrock150.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class UpdateAttributes : Bedrock150Packet
{
    ...
    this(long entityId, soupply.bedrock150.types.Attribute[] attributes=(soupply.bedrock150.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class InventoryTransaction : Bedrock150Packet
{
    ...
    @Var uint type;
    soupply.bedrock150.types.InventoryAction[] actions;

    this() pure nothrow @safe @nogc {}

    this(uint type, soupply.bedrock150.types.InventoryAction[] actions=(soupply.bedrock150.types.InventoryAction[]).init) pure nothrow @safe @nogc
    {
        this.type = type;
    ...
    class UseItem : Bedrock150Packet
    {
        ...
        @Var uint actionType;
        soupply.bedrock150.types.BlockPosition blockPosition;
        @Var int face;
        @Var int hotbarSlot;
        soupply.bedrock150.types.Slot item;
        ...
        this(uint actionType, soupply.bedrock150.types.BlockPosition blockPosition=soupply.bedrock150.types.BlockPosition.init, int face=int.init, int hotbarSlot=int.init, soupply.bedrock150.types.Slot item=soupply.bedrock150.types.Slot.init, Vector!(float, "xyz") playerPosition=Vector!(float, "xyz").init, Vector!(float, "xyz") clickPosition=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
    ...
    class UseItemOnEntity : Bedrock150Packet
    {
        ...
        this(long entityId, uint actionType=uint.init, int hotbarSlot=int.init, soupply.bedrock150.types.Slot item=soupply.bedrock150.types.Slot.init, Vector!(float, "xyz") unknown4=Vector!(float, "xyz").init, Vector!(float, "xyz") unknown5=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.entityId = entityId;
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
    ...
    class ReleaseItem : Bedrock150Packet
    {
        ...
        this(uint actionType, int hotbarSlot=int.init, soupply.bedrock150.types.Slot item=soupply.bedrock150.types.Slot.init, Vector!(float, "xyz") headPosition=Vector!(float, "xyz").init) pure nothrow @safe @nogc
        {
            this.actionType = actionType;
            this.hotbarSlot = hotbarSlot;
            this.item = item;
...
class MobEquipment : Bedrock150Packet
{
    ...
    this(long entityId, soupply.bedrock150.types.Slot item=soupply.bedrock150.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Bedrock150Packet
{
    ...
    @Var long entityId;
    soupply.bedrock150.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.bedrock150.types.Slot[4] armor=(soupply.bedrock150.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class PlayerAction : Bedrock150Packet
{
    ...
    this(long entityId, int action=int.init, soupply.bedrock150.types.BlockPosition position=soupply.bedrock150.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class SetSpawnPosition : Bedrock150Packet
{
    ...
    this(int type, soupply.bedrock150.types.BlockPosition position=soupply.bedrock150.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class ContainerOpen : Bedrock150Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.bedrock150.types.BlockPosition position=soupply.bedrock150.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class InventoryContent : Bedrock150Packet
{
    ...
    @Var uint window;
    soupply.bedrock150.types.Slot[] slots;

    this() pure nothrow @safe @nogc {}

    this(uint window, soupply.bedrock150.types.Slot[] slots=(soupply.bedrock150.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
    }
...
class CraftingData : Bedrock150Packet
{
    ...
    soupply.bedrock150.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock150.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Bedrock150Packet
{
    ...
    @Var int type;
    soupply.bedrock150.types.McpeUuid uuid;
    soupply.bedrock150.types.Slot[] input;
    soupply.bedrock150.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.bedrock150.types.McpeUuid uuid=soupply.bedrock150.types.McpeUuid.init, soupply.bedrock150.types.Slot[] input=(soupply.bedrock150.types.Slot[]).init, soupply.bedrock150.types.Slot[] output=(soupply.bedrock150.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class BlockEntityData : Bedrock150Packet
{
    ...
    this(soupply.bedrock150.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class FullChunkData : Bedrock150Packet
{
    ...
    soupply.bedrock150.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Vector!(int, "xz") position, soupply.bedrock150.types.ChunkData data=soupply.bedrock150.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class PlayerList : Bedrock150Packet
{
    ...
    class Add : Bedrock150Packet
    {
        ...
        soupply.bedrock150.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock150.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Bedrock150Packet
    {
        ...
        soupply.bedrock150.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.bedrock150.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class ClientboundMapItemData : Bedrock150Packet
{
    ...
    @Condition("update==4") soupply.bedrock150.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Vector!(int, "xz") size=Vector!(int, "xz").init, Vector!(int, "xz") offset=Vector!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.bedrock150.types.Decoration[] decorations=(soupply.bedrock150.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class ItemFrameDropItem : Bedrock150Packet
{
    ...
    this(soupply.bedrock150.types.BlockPosition position, soupply.bedrock150.types.Slot item=soupply.bedrock150.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class GameRulesChanged : Bedrock150Packet
{
    ...
    soupply.bedrock150.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.bedrock150.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class AvailableCommands : Bedrock150Packet
{
    ...
    string[] enumValues;
    string[] unknown1;
    soupply.bedrock150.types.Enum[] enums;
    soupply.bedrock150.types.Command[] commands;

    this() pure nothrow @safe @nogc {}

    this(string[] enumValues, string[] unknown1=(string[]).init, soupply.bedrock150.types.Enum[] enums=(soupply.bedrock150.types.Enum[]).init, soupply.bedrock150.types.Command[] commands=(soupply.bedrock150.types.Command[]).init) pure nothrow @safe @nogc
    {
...
class CommandRequest : Bedrock150Packet
{
    ...
    this(string command, uint type=uint.init, soupply.bedrock150.types.McpeUuid uuid=soupply.bedrock150.types.McpeUuid.init, string requestId=string.init, int playerId=int.init, bool internal=bool.init) pure nothrow @safe @nogc
    {
...
class CommandBlockUpdate : Bedrock150Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.bedrock150.types.BlockPosition position;
    ...
    this(bool updateBlock, soupply.bedrock150.types.BlockPosition position=soupply.bedrock150.types.BlockPosition.init, uint mode=uint.init, bool redstoneMode=bool.init, bool conditional=bool.init, long minecart=long.init, string command=string.init, string lastOutput=string.init, string hover=string.init, bool trackOutput=bool.init) pure nothrow @safe @nogc
    {
...
class PlaySound : Bedrock150Packet
{
    ...
    this(string name, soupply.bedrock150.types.BlockPosition position=soupply.bedrock150.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
...
class PlayerSkin : Bedrock150Packet
{
    ...
    this(soupply.bedrock150.types.McpeUuid uuid, string skinId=string.init, string skinName=string.init, string unknown3=string.init, ubyte[] skinData=(ubyte[]).init, ubyte[] capeData=(ubyte[]).init, string geometryModel=string.init, ubyte[] geometryData=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
        this.skinId = skinId;
