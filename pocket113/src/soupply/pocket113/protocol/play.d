 ...
 */
module soupply.pocket113.protocol.play;
...
import soupply.pocket113.metadata : Metadata;
...
class Login : Pocket113Packet
{
    ...
    uint protocol = 113;
    ubyte version_;
    soupply.pocket113.types.LoginBody body_;

    this() pure nothrow @safe @nogc {}

    this(uint protocol, ubyte version_=ubyte.init, soupply.pocket113.types.LoginBody body_=soupply.pocket113.types.LoginBody.init) pure nothrow @safe @nogc
    {
...
class ResourcePacksInfo : Pocket113Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket113.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket113.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.pocket113.types.PackWithSize[] behaviourPacks=(soupply.pocket113.types.PackWithSize[]).init, soupply.pocket113.types.PackWithSize[] resourcePacks=(soupply.pocket113.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Pocket113Packet
{
    ...
    bool mustAccept;
    soupply.pocket113.types.Pack[] behaviourPacks;
    soupply.pocket113.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.pocket113.types.Pack[] behaviourPacks=(soupply.pocket113.types.Pack[]).init, soupply.pocket113.types.Pack[] resourcePacks=(soupply.pocket113.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class StartGame : Pocket113Packet
{
    ...
    soupply.pocket113.types.Rule[] gameRules;
    string levelId;
    string worldName;
...
class AddPlayer : Pocket113Packet
{
    ...
    soupply.pocket113.types.McpeUuid uuid;
    string username;
    @Var long entityId;
    @Var long runtimeId;
    Vector!(float, "xyz") position;
    ...
    float headYaw;
    float yaw;
    soupply.pocket113.types.Slot heldItem;
    Metadata metadata;

    this() pure nothrow @safe @nogc {}

    this(soupply.pocket113.types.McpeUuid uuid, string username=string.init, long entityId=long.init, long runtimeId=long.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, float pitch=float.init, float headYaw=float.init, float yaw=float.init, soupply.pocket113.types.Slot heldItem=soupply.pocket113.types.Slot.init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.uuid = uuid;
...
class AddEntity : Pocket113Packet
{
    ...
    float pitch;
    float yaw;
    soupply.pocket113.types.Attribute[] attributes;
    Metadata metadata;
    soupply.pocket113.types.Link[] links;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, uint type=uint.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, float pitch=float.init, float yaw=float.init, soupply.pocket113.types.Attribute[] attributes=(soupply.pocket113.types.Attribute[]).init, Metadata metadata=Metadata.init, soupply.pocket113.types.Link[] links=(soupply.pocket113.types.Link[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.type = type;
...
class AddItemEntity : Pocket113Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.pocket113.types.Slot item;
    Vector!(float, "xyz") position;
    Vector!(float, "xyz") motion;
    Metadata metadata;
    ...
    this(long entityId, long runtimeId=long.init, soupply.pocket113.types.Slot item=soupply.pocket113.types.Slot.init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, Vector!(float, "xyz") motion=Vector!(float, "xyz").init, Metadata metadata=Metadata.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.item = item;
...
class AddHangingEntity : Pocket113Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.pocket113.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.pocket113.types.BlockPosition position=soupply.pocket113.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class RemoveBlock : Pocket113Packet
{
    ...
    this(soupply.pocket113.types.BlockPosition position) pure nothrow @safe @nogc
    {
        this.position = position;
    }
...
class UpdateBlock : Pocket113Packet
{
    ...
    this(soupply.pocket113.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Pocket113Packet
{
    ...
    this(long entityId, long runtimeId=long.init, soupply.pocket113.types.BlockPosition position=soupply.pocket113.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class Explode : Pocket113Packet
{
    ...
    Vector!(float, "xyz") position;
    float radius;
    soupply.pocket113.types.BlockPosition[] destroyedBlocks;

    this() pure nothrow @safe @nogc {}

    this(Vector!(float, "xyz") position, float radius=float.init, soupply.pocket113.types.BlockPosition[] destroyedBlocks=(soupply.pocket113.types.BlockPosition[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.radius = radius;
...
class BlockEvent : Pocket113Packet
{
    ...
    this(soupply.pocket113.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class UpdateAttributes : Pocket113Packet
{
    ...
    this(long entityId, soupply.pocket113.types.Attribute[] attributes=(soupply.pocket113.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class MobEquipment : Pocket113Packet
{
    ...
    this(long entityId, soupply.pocket113.types.Slot item=soupply.pocket113.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Pocket113Packet
{
    ...
    @Var long entityId;
    soupply.pocket113.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.pocket113.types.Slot[4] armor=(soupply.pocket113.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class BlockPickRequest : Pocket113Packet
{
    ...
    this(Vector!(int, "xyz") position, ubyte slot=ubyte.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.slot = slot;
    }
...
class UseItem : Pocket113Packet
{
    ...
    soupply.pocket113.types.BlockPosition blockPosition;
    @Var uint hotbarSlot;
    @Var int face;
    ...
    this(soupply.pocket113.types.BlockPosition blockPosition, uint hotbarSlot=uint.init, int face=int.init, Vector!(float, "xyz") facePosition=Vector!(float, "xyz").init, Vector!(float, "xyz") position=Vector!(float, "xyz").init, int slot=int.init, soupply.pocket113.types.Slot item=soupply.pocket113.types.Slot.init) pure nothrow @safe @nogc
    {
...
class PlayerAction : Pocket113Packet
{
    ...
    this(long entityId, int action=int.init, soupply.pocket113.types.BlockPosition position=soupply.pocket113.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class SetSpawnPosition : Pocket113Packet
{
    ...
    this(int type, soupply.pocket113.types.BlockPosition position=soupply.pocket113.types.BlockPosition.init, bool forced=bool.init) pure nothrow @safe @nogc
    {
        this.type = type;
        this.position = position;
        this.forced = forced;
...
class DropItem : Pocket113Packet
{
    ...
    this(ubyte action, soupply.pocket113.types.Slot item=soupply.pocket113.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class InventoryAction : Pocket113Packet
{
    ...
    this(int action, soupply.pocket113.types.Slot item=soupply.pocket113.types.Slot.init, int unknown2=int.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
        this.unknown2 = unknown2;
...
class ContainerOpen : Pocket113Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, soupply.pocket113.types.BlockPosition position=soupply.pocket113.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.position = position;
...
class ContainerSetSlot : Pocket113Packet
{
    ...
    this(ubyte window, int slot=int.init, int hotbarSlot=int.init, soupply.pocket113.types.Slot item=soupply.pocket113.types.Slot.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.hotbarSlot = hotbarSlot;
...
class ContainerSetContent : Pocket113Packet
{
    ...
    @Var uint window;
    @Var long entityId;
    soupply.pocket113.types.Slot[] slots;
    @Var int[] hotbar;

    this() pure nothrow @safe @nogc {}

    this(uint window, long entityId=long.init, soupply.pocket113.types.Slot[] slots=(soupply.pocket113.types.Slot[]).init, int[] hotbar=(int[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.entityId = entityId;
        this.slots = slots;
...
class CraftingData : Pocket113Packet
{
    ...
    soupply.pocket113.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.pocket113.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Pocket113Packet
{
    ...
    @Var int type;
    soupply.pocket113.types.McpeUuid uuid;
    soupply.pocket113.types.Slot[] input;
    soupply.pocket113.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, soupply.pocket113.types.McpeUuid uuid=soupply.pocket113.types.McpeUuid.init, soupply.pocket113.types.Slot[] input=(soupply.pocket113.types.Slot[]).init, soupply.pocket113.types.Slot[] output=(soupply.pocket113.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class BlockEntityData : Pocket113Packet
{
    ...
    this(soupply.pocket113.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class FullChunkData : Pocket113Packet
{
    ...
    soupply.pocket113.types.ChunkData data;

    this() pure nothrow @safe @nogc {}

    this(Vector!(int, "xz") position, soupply.pocket113.types.ChunkData data=soupply.pocket113.types.ChunkData.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class PlayerList : Pocket113Packet
{
    ...
    class Add : Pocket113Packet
    {
        ...
        soupply.pocket113.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.pocket113.types.PlayerList[] players) pure nothrow @safe @nogc
        {
    ...
    class Remove : Pocket113Packet
    {
        ...
        soupply.pocket113.types.McpeUuid[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.pocket113.types.McpeUuid[] players) pure nothrow @safe @nogc
        {
            this.players = players;
        }
...
class ClientboundMapItemData : Pocket113Packet
{
    ...
    @Condition("update==4") soupply.pocket113.types.Decoration[] decorations;

    this() pure nothrow @safe @nogc {}

    this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Vector!(int, "xz") size=Vector!(int, "xz").init, Vector!(int, "xz") offset=Vector!(int, "xz").init, ubyte[] data=(ubyte[]).init, soupply.pocket113.types.Decoration[] decorations=(soupply.pocket113.types.Decoration[]).init) pure nothrow @safe @nogc
    {
        this.mapId = mapId;
        this.update = update;
        this.scale = scale;
...
class ItemFrameDropItem : Pocket113Packet
{
    ...
    this(soupply.pocket113.types.BlockPosition position, soupply.pocket113.types.Slot item=soupply.pocket113.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class ReplaceItemInSlot : Pocket113Packet
{
    ...
    this(soupply.pocket113.types.Slot item) pure nothrow @safe @nogc
    {
        this.item = item;
    }
...
class GameRulesChanged : Pocket113Packet
{
    ...
    @Length!uint soupply.pocket113.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.pocket113.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
...
class CommandBlockUpdate : Pocket113Packet
{
    ...
    bool updateBlock;
    @Condition("updateBlock==true") soupply.pocket113.types.BlockPosition position;
    ...
    this(bool updateBlock, soupply.pocket113.types.BlockPosition position=soupply.pocket113.types.BlockPosition.init, uint mode=uint.init, bool redstoneMode=bool.init, bool conditional=bool.init, long minecart=long.init, string command=string.init, string lastOutput=string.init, string hover=string.init, bool trackOutput=bool.init) pure nothrow @safe @nogc
    {
...
class PlaySound : Pocket113Packet
{
    ...
    this(string name, soupply.pocket113.types.BlockPosition position=soupply.pocket113.types.BlockPosition.init, float volume=float.init, float pitch=float.init) pure nothrow @safe @nogc
    {
        this.name = name;
        this.position = position;
        this.volume = volume;
