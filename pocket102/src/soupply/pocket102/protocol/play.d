 ...
 */
module soupply.pocket102.protocol.play;
...
static import soupply.pocket102.types;
...
class ResourcePacksInfo : Pocket102Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket102.types.PackWithSize[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket102.types.PackWithSize[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.pocket102.types.PackWithSize[] behaviourPacks=(soupply.pocket102.types.PackWithSize[]).init, soupply.pocket102.types.PackWithSize[] resourcePacks=(soupply.pocket102.types.PackWithSize[]).init) pure nothrow @safe @nogc
    {
...
class ResourcePacksStackPacket : Pocket102Packet
{
    ...
    bool mustAccept;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket102.types.Pack[] behaviourPacks;
    @EndianLength!ushort(Endian.littleEndian) soupply.pocket102.types.Pack[] resourcePacks;

    this() pure nothrow @safe @nogc {}

    this(bool mustAccept, soupply.pocket102.types.Pack[] behaviourPacks=(soupply.pocket102.types.Pack[]).init, soupply.pocket102.types.Pack[] resourcePacks=(soupply.pocket102.types.Pack[]).init) pure nothrow @safe @nogc
    {
        this.mustAccept = mustAccept;
        this.behaviourPacks = behaviourPacks;
        this.resourcePacks = resourcePacks;
...
class AddPlayer : Pocket102Packet
{
    ...
    float headYaw;
    float yaw;
    soupply.pocket102.types.Slot heldItem;
    Metadata metadata;
...
class AddEntity : Pocket102Packet
{
    ...
    Metadata metadata;
    soupply.pocket102.types.Link[] links;
...
class AddHangingEntity : Pocket102Packet
{
    ...
    @Var long entityId;
    @Var long runtimeId;
    soupply.pocket102.types.BlockPosition position;
    @Var int unknown3;

    this() pure nothrow @safe @nogc {}

    this(long entityId, long runtimeId=long.init, soupply.pocket102.types.BlockPosition position=soupply.pocket102.types.BlockPosition.init, int unknown3=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class RemoveBlock : Pocket102Packet
{
    ...
    this(soupply.pocket102.types.BlockPosition position) pure nothrow @safe @nogc
    {
        this.position = position;
    }
...
class UpdateBlock : Pocket102Packet
{
    ...
    this(soupply.pocket102.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.block = block;
...
class AddPainting : Pocket102Packet
{
    ...
    this(long entityId, long runtimeId=long.init, soupply.pocket102.types.BlockPosition position=soupply.pocket102.types.BlockPosition.init, int direction=int.init, string title=string.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.runtimeId = runtimeId;
        this.position = position;
...
class BlockEvent : Pocket102Packet
{
    ...
    this(soupply.pocket102.types.BlockPosition position, int[2] data=(int[2]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.data = data;
    }
...
class UpdateAttributes : Pocket102Packet
{
    ...
    this(long entityId, soupply.pocket102.types.Attribute[] attributes=(soupply.pocket102.types.Attribute[]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.attributes = attributes;
    }
...
class MobEquipment : Pocket102Packet
{
    ...
    this(long entityId, soupply.pocket102.types.Slot item=soupply.pocket102.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.item = item;
...
class MobArmorEquipment : Pocket102Packet
{
    ...
    @Var long entityId;
    soupply.pocket102.types.Slot[4] armor;

    this() pure nothrow @safe @nogc {}

    this(long entityId, soupply.pocket102.types.Slot[4] armor=(soupply.pocket102.types.Slot[4]).init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.armor = armor;
    }
...
class PlayerAction : Pocket102Packet
{
    ...
    this(long entityId, int action=int.init, soupply.pocket102.types.BlockPosition position=soupply.pocket102.types.BlockPosition.init, int face=int.init) pure nothrow @safe @nogc
    {
        this.entityId = entityId;
        this.action = action;
        this.position = position;
...
class SetSpawnPosition : Pocket102Packet
{
    ...
    this(int unknown0, soupply.pocket102.types.BlockPosition position=soupply.pocket102.types.BlockPosition.init, bool unknown2=bool.init) pure nothrow @safe @nogc
    {
        this.unknown0 = unknown0;
        this.position = position;
        this.unknown2 = unknown2;
...
class DropItem : Pocket102Packet
{
    ...
    this(ubyte action, soupply.pocket102.types.Slot item=soupply.pocket102.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class InventoryAction : Pocket102Packet
{
    ...
    this(int action, soupply.pocket102.types.Slot item=soupply.pocket102.types.Slot.init) pure nothrow @safe @nogc
    {
        this.action = action;
        this.item = item;
    }
...
class ContainerOpen : Pocket102Packet
{
    ...
    this(ubyte window, ubyte type=ubyte.init, int slotCount=int.init, soupply.pocket102.types.BlockPosition position=soupply.pocket102.types.BlockPosition.init, long entityId=long.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
...
class ContainerSetSlot : Pocket102Packet
{
    ...
    this(ubyte window, int slot=int.init, int hotbarSlot=int.init, soupply.pocket102.types.Slot item=soupply.pocket102.types.Slot.init, ubyte unknown4=ubyte.init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slot = slot;
        this.hotbarSlot = hotbarSlot;
...
class ContainerSetContent : Pocket102Packet
{
    ...
    ubyte window;
    soupply.pocket102.types.Slot[] slots;
    @Var int[] hotbar;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, soupply.pocket102.types.Slot[] slots=(soupply.pocket102.types.Slot[]).init, int[] hotbar=(int[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.slots = slots;
        this.hotbar = hotbar;
...
class CraftingData : Pocket102Packet
{
    ...
    soupply.pocket102.types.Recipe[] recipes;

    this() pure nothrow @safe @nogc {}

    this(soupply.pocket102.types.Recipe[] recipes) pure nothrow @safe @nogc
    {
...
class CraftingEvent : Pocket102Packet
{
    ...
    @Var int type;
    UUID uuid;
    soupply.pocket102.types.Slot[] input;
    soupply.pocket102.types.Slot[] output;

    this() pure nothrow @safe @nogc {}

    this(ubyte window, int type=int.init, UUID uuid=UUID.init, soupply.pocket102.types.Slot[] input=(soupply.pocket102.types.Slot[]).init, soupply.pocket102.types.Slot[] output=(soupply.pocket102.types.Slot[]).init) pure nothrow @safe @nogc
    {
        this.window = window;
        this.type = type;
        this.uuid = uuid;
...
class BlockEntityData : Pocket102Packet
{
    ...
    this(soupply.pocket102.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.nbt = nbt;
    }
...
class PlayerList : Pocket102Packet
{
    ...
    class Add : Pocket102Packet
    {
        ...
        soupply.pocket102.types.PlayerList[] players;

        this() pure nothrow @safe @nogc {}

        this(soupply.pocket102.types.PlayerList[] players) pure nothrow @safe @nogc
        {
...
class ItemFrameDropItem : Pocket102Packet
{
    ...
    this(soupply.pocket102.types.BlockPosition position, soupply.pocket102.types.Slot item=soupply.pocket102.types.Slot.init) pure nothrow @safe @nogc
    {
        this.position = position;
        this.item = item;
    }
...
class ReplaceSelectedItem : Pocket102Packet
{
    ...
    this(soupply.pocket102.types.Slot item) pure nothrow @safe @nogc
    {
        this.item = item;
    }
...
class GameRulesChanged : Pocket102Packet
{
    ...
    @Length!uint soupply.pocket102.types.Rule[] rules;

    this() pure nothrow @safe @nogc {}

    this(soupply.pocket102.types.Rule[] rules) pure nothrow @safe @nogc
    {
        this.rules = rules;
    }
